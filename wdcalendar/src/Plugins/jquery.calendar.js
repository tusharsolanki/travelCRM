...
; (function($) {
    ...
    $.fn.bcalendar = function(option) {
        ...
        var __SCOLLEVENTTEMP = "<DIV style=\"WIDTH:${width};top:${top};left:${left};\" title=\"${title}\" class=\"chip chip${i} ${drag}\"><div class=\"dhdV\" style=\"display:none\">${data}</div><DIV style=\"BORDER-BOTTOM-COLOR:${bdcolor}\" class=ct>&nbsp;</DIV><DL style=\"BORDER-BOTTOM-COLOR:${bdcolor}; BACKGROUND-COLOR:${bgcolor1}; BORDER-TOP-COLOR: ${bdcolor}; HEIGHT: ${height}px; BORDER-RIGHT-COLOR:${bdcolor}; BORDER-LEFT-COLOR:${bdcolor}\"><DT style=\"BACKGROUND-COLOR:${bgcolor2}\">${starttime} ${stag} - ${endtime} ${etag} ${icon}</DT><DD><SPAN>${content}</SPAN></DD><DIV class='resizer' style='display:${redisplay}'><DIV class=rszr_icon>&nbsp;</DIV></DIV></DL><DIV style=\"BORDER-BOTTOM-COLOR:${bdcolor}; BACKGROUND-COLOR:${bgcolor1}; BORDER-TOP-COLOR: ${bdcolor}; BORDER-RIGHT-COLOR: ${bdcolor}; BORDER-LEFT-COLOR:${bdcolor}\" class=cb1>&nbsp;</DIV><DIV style=\"BORDER-BOTTOM-COLOR:${bdcolor}; BORDER-TOP-COLOR:${bdcolor}; BORDER-RIGHT-COLOR:${bdcolor}; BORDER-LEFT-COLOR:${bdcolor}\" class=cb2>&nbsp;</DIV></DIV>";
        ...
        function BuildMonthView(showday, events, config) {
            ...
            var cc = "<div id='cal-month-cc' class='cc'><div id='cal-month-cc-body' class='cc-body'><div id='cal-month-cc-content' class='st-contents'><table class='st-grid' cellSpacing='0' cellPadding='0'><tbody></tbody></table></div></div></div>";
		...
		/*Mayank 22-11-2012 start : Code for display any title or text with first character in Upercase*/
		...
		/*Mayank 22-11-2012 End : Code for display any title or text with first character in Upercase*/
		
        function getTitle(event)
				{
					/*Mayank 22-11-2012 start : Code for display Message box on hover of calender appt*/
					var timeshow, locationshow, attendsshow, eventshow, titleshow,typeshow,type;
					var showtime = event[4] != 1;
					eventshow = (event[1] != undefined && event[1] != "") ? unescape(event[1].capitalize()) : "Open Appointment";
					
					var sdt=(dateFormat.call(event[2], i18n.xgcalendar.dateformat.Md3)+ " ("+ __WDAY[event[2].getDay()]+ ")");
					
					var dd = "AM";
					var h = dateFormat.call(event[2], "HH")
					var m = dateFormat.call(event[2], "mm")
					if (h >= 12) { h = h-12; dd = "PM"; }
					if (h == 0) {	h = 12;}
					var st=h+':'+m+' '+dd;
					
					var dd1 = "AM";
					var h1 = dateFormat.call(event[3], "HH")
					var m1 = dateFormat.call(event[3], "mm")
					if (h1 >= 12) { h1 = h1-12; dd1 = "PM"; }
					if (h1 == 0) {	h1 = 12;}
					var et=h1+':'+m1+' '+dd1;
					
					timeshow = sdt + " " + st + " - " + et;
					locationshow = (event[9] != undefined && event[9] != "") ? event[9].capitalize() : "Not Appointed";
					//attendsshow = (event[10] != undefined && event[10] != "") ? event[10] : "";
					titleshow = (event[11] != undefined && event[11] != "") ? unescape(event[11]) : "No Title";
					type = event[12];
					if(type == 1){typeshow='Energy evaluation';}
					else if(type == 2){typeshow='Energy assessment';}
					else if(type == 3){typeshow='Online meeting';}
					else if(type == 4){typeshow='Retrofit';}
					else{typeshow='Not Appointed';}
					...
					//ret.push( i18n.xgcalendar.Title + " : ", titleshow, "\r\n", i18n.xgcalendar.time + " : ", timeshow, "\r\n", i18n.xgcalendar.event + " : ", eventshow, "\r\n", i18n.xgcalendar.Patient + " : ", locationshow, "\r\n", i18n.xgcalendar.Type + " : ", typeshow);
					ret.push( i18n.xgcalendar.Title + " : ", titleshow, "\r\n", i18n.xgcalendar.time + " : ", timeshow);
					/*Mayank 22-11-2012 End : Code for display Message box on hover of calender event or appt*/
					return ret.join("");
        }
				
        function BuildDayEvent(theme, e, index) {
            var p = { bdcolor: theme[0], bgcolor2: theme[0], bgcolor1: theme[2], width: "70%", icon: "", title: "", data: "" };
            p.starttime = pdate(e.st.hour) + ":" + pZero(e.st.minute);//for changing appt time
            p.endtime = pdate(e.et.hour) + ":" + pZero(e.et.minute);
						p.stag = get_tag(e.st.hour);
            p.etag = get_tag(e.et.hour);
			//alert(e.event[1]);
						if(e.event[1]=='Open Appointment')
						{
								p.content = unescape(e.event[11]);
						}
						else
						{
								p.content = unescape(e.event[11]);
        ...
        function BuildMonthDayEvent(e, cday, length) {
            ...
            var cen;
            if (!e.allday && !sf) {
                cen = pdate(e.st.hour) + ":" + pZero(e.st.minute) + " " + get_tag(e.st.hour) + " " + unescape(e.event[1]);
            }
            else {
                cen = unescape(e.event[1]);
            }
            var content = [];
        ...
        function populate() {
            ...
            if (option.url && option.url != "") {
				...
				{ name: "is_public", value: is_public },
                ];
                if (option.extParam) {
        ...
        function gH(y1, y2, pt) {
            ...
            return { sh: t2, sm: t3, eh: t5, em: t6, h: sy2 - sy1 };
				...
				/*Code for changing time of Appt and New Event Start*/
				function pdate(h) {
					if(h>12)
						h-=12;
					return h < 10 ? "0" + h : h;
        ...
        function pZero(n) {
				...
				/*Code for changing time of Appt and New Event End*/
        ...
        function Ta(temp, dataarry) {
            return temp.replace(/\{([\d])\}/g, function(s1, s2) { var s = dataarry[s2]; if (typeof (s) != "undefined") { return encodeURIComponent(s); } else { return ""; } });
				...
				/*Code for changing time of calendar left panel Start*/
        function fomartTimeShow(h) {
				...
				/*Code for changing time of calendar left panel End*/
        ...
        function buildtempdayevent(sh, sm, eh, em, h, title, w, resize, thindex) {
            ...
            var newtemp = Tp(__SCOLLEVENTTEMP, {
                ...
                bgcolor1: theme[2],
                data: "",
                starttime: [pdate(sh), pZero(sm)].join(":"),//for changing bubble time
                endtime: [pdate(eh), pZero(em)].join(":"),
								stag: get_tag(sh),
								etag: get_tag(eh),
        ...
        function dayshow(e, data) {
            ...
            if (data != null) {
                ...
                if (option.quickDeleteUrl != "" && data[8] == 1 && option.readonly != true) {
					if(delete_calendar == 'true')
					{var delete_span='<span id="bbit-cs-deleteall" class="linkrep56 lk">'+i18n.xgcalendar.all_delete +' </span>';}
					else{delete_span='';}
					if(edit_calendar == 'true')
					{var edit_span='<SPAN id="bbit-cs-editLink" class="linkrep57 lk">'+ i18n.xgcalendar.update_detail + '</SPAN>';}
					else{edit_span='';}
					
										var csbuddle = '<div id="bbit-cs-buddle" style="z-index: 180; width: 400px;visibility:hidden;" class="bubble"><table class="bubble-table" cellSpacing="0" cellPadding="0"><tbody><tr><td class="bubble-cell-side"><div id="tl1" class="bubble-corner"><div class="bubble-sprite bubble-tl"></div></div><td class="bubble-cell-main"><div class="bubble-top"></div><td class="bubble-cell-side"><div id="tr1" class="bubble-corner"><div class="bubble-sprite bubble-tr"></div></div>  <tr><td class="bubble-mid" colSpan="3"><div style="overflow: hidden" id="bubbleContent1"><div><div></div><div class="cb-root"><table class="cb-table" cellSpacing="0" cellPadding="0"><tbody><tr><td class="cb-value"><div class="textbox-fill-wrapper"><div class="textbox-fill-mid"><div id="bbit-cs-what" title="'+ i18n.xgcalendar.click_to_detail + '" class="linkrep57 textbox-fill-div" style=""></div></div></div></td></tr><tr><td class=cb-value><div id="bbit-cs-buddle-timeshow"></div><br><div id="bbit-cs-caneveLink" class="linkrep56 lk"></div><div id="bbit-cs-confLink" class="linkrep56 lk"></div>'+delete_span+'<br>'+edit_span+'<br><SPAN id="bbit-cs-agentLink" class="linkrep56 lk"></SPAN></td></tr></tbody></table><div class="bbit-cs-split"><input id="bbit-cs-id" type="hidden" value=""/></div></div></div></div><tr><td><div id="bl1" class="bubble-corner"><div class="bubble-sprite bubble-bl"></div></div><td><div class="bubble-bottom"></div><td><div id="br1" class="bubble-corner"><div class="bubble-sprite bubble-br"></div></div></tr></tbody></table><div id="bubbleClose2" class="bubble-closebutton"></div><div id="prong1" class="prong"><div class=bubble-sprite></div></div></div>';
                    ...
                    if (bud.length == 0) {
                       ...
                       /* $("#bbit-cs-what").click(function(e) {
                        ...
                        lbtn.click(function(e) {
							...
							$("#bbit-cs-agentLink").click(function(e) {
                            if (!option.EditCmdhandler) {
                                alert("EditCmdhandler" + i18n.xgcalendar.i_undefined);
                            }
                            else{
															var app_id = $("#bbit-cs-id").val();
															var url =gbl_path+"edit.php?flag=1&id="+app_id;
															OpenModelWindow(url,{ width: 600, height: 400, caption: "Allocate Agent"});
                            }
                            $("#bbit-cs-buddle").css("visibility", "hidden");
                            return false;
                        });
						$("#bbit-cs-confLink").click(function(e) {							
                            if (!option.EditCmdhandler) {
                                alert("EditCmdhandler" + i18n.xgcalendar.i_undefined);
                            }
                            else{
															$.ajax({
																type: "post",
																url: $("#baseurl").val()+"wdcalendar/php/getuser.php?uid="+$("#bbit-cs-id").val(),
						...
						$("#bbit-cs-deleteall").click(function(e) {
                                                    
							if(confirm(i18n.xgcalendar.delete_event)) 
                                                        {
                                                            if (!option.EditCmdhandler) {
                                                                alert("EditCmdhandler" + i18n.xgcalendar.i_undefined);
                                                                }
								...
								$.ajax({
									type: "post",
									data:{id:$("#bbit-cs-id").val()},
									url: $("#baseurl").val()+"calendar/delete_calender",
									success: function(msg1){
                                                                                //$.confirm({'title': 'Alert','message': msg1,'buttons': {'ok'	: {'class'	: 'uibutton large btn_center alert_ok'}}});
										alert(msg1);
										$("#gridcontainer").reload();
									}
								});
                                                        ...
                                                        // NEW 19-01-2015 Sanjay M.
                                                        /*$.confirm({'title': 'CONFIRM','message': " <strong> "+i18n.xgcalendar.delete_event+"</strong>",'buttons': {'Yes': {'class': '',
                                                        'action': function(){
                                                            $.ajax({
                                                                type: "post",
                                                                data:{id:$("#bbit-cs-id").val()},
                    ...
                    if (data[4] != 1) {
										...
										var dd = "AM";
										var h = dateFormat.call(data[2], "HH")
										var m = dateFormat.call(data[2], "mm")
										if (h >= 12) { h = h-12; dd = "PM"; }
										if (h == 0) {	h = 12;}
			              ss.push(",", ' '+h+':'+m+' '+dd);
                    }
					...
					/*Mayank 21-11-2012 start : Code for display a pop up box for insert, updte,delete action*/
                    var ts = $("#bbit-cs-buddle-timeshow").html(ss.join(""));
										var confdt=data[10].split('-');
										//alert(confdt);
										if(data[1]!="Open Appointment" && confdt[0]==0 && confdt[1]!=0 && confdt[2]==0)
										{
											$("#bbit-cs-confLink").html(i18n.xgcalendar.confirm_appt);
											$("#bbit-cs-delete").html(i18n.xgcalendar.i_delete);
											$("#bbit-cs-editLink").html(i18n.xgcalendar.update_detail);
											$("#bbit-cs-agentLink").html(i18n.xgcalendar.agent_link);
										}
										else if(data[1]!="Open Appointment" && confdt[0]==0 && confdt[1]!=0 && confdt[2]==1)
										{
											$("#bbit-cs-confLink").html("");
											$("#bbit-cs-delete").html(i18n.xgcalendar.i_delete);
											$("#bbit-cs-editLink").html(i18n.xgcalendar.update_detail);
											$("#bbit-cs-agentLink").html(i18n.xgcalendar.agent_link);
										}
										else
										{
											...
											$("#bbit-cs-delete").html(i18n.xgcalendar.i_delete);
											$("#bbit-cs-editLink").html(i18n.xgcalendar.update_detail);
											$("#bbit-cs-agentLink").html("");
										}
										
										temp_event_ln = i18n.xgcalendar.i_delete;			
										
										$("#bbit-cs-what").html(unescape(data[1]));
        ...
        function quickadd(start, end, isallday, pos) {
            ...
            if (buddle.length == 0) {
                var temparr = [];
                temparr.push('<div id="bbit-cal-buddle" style="z-index: 180; width: 200px;visibility:hidden;" class="bubble">');
                ...
                temparr.push('<td class="bubble-cell-main"><div class="bubble-top"></div><td class="bubble-cell-side"><div id="tr1" class="bubble-corner"><div class="bubble-sprite bubble-tr"></div></div>  <tr><td class="bubble-mid" colSpan="3"><div style="overflow: hidden" id="bubbleContent1"><div><div class="cb-root">');
								
								//temparr.push('<table class="cb-table" cellSpacing="0" cellPadding="0"><tbody><tr><td class=cb-value><div id="bbit-cal-buddle-timeshow"></div></td></tr></tbody></table>');
								
                temparr.push('<input id="bbit-cal-start" type="hidden"/><input id="bbit-cal-end" type="hidden"/><SPAN id="bbit-cal-editLink" class="linkrep56 lk">');
                temparr.push(i18n.xgcalendar.new_detail, ' </SPAN></div></div></div><tr><td><div id="bl1" class="bubble-corner"><div class="bubble-sprite bubble-bl"></div></div><td><div class="bubble-bottom"></div><td><div id="br1" class="bubble-corner"><div class="bubble-sprite bubble-br"></div></div></tr></tbody></table><div id="bubbleClose1" class="bubble-closebutton"></div><div id="prong2" class="prong"><div class=bubble-sprite></div></div></div>');
                ...
                switch (d.type) {
                    ...
                    case 3:
                        ...
                        if (diffx > 5 || diffx < -5 || diffy < -5 || diffy > 5 || d.lasso) {
                            if (!d.lasso) {
                                d.lasso = $("<div style='z-index: 90; display: block' class='drag-lasso-container'/>");
                                $(document.body).append(d.lasso);
                            }
                            if (!d.sdi) {
