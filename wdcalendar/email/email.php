...
<html>
	<body>
      ...
      <tr>
      	<td style="color:#333; font-size:14px; font-family:Arial, Helvetica, sans-serif; text-align:center;">You have New Appointment Request From Dr. '.$agentname.' for '.$reason.'</td>
      </tr>
      
      <tr>
        <td style="font-family:Arial, Helvetica, sans-serif; font-size:14px; color:#333; text-align:center;">If You want to accept request for <b>'.$sdate.' at '.$stime.'</b></td>
      </tr>
