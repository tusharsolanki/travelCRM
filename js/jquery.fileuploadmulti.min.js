    ...
    b.fn.uploadFile = function(t) {
        ...
        function l(H, B, u) {
            for (var C = 0; C < u.length; C++) {
				...
				filesizeCount = u[C].size + filesizeCount;
				//if (H.maxFileSize != -1 && u[C].size > H.maxFileSize) {
                if (H.maxFileSize != -1 && filesizeCount > H.maxFileSize) {
					filesizeCount = filesizeCount - u[C].size;
                    if (H.showError) {
        ...
        function p(v, u) {
            ...
            this.cancel = b("<div><input type='button' onclick='removefile();' value=" + u.cancelStr + " name=" + u.cancelStr + " id=" + u.cancelStr + " class='upload-red'></div>").appendTo(this.statusbar).hide();
