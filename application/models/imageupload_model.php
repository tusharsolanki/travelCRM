...
class imageupload_model extends CI_Model
{
    ...
    */
	...
	public function uploadSmallImage1($sourceImgPath,$thumbPath)
    {
		...
		$configThumb['width'] = 20;  
		$configThumb['height'] = 20;  
		$this->load->library('image_lib');
    ...
    */
	...
	function copyfile($bgImgPath,$image,$file_name)
	{
		$this->load->helper("file"); 
		$bgTempPath = $this->config->item('temp_attachment_path');
		$sourceImgBig = base_url().$bgTempPath.$image;
		$sourceRootImgBig = base_url().$bgTempPath.$image;
