<?php
	/*
    @Description: bomb Library Model
...
class bomb_library_model extends CI_Model
{
    function __construct()
    {
        parent::__construct();
        $this->table_name = 'bomb_template_master';
		$this->table_name_transcation='task_user_transcation';
		$this->table_name_event='bomb_event_master';
 ...
 /*
    ...
    */
    ...
    /*
    @Description: Function is for Insert bomb Library details by Admin
    @Author: Mohit Trivedi
    @Input: bomb Library details for Insert into DB
    ...
    */
    ...
    @Author: Mohit Trivedi
    @Input: bomb Library details for Update into DB
    ...
    */
    ...
    @Author: Mohit Trivedi
    @Input: - bomb Library id which is delete by admin
    ...
    */
	...
	public function getbombpagingid($bomb_id='')
	{
		$this->db->select('*');
    ...
    */
	function get_new_template($parent_db='',$new_ar='')
	{
		...
		$sql_ins = "INSERT INTO ".$this->table_name." (template_name, template_category, template_subcategory, template_subject, bomb_message, superadmin_template_id, admin_publish_date, superadmin_publish_date,is_default,edit_flag, created_date, created_by, status) SELECT em.template_name, ccat.id, em.template_subcategory, em.template_subject, em.bomb_message,em.id, '".$now."' as admin_publish_date, em.superadmin_publish_date,em.is_default,'1' as edit_flag, em.created_date,'1' as created_by,em.status FROM ".$parent_db.".".$this->table_name." as em LEFT JOIN ".$parent_db.".marketing_master_lib__category_master pcat ON em.template_category  = pcat.id LEFT JOIN marketing_master_lib__category_master ccat ON ccat.superadmin_cat_id  = pcat.id where is_default  = '1' and em.publish_flag = '1' ".$new_ar.";";
    ...
    */
	function get_update_template($parent_db='',$parent_id='',$next_temp,$db_name='')
	{
		...
		$sql_ins = "INSERT INTO ".$table_name." (template_name, template_category, template_subcategory, template_subject, bomb_message,superadmin_template_id, admin_publish_date, superadmin_publish_date,is_default,edit_flag, created_date, created_by, status) SELECT '".$next_temp."' as template_name,ccat.id, em.template_subcategory, em.template_subject, em.bomb_message,em.id, '".$now."' as admin_publish_date, em.superadmin_publish_date,em.is_default,'1' as edit_flag, em.created_date,'1' as created_by,em.status FROM ".$parent_db.".".$this->table_name." as em LEFT JOIN ".$parent_db.".marketing_master_lib__category_master pcat ON em.template_category  = pcat.id LEFT JOIN ";
		if(!empty($db_name))
