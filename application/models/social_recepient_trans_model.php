<?php
	/*
    @Description: social Texts Model
...
class social_recepient_trans_model extends CI_Model
{
    function __construct()
    {
        parent::__construct();
        $this->table_name = 'social_recepient_trans';
    ...
    */
    ...
    /*
    @Description: Function is for Insert social Texts details by Admin
    @Author: Sanjay Chabhadiya
    @Input: social Texts details for Insert into DB
    ...
    */
	...
	/*
		...
		@Author: Sanjay Chabhadiya
		@Input: social Texts details for Update into DB
    ...
    */
	...
	/*
    @Description: Function for Delete social Texts Profile By Admin
    @Author: Sanjay Chabhadiya
    @Input: - social Texts id which is delete by admin
    ...
    */
    ...
    {
        $this->db->where('social_campaign_id',$id);
        $this->db->delete($this->table_name);
    }
	
	public function delete_record_campaign($data,$id)
    {
		if(!empty($data))
		{
