...
class state_model extends CI_Model
{
    ...
    */
    ...
    /*
        @Description: Function is for Insert state
        @Author     : Sanjay Moghariya
        @Input      : State details for Insert into DB
    ...
    */
    ...
    /*
        @Description: Function is for update state
        @Author     : Sanjay Moghariya
        @Input      : state details for Update into DB
