...
class favorite_model extends CI_Model
{
    ...
    {
        parent::__construct();
        $this->table_name = 'joomla_rpl_bookmarks';
...
/*
    ...
    */
    ...
    /*
        @Description: Function for Delete favorite
        @Author     : Sanjay Moghariya
        @Input      : id
        @Output     : Delete favorite record
        @Date       : 01-12-2014
    */
    public function delete_fav_record($fav_data)
    {
        $this->db->where('uid',$fav_data['uid']);
        $this->db->where('pid',$fav_data['pid']);
        $this->db->where('lw_admin_id',$fav_data['lw_admin_id']);
