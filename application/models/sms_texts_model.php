...
class sms_texts_model extends CI_Model
{
    ...
    */
	function check_superadmin_template($new_ar='',$send_type='',$parent_db='')
	{
		...
		FROM ".$parent_db.".".$this->table_name." where  sms_send_type  = ".$send_type." ".$new_ar."
		 GROUP BY is_default";
		$query = $this->db->query($sql_ins);
		return $query->result_array();
	}
