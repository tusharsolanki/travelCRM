...
class mail_blast_model extends CI_Model
{
    function __construct()
    {
        parent::__construct();
        $this->table_name = 'mail_blast_sent';
		$this->table_name_transcation='mail_blast_contact_trans';
	}
    ...
    */
    ...
    {
        $this->db->where('mail_blast_id',$id);
