...
class last_login_model extends CI_Model
{
    ...
    {
        parent::__construct();
        $this->table_name = 'joomla_rpl_log';
    ...
    */
    ...
    public function getuser($getfields='', $match_values = '',$condition ='', $compare_type = '', $count = '',$num = '',$offset='',$orderby='',$orderbyfield='',$and_match_value='')
    {
        //echo $offset;exit;
        $fields =  $getfields ? implode(',', $getfields) : '';
        $sql = 'SELECT ';
