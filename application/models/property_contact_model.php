<?php
/*
    @Description: Property contact form model
...
class property_contact_model extends CI_Model
{
    ...
    {
        parent::__construct();
        $this->table_name = 'joomla_rpl_property_contact';
    }
    
    /*
        @Description: Function for property contact form list
        @Author     : Sanjay Moghariya
        @Input      : Fieldl list(id,name..), match value(id=id,..), condition(and,or),compare type(=,like),count,limit per page, starting row number
        @Output     : Property contact list
        @Date       : 09-03-2015
    */
    ...
    /*
        ...
        @Output     : Property contact form listing
        @Date       : 09-03-2015
    */
    ...
    /*
        @Description: Function is for Insert property contact form data
        @Author     : Sanjay Moghariya
        @Input      : property contact form data
    ...
    */
    ...
    /*
        @Description: Function is for update property contact form details
        @Author     : Sanjay Moghariya
