...
{	
    ...
    */
    ...
    {	
		//check user right
		check_rights('work_time_configuration');	      
	    redirect('user/'.$this->viewName."/add_record");
    }
    ...
    */
    ...
    public function insert_data()
    {
		...
		$cdata['user_id']=$this->user_session['id'];
		...
		for($i=0;$i<count($cdata4['nth_day']);$i++)
		{
			if(!empty($cdata4['nth_day'][$i]) && !empty($cdata4['nth_date'][$i]))
			{
				...
				$cdata2['user_id']=$this->user_session['id'];
				$cdata2['nth_day'] = $cdata4['nth_day'][$i];
				$cdata2['nth_date'] = $cdata4['nth_date'][$i];
				$cdata2['created_by'] = $this->user_session['id'];
		...
		$get_all_interaction_plans = $this->interaction_model->get_all_assigned_interaction_plans($this->user_session['id']);
