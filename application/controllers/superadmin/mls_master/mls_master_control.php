...
class mls_master_control extends CI_Controller
{	
    function __construct()
    {
        ...
        $this->obj = $this->mls_master_model;
    ...
    */
    public function add_record()
    {
		...
		$fields = array('mm.*','lm.user_type');
		$join_tables = array('login_master as lm' => 'lm.id = mm.created_by');
		$group_by='mm.id';
    ...
    */
    public function insert_plan_type()
    {
        ...
        $cdata['mls_name'] = $this->input->post('plan_type');
    ...
    */
    public function update_status()
    {
        ...
        $cdata['mls_name'] = $this->input->post('category_name');	
       // $cdata['modified_by'] = $this->superadmin_session['id'];	
        //$cdata['modified_date'] = date('Y-m-d H:i:s');
