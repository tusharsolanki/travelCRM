...
{	
    ...
    */
            ...
            if(!empty($tables))
            {
                foreach($tables as $table_name)
                {
                    ...
                    if($worked == 0)
                    {
                        ...
                        $this->dump_database($table_name,$prefix,$id,$minute,$hour,$day,$month);
                    }   
    ...
    function dump_database($table_name,$prefix,$id='',$minute='',$hour='',$day='',$month='')
    {
       ...
       // echo $table_name;
	    ...
	    echo "Import to staging database ".$table_name.'<br>';
            ...
            $this->dump_master_database($table_name,$prefix,$id,$minute,$hour,$day,$month);
    ...
    function dump_master_database($table_name,$prefix,$id='',$minute='',$hour='',$day='',$month='')
    {
        //ENTER THE RELEVANT INFO BELOW
        $mysqlDatabaseName = $this->config->item('mls_master_db');
        $mysqlHostName     = $this->config->item('mls_master_host');
