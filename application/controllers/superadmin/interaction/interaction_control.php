    ...
    */
    ...
    {	
		...
		if(!empty($searchtext))
		{
			...
			$config['total_rows'] = $this->obj->getmultiple_tables_records($table,$fields,$join_tables,'left','',$match,'like','','','','',$group_by,$where1);
		}
		else
		{
    ...
    */
	...
	public function ajax_selecttemplate()
	{
		...
		if(!empty($id))
		{
			...
			{
				//$match = array('template_category'=>$catid,'template_subcategory'=>$subcatid);
				$match = array();
				if($catid > 0)
