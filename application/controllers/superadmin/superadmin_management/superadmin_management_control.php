...
/*
    @Description: Superadmin Management controller
...
class superadmin_management_control extends CI_Controller
{	
    ...
    */
    ...
    {	
		...
		if(!empty($searchtext))
		{
			...
			$config['total_rows'] = $this->obj->get_user('',$match,'','like','','','','','','','1');
		}
		else
		{
		...
		$this->session->set_userdata('superadmin_management_sortsearchpage_data', $sortsearchpage_data);
