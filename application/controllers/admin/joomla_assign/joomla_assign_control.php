...
{	
    ...
    */
    ...
    {	
        ...
        if(!empty($searchtext))
        {
            ...
            $data['datalist'] =$this->joomla_assign_model->getmultiple_tables_records($table,$fields,$join_tables,'left',$match,'','like',$config['per_page'], $uri_segment,$data['sortfield'],$data['sortby'],'','');
            $config['total_rows'] = count($this->joomla_assign_model->getmultiple_tables_records($table,$fields,$join_tables,'left',$match,'','like'));
        }
        else
        {
            $data['datalist'] =$this->joomla_assign_model->getmultiple_tables_records($table,$fields,$join_tables,'left','','','=',$config['per_page'], $uri_segment,$data['sortfield'],$data['sortby'],'','');
            $config['total_rows'] = count($this->joomla_assign_model->getmultiple_tables_records($table,$fields,$join_tables,'left','','','='));
        }
    ...
    */
    ...
    {
        //$min_price = $this->input->post('min_price'); // Remove for phase1
        //$max_price = $this->input->post('max_price'); // Remove for phase1
    ...
    */
    ...
    public function update_data()
    {
        ...
        $cdata['interaction_plan_id'] = $this->input->post('assigned_interaction_plan_id');
        $cdata['prospect_type'] = $this->input->post('prospect_type');
        /*$min_price = $this->input->post('min_price');  Remove for Phase 1
