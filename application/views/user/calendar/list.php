            		...
            		<tr>
                      <td colspan="4"><table class="iconment_title_in" width="100%" border="0" cellspacing="0" cellpadding="0">
                           <tr>
                                ...
                                <th><?php echo $this->lang->line('label_property_address')?></th>                               				
                                <th><?php echo $this->lang->line('label_property_city')?></th>
...
<img title="Edit record" src="<?php echo $this->config->item('image_path');?>edit_icon.png" width="15" height="20" /> 
                                                        ...
                                                        <td width="20" valign="top"><a href="javascript:void(0);" onclick="deletepopup('<?=rawurlencode(ucfirst(strtolower($row['property_name'])))?>','<?php echo $this->lang->line('tips_head_submodel')?>','<?php echo $this->config->item('crm_base_url').$viewname;?>/delete_record/<?php echo  $row['id'] ?>');"><img title="Delete record" src="<?php echo $this->config->item('image_path');?>delete_icon.png" width="15"  /></a></td>
