          ...
          <thead>
           <tr role="row">
            ...
            <th width="9%" rowspan="1" colspan="1"><?=$this->lang->line('common_label_preview')?></th>
             ...
             <th width="12%" class="hidden-xs hidden-sm sorting_disabled actionbtn7" data-filterable="true" role="columnheader" rowspan="1" colspan="1" aria-label="CSS grade"><?php echo $this->lang->line('common_label_action')?></th>
             <? } ?>
           </tr>
           </thead>
...
-->							<div id="temp_desc_<?php echo  $row['id'] ?>" style="display:none;">
					 ...
					 <?php if(!empty($this->modules_unique_name) && in_array('letter_library_add',$this->modules_unique_name)){?>
							<a class="btn btn-xs btn-success" href="<?= $this->config->item('user_base_url').$viewname; ?>/copy_record/<?= $row['id'] ?>" title="Copy Record"><i class="fa fa-copy copyicon8"></i></a> &nbsp; 
                            <? } ?>
