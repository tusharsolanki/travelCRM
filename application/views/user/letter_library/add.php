       ...
       <div class="col-sm-12">
        ...
        <div class="col-sm-12 clear">
          ...
          <div class="col-sm-12 pull-left text-center margin-top-10">
			...
			<input type="submit" class="btn btn-secondary-green" value="Save Letter Template" title="Save Template" onclick="return setdefaultdata();" name="submitbtn" />
            <?php if($this->uri->segment(4) != 'iframe'){ ?>
			 <input type="submit" class="btn btn-secondary" id="mailout" title="Mail Out" value="Perform Mail Out" name="mailout" onclick="return setdefaultdata();" />
 					<?php } if($this->uri->segment(4) == 'iframe'){ ?>
