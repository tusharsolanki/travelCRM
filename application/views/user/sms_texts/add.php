       ...
       <div class="col-sm-12">
        ...
        <div class="col-sm-12 clear">
          ...
          <div class="col-sm-8 form-group">
                  ...
                  <textarea name="sms_message" id="sms_message" placeholder="e.g. Message" class="form-control parsley-validated" ><?=!empty($editRecord[0]['sms_message'])? htmlentities($editRecord[0]['sms_message']):'';?>
</textarea>
...
<input type="submit" class="btn btn-secondary-green" title="Save Template" value="Save Template" onclick="return setdefaultdata();" name="submitbtn" />
<?php if($this->uri->segment(4) == 'iframe'){ ?>
