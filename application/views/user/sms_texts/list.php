<?php 
    /*
        @Description: user sms texts list
        ...
        <div class="portlet">
          <div class="portlet-header">
            <h3> <i class="fa fa-table"></i>
              <?=$this->lang->line('smstexttemplate_list_head');?>
            </h3>
          ...
          <div class="portlet-content">
            <ul class="nav nav-tabs" id="myTab1">
              <li <?php if($tabid == '' || $tabid == 1){?> class="active" <?php } ?>> <a title="<?=$this->lang->line('marketing_sms_librery_my');?>" data-toggle="tab" href="#mydata"onclick="load_view('my_data');">
                <?=$this->lang->line('marketing_sms_librery_my');?>
                </a> </li>
              <li <?php if($tabid == 2){?> class="active" <?php } ?>> <a title="<?=$this->lang->line('marketing_sms_librery_default');?>" data-toggle="tab" href="#defaultdata" onclick="load_view('my_default');">
                <?=$this->lang->line('marketing_sms_librery_default');?>
                </a> </li>
            </ul>
...
<script>
	...
	function contact_search(allflag)
	{
		...
		$.ajax({
			type: "POST",
			url: "<?php echo base_url();?>user/sms_texts/"+uri_segment,
			data: {
	...
	function delete_all(id)
		{
			...
			success: function(data){
				...
				$.ajax({
					type: "POST",
					url: "<?php echo base_url();?>user/sms_texts/",
					data: {
