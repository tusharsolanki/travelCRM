    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="col-sm-12 add_new_contact_popup">
		  ...
		  <?php $this->load->view('user/'.$viewname.'/add_contact_popup_ajax');?>
		  </div>
        </div>
      </div>
           ...
           <div class="col-sm-12 col-lg-8">
            ...
            <div class="row">
             <div class="col-sm-12">
			  ...
			  <textarea name="txtarea_desc" placeholder="e.g. Task Descripton" id="txtarea_desc" class="form-control parsley-validated"><?php if(!empty($editRecord[0]['desc'])){ echo $editRecord[0]['desc']; }?></textarea>
             </div>
            </div>
...
<div class="row form-group">
 ...
 Reminders
             ...
             <div class="col-sm-6 col-lg-3">
              <input id="email_time_before" name="email_time_before" class="form-control parsley-validated" type="text" value="<?php if(!empty($editRecord[0]['email_time_before'])){ echo $editRecord[0]['email_time_before']; }?>"  placeholder="Number">
             </div>
             <div class="col-sm-6 col-lg-3">
 ...
 <div class="col-sm-3">
             ...
             <div class="col-sm-6 col-lg-3">
              <input id="popup_time_before" name="popup_time_before" class="form-control parsley-validated" type="text" value="<?php if(!empty($editRecord[0]['popup_time_before'])){ echo $editRecord[0]['popup_time_before']; }?>"  placeholder="Number">
             </div>
             <div class="col-sm-6 col-lg-3">
...
<input type="submit" class="btn btn-secondary-green" value="Save Task" title="Save Task"  name="submitbtn" onclick="return showloading();" />
...
function select_box()
{
	...
	{
		$.confirm({'title': 'Alert','message': " <strong> Please select stleast one user "+"<strong></strong>",'buttons': {'ok'	: {'class'	: 'btn_center'}}});
					return false;
...
$(document).ready(function(){
	...
	function contact_search()
	{
		$.ajax({
			type: "POST",
			url: "<?php echo base_url();?>user/task/search_contact_ajax/",
			data: {
			result_type:'ajax',searchtext:$("#search_contact_popup_ajax").val(),contact_status:$('#slt_contact_status').val(),contact_source:$('#slt_contact_source').val(),contact_type:$('#contact_type').val()
		},
		beforeSend: function() {
	...
	function addcontactstointeractionplan()
	{
		$.ajax({
			type: "POST",
			url: "<?php echo base_url();?>user/task/add_contacts_to_interaction_plan/",
			data: {
	...
	$('body').on('click','.remove_selected_contact',function(e){
		...
		'action': function(){
			...
			$.ajax({
				type: "POST",
				url: "<?php echo $this->config->item('user_base_url').$viewname.'/delete_contact_from_task';?>",
