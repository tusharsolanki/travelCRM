       ...
       <div class="table_large-responsive">
        <div role="grid" class="dataTables_wrapper" id="DataTables_Table_0_wrapper">
         ...
         <div class="row dt-rt">
          ...
          <div class="col-sm-11">
           <div class="dataTables_filter" id="DataTables_Table_0_filter">
            <label>
             <input type="text" name="searchtext" id="searchtext" title="Search Text" aria-controls="DataTables_Table_0" placeholder="Search...">
			 <button class="btn btn-secondary howler" data-type="danger" title="Search" onclick="contact_search();">Search</button>
         ...
         <div class="row dt-rt">
          ...
          <div class="col-sm-6">
          <a class="btn  pull-right btn-success howler" title="Add Task" href="<?=base_url('user/'.$viewname.'/add_record');?>">Add Task</a>
          </div>
         </div>
         <div id="common_div">
