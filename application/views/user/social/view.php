           ...
           <div class="col-sm-8">
            <div class="row">
             <div class="col-sm-12">
              ...
              <label><?=ucfirst(strtolower($editRecord[0]['task_name']));?></label>
            ...
            <div class="row">
             <div class="col-sm-8">
              ...
              <label><?= !empty($editRecord[0]['desc'])?ucfirst(strtolower($editRecord[0]['desc'])): '-';?></label>
		   ...
		   <th width="50%"><?=$this->lang->line('completed_name')?></th>
             ...
             <?php if(!empty($datalist) && count($datalist)>0){
					$i=!empty($this->router->uri->segments[4])?$this->router->uri->segments[4]+1:1;
                      ...
                      <td class="">
                    <?php echo ucfirst(strtolower($row['first_name'].' '.$row['middle_name'].' '.$row['last_name']));?> </td>
                    <td>
