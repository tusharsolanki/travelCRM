        ...
        <div class="portlet">
          ...
          <div class="portlet-content">
                ...
                <div class="row dt-rt">
                  ...
                  <div class="col-lg-3 col-md-3 text-center">
                    <div class="iconbox"><a id="configuration_view" href="<?=base_url('user/social/add_record/2');?>"><img title="New Tweet" alt="New Tweet" src="<?=base_url()?>images/new-tweet-icon.jpg" class="img-responsive"><span>New Tweet</span></a></div>
                  </div>
                   <? } ?>
                    <?php if(!empty($this->modules_unique_name) && in_array('linkedin',$this->modules_unique_name)){?>
                  <div class="col-lg-3 col-md-3 text-center">
                    <div class="iconbox"><a id="configuration_view" href="<?=base_url('user/social/add_record/3');?>"><img title="New LinkedIn Post" alt="New LinkedIn Post" src="<?=base_url()?>images/new-linkedIn-post-icon.jpg" class="img-responsive"><span>New LinkedIn Post</span></a></div>
                  </div>
                  <? } ?>
                    <?php if(!empty($this->modules_unique_name) && in_array('all_channels',$this->modules_unique_name)){?>
                  <div class="col-lg-3 col-md-3 text-center ">
                    <div class="iconbox"><a id="configuration_view" href="<?=base_url('user/social/add_record/all');?>"><img title="New Post To All" alt="New Post To All" src="<?=base_url()?>images/new-post-to-all-icon.jpg" class="img-responsive"><span>New Post To All</span></a></div>
                  </div>
                   <? } ?>
                  <div class="col-lg-3 col-md-3 text-center clear">
                    <div class="iconbox"><a id="configuration_view" href="<?=base_url('user/social');?>"><img title="Previous Social Posts" alt="Previous Social Posts" src="<?=base_url()?>images/previous-social-posts-icon.jpg" class="img-responsive"><span>Previous Social Posts</span></a></div>
                  </div>
