        ...
        <div class="tab-content" id="myTab1Content">
         ...
         <div class="row">
          ...
          <div class="form-group">
                  <label for="select-multi-input">
                 	Message : 
	  				...
	  				<?=!empty($datalist[0]['social_message'])?ucfirst(strtolower($datalist[0]['social_message'])):'';?>
                </div>
               </div>
          <div class="col-sm-12 pull-left text-center margin-top-10">
			...
			{
			?>
				<a class="btn btn-primary" onclick="history.go(-1)" href="<?php echo $this->config->item('user_base_url').$viewname."/".$pagingid; ?>" title="Back">Close</a>
			<?php } else { ?>
			<a class="btn btn-primary" onclick="history.go(-1)" href="<?php echo $this->config->item('user_base_url').$viewname?>" title="Back">Close</a>
			<?php } ?>
         </div>
          </form>
