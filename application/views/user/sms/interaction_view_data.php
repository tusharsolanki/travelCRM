        ...
        <div class="tab-content" id="myTab1Content">
         ...
         <div class="tab-pane fade in active" id="home">
          ...
          <form class="form parsley-form" enctype="multipart/form-data" name="<?php echo $viewname;?>" id="<?php echo $viewname;?>" method="post" accept-charset="utf-8" action="<?php echo $this->config->item('user_base_url')?><?=$viewname?>/interaction_mailsms" novalidate>
		   ...
		   <div class="row">
             <div class="col-sm-12">
              <label for="text-input"><?=$this->lang->line('email_to');?> : </label> <label for="text-input"><?=!empty($datalist[0]['contact_name'])?ucfirst(strtolower($datalist[0]['contact_name'])):''?>(<?=!empty($datalist[0]['phone_no'])?($datalist[0]['phone_no']):''?>)</label>
             </div>
            </div>
            <div class="row">
             <div class="col-sm-12">
          ...
          <div class="form-group">
                  ...
                  <textarea name="sms_message" id="sms_message" class="form-control parsley-validated" onkeypress="return keypress(event);" ><?=!empty($datalist[0]['sms_message'])?ucfirst(strtolower($datalist[0]['sms_message'])):'';?></textarea>
