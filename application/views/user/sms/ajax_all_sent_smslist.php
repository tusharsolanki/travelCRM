                      ...
                      foreach($datalist as $row){?>
						<tr <? if($i%2==1){ ?>class="bgtitle" <? }?> > 
							...
							?>
							 ...
							 <td class="hidden-xs hidden-sm ">
							 <a class="btn btn-xs btn-success" href="<?=$this->config->item('user_base_url').$viewname;?>/view_data/<?=!empty($row['sms_campaign_id'])?$row['sms_campaign_id']:'';?>/<?=$row['id']?>/all" title="View"> View </a>
							 </td>
                             <td class="hidden-xs hidden-sm ">
