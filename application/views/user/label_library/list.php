    ...
    <div class="col-md-12">
     <div class="portlet">
      <div class="portlet-header">
       <h3> <i class="fa fa-table"></i><?=$this->lang->line('label_library_header');?></h3>
      ...
      <div class="portlet-content">
       <ul class="nav nav-tabs" id="myTab1">
              <li <?php if($tabid == '' || $tabid == 1){?> class="active" <?php } ?>> <a title="<?=$this->lang->line('marketing_label_librery_my');?>" data-toggle="tab" href="#mydata" onclick="load_view('my_data');">
                <?=$this->lang->line('marketing_label_librery_my');?>
                </a> </li>
              <li <?php if($tabid == 2){?> class="active" <?php } ?>> <a title="<?=$this->lang->line('marketing_label_librery_default');?>" data-toggle="tab" href="#defaultdata" onclick="load_view('my_default');">
                <?=$this->lang->line('marketing_label_librery_default');?>
                </a> </li>
            </ul>
...
<script>
	...
	function contact_search(allflag)
	{
		...
		$.ajax({
			type: "POST",
			url: "<?php echo base_url();?>user/label_library/"+uri_segment,
			data: {
	...
	function delete_all(id)
		{
			...
			success: function(data){
				...
				$.ajax({
					type: "POST",
					url: "<?php echo base_url();?>user/label_library/",
					data: {
...
function default_search(allflag1)
	...
	$('body').on('click','#default_common_tb a.paginclass_A',function(e){
		...
		$('body').on('click','.view_form_btn',function(e){
			...
			var temp_size = $('#temp_size_type_'+id).text();
