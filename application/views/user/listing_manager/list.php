      ...
      <div class="col-md-12">
        ...
        <div role="grid" class="dataTables_wrapper" id="DataTables_Table_0_wrapper">
         ...
         <div class="row dt-rt">
          ...
          <!--<div class="col-sm-12 col-lg-7 col-md-12">
              <ul class="contact_add">
                <li><a class="btn btn-xs" title="Import Contacts" href="<?=base_url('user/'.$viewname.'/import');?>"><i class="fa fa-level-down"></i> &nbsp;Import Property</a></li>
              </ul>
          </div>-->
          <div class="col-sm-11">
         ...
         <div class="row dt-rt">
          ...
          <a class="btn  pull-right btn-secondary-green howler" href="<?=base_url('user/'.$viewname.'/add_record');?>" title="Add Property">Add New Listing</a>
           <? } ?>
          </div>
         </div>
         <div id="common_div">
...
$('body').on('click','.view_contacts_btn',function(e){
	...
	$.ajax({
		type: "POST",
		url: "<?php echo $this->config->item('user_base_url').$viewname.'/view_contacts';?>",
		data: {'id':id},
		success: function(html){
