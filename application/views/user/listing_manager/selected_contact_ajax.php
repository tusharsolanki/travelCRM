...
if(!empty($contacts_data)){
  ...
  <tr class="<?php if($i%2==0){echo 'odd';}else{echo 'even';}$i++;?>">
	...
	<td class="text-center" width="57%"><a href="javascript:void(0);" class="btn btn-xs btn-primary remove_selected_contact" data-group="<?=!empty($editRecord[0]['id'])?$editRecord[0]['id']:'';?>" data-id="<?=!empty($row['id'])?$row['id']:'';?>"> <i class="fa fa-times"></i></a></td>
  </tr>
<?php } ?>
<?php }else{ ?>
	<tr>
