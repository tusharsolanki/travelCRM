                                        ...
                                        <div class="col-sm-8">
                                            <div class="row">
                                                <div class="col-sm-12 form-group">
                                                    ...
                                                    <input id="txt_name" name="txt_name" placeholder="Name" class="form-control parsley-validated" type="text" value="<?php if(!empty($editRecord[0]['name'])){ echo htmlentities($editRecord[0]['name']);}?>" data-required="true">
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-sm-12 form-group">
