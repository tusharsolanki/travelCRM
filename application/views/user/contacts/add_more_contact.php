         ...
         <div id="common_div">
         	<div class="col-sm-12 pull-left text-center">
            	<div class="row">
					...
					<div class="col-sm-12 form-group"><?php echo $count_no_contact."  Contact imported successfully"; ?><?=!empty($msg)?' and '.$msg:'';?> </div>
			...
			<div class="col-sm-12 pull-left text-center">
            	<div class="row">
					...
					<a class="btn btn-secondary" title="Undo Last Import" href="<?=base_url('user/'.$viewname.'/delete_last_import')."/".$csv_id;?>">Undo Last Import</a>
					<a class="btn btn-secondary" title="Import More Contacts" href="<?=base_url('user/'.$viewname.'/import');?>">Import More Contacts</a> 
					<a class="btn btn-secondary" href="<?=base_url('user/'.$viewname);?>" title="Finish">Finish</a>
        		</div>
         	</div>
