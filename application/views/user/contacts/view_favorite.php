                                        ...
                                        $i=!empty($this->router->uri->segments[4])?$this->router->uri->segments[4]+1:1;
                                          foreach($result_favorite as $rf){?>
                                            <tr <? if($i%2==1){ ?>class="bgtitle" <? }?> > 
                                                ...
                                                <td class="hidden-xs hidden-sm "><?=!empty($rf['propery_name'])?ucfirst(strtolower($rf['propery_name'])):'';?></td>
	...
	function delete_all(id)
		{
			...
			success: function(data){
				$.ajax({
					...
					data: {
					result_type:'ajax',searchreport:$("#searchreport").val(),perpage:$("#perpage2").val(),searchtext:$("#searchtext2").val(),sortfield:$("#sortfield2").val(),sortby:$("#sortby2").val()
				},
				beforeSend: function() {
