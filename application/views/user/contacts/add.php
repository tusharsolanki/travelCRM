  ...
  <div id="content-container" class="addnewcontact">
    <div class="">
      <div class="col-md-12"> 
		...
		{?>
            <a title="View Contact" class="btn btn-secondary" href="<?= $this->config->item('user_base_url').$viewname; ?>/view_record/<?=$editRecordId?>"><?php echo $this->lang->line('common_view_title')?></a>
            <?php }	?>
            <a class="btn btn-secondary" onclick="history.go(-1)" href="javascript:void(0)"><?php echo $this->lang->line('common_back_title')?></a> </span> </div>
          <!-- /.portlet-header -->
		 ...
		 ?>
                  ...
                  <div class="col-sm-12 col-lg-7">
                    ...
                    <div class="row">
                      <div class="col-sm-12 col-lg-4 form-group">
                        ...
                        <input id="txt_first_name" name="txt_first_name" maxlength="50" class="form-control parsley-validated" type="text" value="<?php if(!empty($editRecord[0]['first_name'])){ echo htmlentities($editRecord[0]['first_name']); }?>" data-required="true" onkeypress="return isCharacterKey(event)" placeholder="e.g. John">
                      </div>
                      <div class="col-sm-12 col-lg-4 form-group">
                        <label for="text-input">
                          <?=$this->lang->line('contact_add_mname');?>
                        </label>
                        <input id="txt_middle_name" name="txt_middle_name" maxlength="50" class="form-control parsley-validated" type="text" value="<?php if(!empty($editRecord[0]['middle_name'])){ echo htmlentities($editRecord[0]['middle_name']); }?>" onkeypress="return isCharacterKey(event)" placeholder="e.g. Jane">
                      </div>
                      <div class="col-sm-12 col-lg-4 form-group">
                        <label for="text-input">
                          <?=$this->lang->line('contact_add_lname');?>
                        </label>
                        <input id="txt_last_name" name="txt_last_name" maxlength="50" class="form-control parsley-validated" type="text" value="<?php if(!empty($editRecord[0]['last_name'])){ echo htmlentities($editRecord[0]['last_name']); }?>" onkeypress="return isCharacterKey(event)" placeholder="e.g. Laren">
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-sm-12 col-lg-4 form-group">
                        ...
                        <input id="txt_spousefirst_name" name="txt_spousefirst_name" maxlength="50" class="form-control parsley-validated" type="text" value="<?php if(!empty($editRecord[0]['spousefirst_name'])){ echo htmlentities($editRecord[0]['spousefirst_name']); }?>" onkeypress="return isCharacterKey(event)"  placeholder="e.g. Ruby">
                      </div>
					  <div class="col-sm-12  col-lg-4">
              <label for="text-input"><?=$this->lang->line('contact_add_spousemname');?></label>
              <input id="txt_spousemiddle_name" name="txt_spousemiddle_name" maxlength="50" class="form-control parsley-validated" type="text" onkeypress="return isCharacterKey(event)" value="<?php if(!empty($editRecord[0]['spousemiddle_name'])){ echo htmlentities($editRecord[0]['spousemiddle_name']); }?>" placeholder="e.g. max">
                      ...
                      <div class="col-sm-12 col-lg-4 form-group">
                        ...
                        <input id="txt_spouselast_name" name="txt_spouselast_name" maxlength="50" class="form-control parsley-validated" type="text" value="<?php if(!empty($editRecord[0]['spouselast_name'])){ echo htmlentities($editRecord[0]['spouselast_name']); }?>" onkeypress="return isCharacterKey(event)"  placeholder="e.g. Sen">
                      </div>
                    </div>
                    <div class="row">
			 		...
			 		foreach($address_trans_data as $rowtrans){ ?>
                      <div class="delete_address_trans_record<?=$rowtrans['id']?> padding-top-10 clear autooverflow">
                        ...
                        <div class="col-sm-6 columns">
                          <div class="row">
                            <textarea placeholder="Address Line 1" id="txtarea_address_line1" name="txtarea_address_line1e[]" class="form-control parsley-validated"><?php if(!empty($rowtrans['address_line1'])){ echo $rowtrans['address_line1']; }?>
</textarea>
                          </div>
                          <div class="row">
                          ...
                          <div class="row">
                            ...
                            <div class="col-sm-4 nopadding form-group">
                              <input type="text" placeholder="Zip Code" id="txt_zip_code" name="txt_zip_codee[]" maxlength="5" data-minlength="5" class="form-control parsley-validated" value="<?php if(!empty($rowtrans['zip_code'])){ echo htmlentities($rowtrans['zip_code']); }?>">
                            </div>
                          </div>
                          <div class="row">
                      ...
                      <div class="col-sm-6 columns">
                        ...
                        <div class="row">
                          ...
                          <div class="col-sm-4 nopadding form-group">
                            <input type="text" placeholder="Zip Code" id="txt_zip_code" name="txt_zip_code[]" data-minlength="5"  maxlength="5" class="form-control parsley-validated">
                          </div>
                        </div>
                        <div class="row">
                    ...
                    <div class="row">
                      <div class="col-sm-8">
                        ...
                        <textarea name="txtarea_notes" id="txtarea_notes" class="form-control parsley-validated"><?php if(!empty($editRecord[0]['notes'])){ echo $editRecord[0]['notes']; }?>
</textarea>
                      </div>
                    </div>
                  </div>
                        ...
                        <div class="browse"> <span class="text"> </span>
                          <div class="browse_btn">
                            <div class="file_input_div">
                              ...
                              <input type="file" alt="1" name="contact_pic" id="contact_pic" class="file_input_hidden" onchange="showimagepreview(this)"/>
                            </div>
                          </div>
				...
				?>
                    ...
                    <div class="add_website">
                      <div>
                        <?php /*?><div class="row add_website_div">
               ...
               <div class="col-sm-12 topnd_margin"> <a title="Add Website" class="text_color_red text_size add_new_website" href="javascript:void(0);"><i class="fa fa-plus-square"></i> Add Website</a> </div>
			 		...
			 		foreach($profile_trans_data as $rowtrans){ ?>
                          <div class="delete_social_trans_record<?=$rowtrans['id']?> padding-top-10 clear autooverflow">
                            ...
                            <div class="col-sm-5 form-group">
                              <input type="text" class="form-control parsley-validated fbid" id="txt_social_profilee" name="txt_social_profilee[]" value="<?php if(!empty($rowtrans['website_name'])){ echo $rowtrans['website_name']; }?>" placeholder="e.g. https://twitter.com/demo">
                            </div>
                            <div class="col-sm-1 text-center icheck-input-new">
                              <div class=""> <a class="btn btn-xs btn-primary mar_top_con_my" href="javascript:void(0);" onclick="return ajaxdeletetransdata('delete_social_trans_record','<?=$rowtrans['id']?>');"> <i class="fa fa-times"></i> </a> </div>
                            </div>
                          </div>
                          <?php } ?>
                          <?php } else { ?>
			...
			//$("#email_to").attr("placeholder","Enter Contact Name");
				   ...
				   <div class="delete_tag_trans_record<?=$rowtrans['id']?> padding-top-10 clear autooverflow">
					<div class="col-sm-8">
						...
						<input type="text" class="form-control parsley-validated" id="txt_tag" name="txt_tage[]" value="<?php if(!empty($rowtrans['tag'])){ echo $rowtrans['tag']; }?>" placeholder="e.g. Tag">
					</div>
					<div class="col-sm-1 text-center icheck-input-new">
					 <div class="">
			...
			<?php }else{ ?>
			 ...
			 <?php } */ ?>
                    ...
                    <div class="row add_communication_plan_div">
                      <div class="col-sm-8"> <strong>Assigned communication plan</strong>
                        <ul>
                          <?php
				...
				?>
                  ...
                  <div class="col-sm-12 pull-left text-center margin-top-10"> 
                    ...
                    <input type="submit" class="btn btn-secondary-green" value="Save Contact" onclick="return setdefaultdata();" name="submitbtn" />
              ...
              <form class="form parsley-form" enctype="multipart/form-data" name="<?php echo $viewname;?>ajax" id="<?php echo $viewname;?>" method="post" accept-charset="utf-8" action="<?php echo $this->config->item('user_base_url')?><?php echo $path?>" data-validate="parsley" novalidate >
                    ...
                    <div class="col-sm-8">
                      <div class="row">
                        ...
                        <div class="col-sm-7 form-group">
                          ...
                          <textarea id="txtarea_doc_desc" placeholder="e.g. Description" name="txtarea_doc_desc" class="form-control parsley-validated"><?php if(!empty($rowtrans['doc_desc'])){ echo $rowtrans['doc_desc']; } ?>
</textarea>
                        </div>
                        <div class="col-sm-7 form-group">
                        ...
                        <div class="col-sm-7 form-group margin-top-10">
                          <label >Allow File Tpe: txt,doc,docx,pdf,csv,xls,xlsx,jpg,jpeg,png,bmp,gif </label>
                          <input type="submit" class="btn btn-secondary" value="Save and Add More Document" onclick="return setsubmitidtab2(3);" id="submitbtn" name="submitbtn2" />
                        </div>
                      </div>
                    </div>
                ...
                <div class="col-sm-12 pull-left text-center">
                  ...
                  <input type="submit" class="btn btn-secondary-green" value="Save Contact" onclick="setsubmitidtab2(1);" id="savecontacttab2" name="submitbtn" />
            ...
            <form class="form parsley-form" enctype="multipart/form-data" name="<?php echo $viewname;?>" id="<?php echo $viewname;?>" method="post" accept-charset="utf-8" action="<?php echo $this->config->item('user_base_url')?><?php echo $path?>" data-validate="parsley" novalidate >
              <input id="id" name="id" type="hidden" value="<?php if(!empty($editRecord[0]['id'])){ echo $editRecord[0]['id']; }?>">
              <div class="col-sm-12 pull-left text-center margin-bottom-10">
                <input type="submit" title="Save Contact" class="btn btn-secondary-green" value="Save Contact" name="submitbtn" onclick="on_submit();" />
                <?php 
					if($right_buyer[0]['is_buyer_tab']== '1')
					{
				 ?>
          ...
          <form class="form parsley-form" enctype="multipart/form-data" name="<?php echo $viewname;?>" id="<?php echo $viewname;?>" method="post" accept-charset="utf-8" action="<?php echo $this->config->item('user_base_url')?><?php echo $path?>" data-validate="parsley" novalidate >
            <input id="id" name="id" type="hidden" value="<?php if(!empty($editRecord[0]['id'])){ echo $editRecord[0]['id']; }?>">
            <div class="col-sm-12 pull-left text-center margin-bottom-10">
              <input type="submit" title="Save Contact and Finish" class="btn btn-secondary-green" value="Save Contact and Finish" onclick="on_submit();" />
              <a class="btn btn-primary" title="Cancel" href="javascript:history.go(-1);">Cancel</a> </div>
            <div class="col-sm-12 clear">
              ...
              <div class="row">
                <div class="col-sm-8">
                  ...
                  <input id="txt_house_style" name="txt_house_style"  class="form-control parsley-validated" type="text"  value="<?php if(!empty($editRecord[0]['house_style'])){ echo htmlentities($editRecord[0]['house_style']); }?>" placeholder="e.g. House Style"/>
                </div>
              </div>
              <div class="row">
                <div class="col-sm-8">
              ...
              <div class="row">
                <div class="col-sm-8">
                  ...
                  <input id="txt_square_footage" name="txt_square_footage" class="form-control parsley-validated" type="text" value="<?php if(!empty($editRecord[0]['square_footage'])){ echo htmlentities($editRecord[0]['square_footage']); }?>"  placeholder="e.g. Footage" />
                </div>
              </div>
              <div class="row">
                <div class="col-sm-8">
              ...
              <div class="row">
                <div class="col-sm-8">
                  <label for="text-input">
                    <?=$this->lang->line('contact_add_no_of_bathrooms');?> (e.g. 1.5 Or 2)
                  </label>
                  <input id="txt_no_of_bathrooms" name="txt_no_of_bathrooms" class="form-control parsley-validated" type="text" value="<?php if(!empty($editRecord[0]['no_of_bathrooms'])){ echo $editRecord[0]['no_of_bathrooms']; }?>" onkeypress="return isNumberKeyDecimal(event)" placeholder="Number"  />
                </div>
              </div>
              <div class="row">
                <div class="col-sm-8">
                  ...
                  <textarea name="textarea_buyer_preferences_notes" placeholder="e.g. Notes"  id="textarea_buyer_preferences_notes" class="form-control parsley-validated"><?php if(!empty($editRecord[0]['buyer_preferences_notes'])){ echo $editRecord[0]['buyer_preferences_notes']; }?>
</textarea>
                </div>
              </div>
            </div>
...
<script type="text/javascript">
	...
	$('body').on('click','.add_new_social_profile',function(e){
		...
		inlinehtml += '<div class="remove_social_profile_div padding-top-10 clear autooverflow">';
		   ...
		   inlinehtml += '<div class="col-sm-5">';
			//inlinehtml += '<label for="text-input"><?=$this->lang->line('contact_add_website');?></label>';
			inlinehtml += '<input type="text" class="form-control parsley-validated fbid" id="txt_social_profile" name="txt_social_profile[]" placeholder="e.g. https://twitter.com/demo">';
		   inlinehtml += '</div>';
		   inlinehtml += '<div class="col-sm-1 text-center icheck-input-new">';
			inlinehtml += '<div class="">';
			 //inlinehtml += '<label>&nbsp;</label>';
		 ...
		 inlinehtml += '<div class="col-sm-6 columns">';
		  ...
		  inlinehtml += '<div class="row">';
		   ...
		   inlinehtml += '<div class="col-sm-4 nopadding">';
			inlinehtml += '<input type="text" placeholder="Zip Code" id="txt_zip_code" data-minlength="5" maxlength="5"  name="txt_zip_code[]" class="form-control parsley-validated">';
		   inlinehtml += '</div>';
		  inlinehtml += '</div>';
		  inlinehtml += '<div class="row">';
...
<style>
.portlet .portlet-content {min-height:1270px;}
