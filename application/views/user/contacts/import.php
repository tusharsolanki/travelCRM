      ...
      <div class="portlet-content">
       <div class="table-responsive">
        <div role="grid" class="dataTables_wrapper" id="DataTables_Table_0_wrapper">
         <div id="common_div">
		 <form class="form parsley-form" enctype="multipart/form-data" name="<?php echo $viewname;?>" id="<?php echo $viewname;?>" method="post" accept-charset="utf-8" action="<?php echo $this->config->item('user_base_url').$viewname.'/insert_contact_csv';?>" >
		 <div class="col-sm-12">
            <div class="row">
			<div class="col-sm-6 form-group clear">
				<label for="text-input"><a title="Download CSV" href="<?=$this->config->item('download_csv_path')?>" class="textdecoration import_only">Click here</a>  to Download Sample CSV File for Contacts.  </label>
			</div>
         	<div class="col-sm-6 form-group clear">
			...
			<div class="col-sm-6 form-group clear">
				<input type="submit" class="btn btn-secondary-green" value="Upload"  id="save" title="Upload" name="submitbtn" onclick="return checkfile();" />
...
<script type="text/javascript">
	$(function(){
		...
		new AjaxUpload(btnUpload1, {
			type: 'post',
			data:{},
			action: '<?=$this->config->item('user_base_url').$viewname."/upload_csv";?>',
			name: 'uploadfile',
