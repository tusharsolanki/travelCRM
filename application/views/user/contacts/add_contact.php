       ...
       <div class="table-responsive">
        <div role="grid" class="dataTables_wrapper" id="DataTables_Table_0_wrapper">
         <div id="common_div">
			...
			<form class="form parsley-form" enctype="multipart/form-data" name="<?php echo $viewname;?>" id="<?php echo $viewname;?>" method="post" accept-charset="utf-8" action="<?php echo $this->config->item('user_base_url').$viewname.'/insert_contact';?>" >
			<div class="col-sm-12">
            	<div class="row">
			...
			<div class="col-sm-12">
            	<div class="row">
					...
					<input type="submit" class="btn btn-secondary-green" title="Import Contacts" value="Import Contacts"  id="save" name="submitbtn" />
  ...
  function get_map_field(data)
    {
	 ...
	 $.ajax({
			type: "POST",
			url: "<?php echo $this->config->item('user_base_url').$viewname.'/get_filed_list';?>",
			dataType: 'json',
			async: false,
