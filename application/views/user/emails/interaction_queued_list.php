    ...
    <div class="col-md-12">
     <div class="portlet">
      <div class="portlet-header">
       <h3> <i class="fa fa-table"></i><?php if($viewname == 'emails')
      ...
      <div class="portlet-content">
       <div class="table_large-responsive">
        <div role="grid" class="dataTables_wrapper" id="DataTables_Table_0_wrapper">
         ...
         <?=$this->load->view('user/'.$viewname1.'/interaction_ajax_queued_list')?>
...
<script>
	...
	function contact_search(allflag)
	{
		...
		$.ajax({
			type: "POST",
			url: "<?php echo base_url();?>user/<?=$viewname?>/interaction_plan_queued_list/<?=$this->uri->segment(4)?>/"+uri_segment,
			data: {
