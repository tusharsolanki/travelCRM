                      ...
                      foreach($datalist as $row){?>
						<tr <? if($i%2==1){ ?>class="bgtitle" <? }?> > 
							...
							?>
							 ...
							 <td class="hidden-xs hidden-sm">
							 <a class="btn btn-xs btn-success" href="<?=$this->config->item('user_base_url').$viewname;?>/view_data/<?=!empty($row['email_campaign_id'])?$row['email_campaign_id']:'';?>/<?=$row['id']?>/all" title="View"> View </a>
							 </td>
                             <?php if($viewname == 'bomb_emails') { ?>
                            	<td class="hidden-xs hidden-sm">
