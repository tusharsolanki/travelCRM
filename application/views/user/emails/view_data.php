         ...
         <div class="tab-pane fade in active" id="home">
           ...
           <div class="col-sm-8">
             ...
             <div class="col-sm-12 form-group">
              <label for="text-input"><?=$this->lang->line('email_to');?> : </label>
             	<label for="text-input"><?=!empty($datalist[0]['first_name'])?ucwords($datalist[0]['first_name']):''?> <?=!empty($datalist[0]['last_name'])?ucwords($datalist[0]['last_name']):''?>
             ...
             <div class="col-sm-12 form-group">
              ...
              <label for="text-input"><?=!empty($email_cc)?$email_cc:''?></label>
             ...
             <div class="col-sm-12 form-group">
              ...
              <label for="text-input"><?=!empty($email_bcc)?$email_bcc:''?></label>
             </div>
            </div>
            	<?php } ?>
                ...
                <div class="row">
                 <div class="col-sm-12">
                  <label for="text-input"> Status : </label> <span class="email_status"> <?php if(!empty($datalist[0]['info'])) { ?> <img src="<?=$this->config->item('image_path').'ajax-loader.gif'?>" /> <?php } else echo "NA"; ?> </span>
                 </div>
               </div> 
                <div class="row">
                 <div class="col-sm-12">
             ...
             <label for="text-input"><?=!empty($datalist[0]['template_subject'])?$datalist[0]['template_subject']:''?> </label>
           </div>
          </div>
          </div>
          ...
          <div class="col-sm-4">
            ...
            <div class="attachfiel">
			 ...
			 ?>
			 	<a href="#" title="" onclick="download_file('<?=$attachment[$i]?>');"> <?=$attachment[$i]?></a><br />
			<?php
					}	
				}
			 ?>
          ...
          <div class="col-sm-12 pull-left text-center margin-top-10">
			...
			{
			?>
				<a class="btn btn-primary" href="<?php echo $this->config->item('user_base_url').$viewname."/all_sent_mail/".$pagingid; ?>" title="Back">Close</a>
			<?php } else { ?>
			<a class="btn btn-primary" onclick="history.go(-1)" href="<?php echo $this->config->item('user_base_url').$viewname."/sent_email/".$this->uri->segment(4)."/".$pagingid;?>" title="Back">Close</a>
			<?php } ?>
         </div>
          </form> 
         </div>
