    ...
    <div class="col-md-12">
     <div class="portlet">
      <div class="portlet-header">
       ...
       <span class="pull-right"><a title="Back" class="btn btn-secondary" href="<?php echo $this->config->item('user_base_url')?>leads_dashboard"><?php echo $this->lang->line('common_back_title')?></a> </span>
      </div>
      <!-- /.portlet-header -->
       ...
       <div class="table_large-responsive">
        <div role="grid" class="dataTables_wrapper" id="DataTables_Table_0_wrapper">
         ...
         <div class="row dt-rt">
          ...
          <a class="btn  pull-right btn-success howler" title="Add Plan" href="<?=base_url('user/'.$viewname.'/add_record');?>">Add Plan</a>
          <?php } ?>
          </div>
...
<script>
	...
	function contact_search(allflag)
	{
		...
		$.ajax({
			type: "POST",
			url: "<?php echo base_url();?>user/joomla_assign/"+uri_segment,
			data: {
	...
	function delete_all(id)
		{
			...
			success: function(data){
				...
				$.ajax({
					type: "POST",
					url: "<?php echo base_url();?>user/joomla_assign/"+data,
					data: {
...
function change_status(status,plan_id)
        {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo $this->config->item('user_base_url').$viewname.'/change_plan_status';?>",
                dataType: 'json',
                async: false,
