                        ...
                        <div class="col-sm-12">
                            <div class="tab-content" id="myTab1Content">
                                <div class="row tab-pane fade in active" id="home">
                                    <form class="form parsley-form" data-validate="parsley" enctype="multipart/form-data" name="<?php echo $viewname;?>" id="<?php echo $viewname;?>" method="post" accept-charset="utf-8" action="<?php echo $this->config->item('user_base_url')?><?php echo $path?>" novalidate onkeypress="return event.keyCode != 13;">
                                        ...
                                        <div class="col-sm-12 pull-left text-center margin-top-10">
                                            <input type="submit" class="btn btn-secondary" value="Save" title="Save" name="submitbtn" id="ja_submitbtn" onclick="return success_submit();" /> 
