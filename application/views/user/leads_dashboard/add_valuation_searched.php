                                        ...
                                        <div class="col-sm-8">
                                            <div class="row">
                                                <div class="col-sm-12 form-group">
                                                    ...
                                                    <input id="txt_search_address" readonly name="txt_search_address" placeholder="" class="form-control parsley-validated" type="text" value="<?php if(!empty($editRecord[0]['search_address'])){ echo $editRecord[0]['search_address'];}?>">
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-sm-12 form-group">
