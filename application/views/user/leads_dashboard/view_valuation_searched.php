                ...
                foreach($result_valuation_searched as $rvs){?>
                    <tr <? if($i%2==1){ ?>class="bgtitle" <? }?> > 
                        ...
                        <td class="hidden-xs hidden-sm text-center">
                            ...
                            <a class="btn btn-xs btn-success" title="Edit Valuation Searched" href="<?= $this->config->item('user_base_url').$viewname; ?>/edit_valuation_searched/<?= $rvs['id'] ?>"><i class="fa fa-pencil"></i></a> &nbsp; 
                        </td>
                    </tr>
                <?php } 
            } else {?>
