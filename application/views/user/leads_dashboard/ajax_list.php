...
<table class="table table-striped table-bordered table-hover table-highlight table-checkable dataTable-helper dataTable datatable-columnfilter" id="DataTables_Table_0" aria-describedby="DataTables_Table_0_info">
		 ...
		 //	pr($datalist);exit;
                      ...
                      foreach($datalist as $row){
                            ...
                            <?php } ?>
                                   ...
                                   <?php if(!empty($this->modules_unique_name) && in_array('lead_dashboard_delete',$this->modules_unique_name)){?>
                                    ...
                                    <? } ?>
                                        <td class="hidden-xs hidden-sm new_bold_class">
                                            <div class="radio">
						<label class="">
                                                    <div <?php if(!empty($row['joomla_contact_type']) && $row['joomla_contact_type'] == 'Buyer'){ echo 'class="fnt_bold '.$cls.'"'; } else { echo 'class="fnt_normal"';}?>>
                                            ...
                                            <div class="radio">
						<label class="">
                                                    <div <?php if(!empty($row['joomla_contact_type']) && $row['joomla_contact_type'] == 'Seller'){ echo 'class="fnt_bold '.$cls.'"'; } else { echo 'class="fnt_normal"';}?>>
                                            ...
                                            <div class="radio">
						<label class="">
                                                    <div <?php if(!empty($row['joomla_contact_type']) && $row['joomla_contact_type'] == 'Buyer/Seller'){ echo 'class="fnt_bold '.$cls.'"'; } else { echo 'class="fnt_normal"';}?>>
                                        ...
                                        <td class="hidden-xs hidden-sm ">
                                            <a title="View Contact" href="<?= $this->config->item('user_base_url')?>leads_dashboard/view_record/<?= $row['id'] ?>" class="textdecoration1 text_color_red"><?=!empty($row['contact_name'])?ucwords($row['contact_name']):'';?></a><br />
                                        ...
                                        <td class="hidden-xs hidden-sm ">
                                            <form class="form parsley-form" enctype="multipart/form-data" name="<?php echo $viewname;?><?=$row['id']?>" id="<?php echo $viewname;?><?=$row['id']?>" method="post" accept-charset="utf-8" action="<?php echo $this->config->item('user_base_url')?>leads_dashboard/property_contact_form/<?=$row['id']?>">
                                        ...
                                        <td class="hidden-xs hidden-sm ">
                                            ...
                                            <?php /*<b><?=!empty($row['total_properties_viewed'])?$row['total_properties_viewed']:'0';?></b> props*/ ?>
                                        </td>
                                        ...
                                        <td class="hidden-xs hidden-sm ">
                                            <?=!empty($row['assigned_agent_name'])?ucwords($row['assigned_agent_name']):'';?>
                                        </td>
                                        <td class="hidden-xs hidden-sm ">
                                            <?=!empty($row['assigned_lender_name'])?ucwords($row['assigned_lender_name']):'';?>
                                        </td>
                                        <? if(in_array('lead_dashboard_edit',$this->modules_unique_name) || in_array('lead_dashboard_delete',$this->modules_unique_name)){ ?>
                                        <td class="hidden-xs hidden-sm text-center">
                                            ...
                                            <a class="btn btn-xs btn-success"  title="Edit Contact" href="<?= $this->config->item('user_base_url'); ?>contacts/edit_record/<?= $row['id'] ?>"><i class="fa fa-pencil"></i></a> &nbsp;  <? } ?>
                                             <?php if(!empty($this->modules_unique_name) && in_array('lead_dashboard_delete',$this->modules_unique_name)){?>
          ...
          <?php } } else {?>
		  <tr>
		  	<td colspan="15" align="center"><?=$this->lang->line('user_general_noreocrds')?></td>
		  </tr>
