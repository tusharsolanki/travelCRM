...
?>
        ...
        <div id="common_div" class="dataTables_wrapper">
			<?php $this->load->view('user/'.$viewname.'/ajax_list_valuation_searched')?>
		</div>
		<div id="temp_dev" class="col-sm-12 text-center error"></div>
		 <div id="common_div1" class="dataTables_wrapper">
		 	
			<?php $this->load->view('user/'.$viewname.'/ajax_list_select_contact')?>
		</div>
		
         <?php /*?><?php $this->load->view('user/'.$viewname.'/ajax_list_assign_contact')?>
		 <?php $this->load->view('user/'.$viewname.'/ajax_list_select_contact')?><?php */?>
