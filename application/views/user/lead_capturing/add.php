      ...
      <div class="portlet-content">
       ...
       <div class="table_large-responsive">
              <div role="grid" class="dataTables_wrapper" id="DataTables_Table_0_wrapper">
                ...
                <div id="common_div">
				                     <form class="form parsley-form" data-validate="parsley" enctype="multipart/form-data" name="<?php echo $viewname;?>" id="<?php echo $viewname;?>" method="post" accept-charset="utf-8" action="<?php echo $this->config->item('user_base_url')?><?php echo $path?>" novalidate >
		  <input id="id" name="id" type="hidden" value="<?php if(!empty($editRecord[0]['id'])){ echo $editRecord[0]['id']; }?>">     
                      ...
                      <fieldset class="edit_main_div">
                        ...
                        <div class="col-lg-6 col-md-6 col-xs-12">
                          <div class="col-xs-12 mrgtop1 form-group">
                            ...
                            <input id="form_title" name="form_title" placeholder="e.g. Title" class="form-control parsley-validated" data-parsley-group="block2" type="text" value="<?php if(!empty($editRecord[0]['form_title'])){ echo htmlentities($editRecord[0]['form_title']); }?>" data-required="true">
                         ...
                         <!-- <div class="col-xs-1 mrgtop1">
                          ...
                          <div class="col-xs-11 mrgtop1">
                            <label for="text-input">Show Title In Form Builder</label>
						  </div>-->
                          ...
                          <div class="col-xs-12 mrgtop1">
                            <label for="text-input"><?=$this->lang->line('common_label_desc')?></label>
			  				<textarea name="form_desc" placeholder="e.g. Description" id="form_desc" class="form-control parsley-validated"><?php if(!empty($editRecord[0]['form_desc'])){ echo htmlentities($editRecord[0]['form_desc']); }?></textarea>
                          </div>
                          <!--<div class="col-xs-1 mrgtop1">
                          ...
                          <div class="col-xs-12 mrgtop22">
			    		   ...
			    		   <textarea name="success_msg" placeholder="e.g. Message" id="success_msg" class="form-control parsley-validated"><?php if(!empty($editRecord[0]['success_msg'])){ echo htmlentities($editRecord[0]['success_msg']); }?></textarea>
                          </div>
                          <div class="col-sm-12">
                              ...
                              <?php if(isset($userlist) && count($userlist) > 0){
                                            ...
                                            foreach($userlist as $row){
                                                if(!empty($row['id'])){?>
                                <option value='<?php echo $row['id'];?>' <?php if(isset($editRecord[0]['assign_user_id']) && $editRecord[0]['assign_user_id'] ==$row['id']){ echo "selected";}?> ><?=ucfirst(strtolower($row['first_name']." ".$row['middle_name']." ".$row['last_name'].$email));?></option>
                                <?php 		}
                                            }
                                        } ?>
                              </select>
              ...
              <option value="">Select Communication Plan</option>
                ...
                <?php 		}
                         ...
                         <? } */ ?>
                          <div class="col-xs-12 mrgtop1">
                            ...
                            <input id="form_width" name="form_width"  placeholder="Number" class="form-control parsley-validated" type="text" value="<?php if(!empty($editRecord[0]['form_width'])){ echo $editRecord[0]['form_width']; }?>" onkeypress="return isNumberKey(event);">

                          </div>
                          <div class="col-xs-12 mrgtop1">
                            <label for="text-input">Height (In px)</label>
                            <input id="form_height" name="form_height"  placeholder="Number" class="form-control parsley-validated" type="text" value="<?php if(!empty($editRecord[0]['form_height'])){ echo $editRecord[0]['form_height']; }?>" onkeypress="return isNumberKey(event);">

                          </div>
                          <div class="col-xs-12 mrgtop22">
                            <label for="text-input">Background Color</label>
                          <input class='simple_color form-control parsley-validated' value='<?=!empty($editRecord[0]['bg_color'])?$editRecord[0]['bg_color']:'#00b050';?>' name="bg_color" id="bg_color"/>
						  </div>
                        </div>
                      </fieldset>
                    </div>
               ...
               <select  ondblclick="addfieldtoeditor(); common_hide();" id="slt_customfields" name="slt_customfields" size="15" multiple="multiple" class="selectBox" >
                 ...
                 <input class="btn btn-secondary-green" type="button" name="submitbtn1" onclick="addfieldtoeditor(); common_hide();" title="Insert Field" value="Insert Field">
				  ...
				  <input type="submit" class="btn btn-secondary-green" value="Save Form" title="Save Form" name="submitbtn" onclick="return select_box();" />
				   <a title="Preview Form" class="btn btn-success mrg26" data-toggle="modal" href="#basicModal" onclick="preview();">Preview Form</a>
                                   <?php 
                                   ...
                                   <?php } ?>
                                   <a title="Cancel" class="btn  btn-danger mrg26" href="javascript:history.go(-1)">Cancel</a></div>
...
$('body').on('click', '#remScnt_square', function(){
 ...
 /*function name_edit(id)
 {
	...
	$("#name_edit").show();
        ...
        if(name == 'true' || jQuery.inArray("f_name"+id, id_array) != -1) {
            $('#name_is_required').attr("checked","checked");
        } else {
            $('#name_is_required').removeAttr("checked");
        }
 ...
 function web_edit(id)
 {
	...
	$("#file_edit").hide();
        ...
        $("#web_edit_id").val(id);
        var name = $('#website'+id).attr('data-required');
        //if(name == 'true') {
        if(name == 'true' || jQuery.inArray("website"+id, id_array) != -1) {
            $('#web_is_required').attr("checked","checked");
        } else {
            $('#web_is_required').removeAttr("checked");
        }
        $("#txt_web_edit").val($('#web'+id).html());
 }
...
/*function change_name_label(name,label_text)
 {
     var edit_id = $("#name_edit_id").val();
     if(label_text.trim() != '') {
        if(name == '1')
		{
            $('#fname_'+edit_id).text(label_text);
			if($('#name_is_required').is(":checked"))
			{
				$("#fname_"+edit_id).append('<span class="val"> *</span>');
			}
		}
