...
<div class="row add_communication_plan_div">
			<?php if(!isset($result_type) || (isset($result_type) && $result_type != 'ajax')) { ?>
			...
			?>
				<div id="myTab10Content" class="tab-content">
					...
					<div class="smart-drip-plan-con-box1 row tab-pane fade in active"  id="assigned_plans">
						<?=$this->load->view('user/interaction_plans/view_contact_popup');?>
					</div>
                   ...
                   <div class="con_srh">
					 ...
					 <form class="form parsley-form" enctype="multipart/form-data" name="<?php echo $viewname;?>" id="<?php echo $viewname;?>" method="post" accept-charset="utf-8" action="<?php echo $this->config->item('user_base_url').$viewname;?>/update_data" novalidate >
                    ...
                    <input id="txtarea_description" name="txtarea_description" type="hidden" value="<?=!empty($editRecord[0]['description'])?$editRecord[0]['description']:''?>">
                    <input id="txtarea_target_audience" name="txtarea_target_audience" type="hidden" value="<?=!empty($editRecord[0]['target_audience'])?$editRecord[0]['target_audience']:''?>">
                    <input id="plan_start_date" name="plan_start_date" type="hidden" value="<?=!empty($editRecord[0]['plan_start_type'])?$editRecord[0]['plan_start_type']:''?>">
                    ...
                    <div class="col-sm-12 add_new_contact_popup">
                      <div class="new_contact_popup">
                       	<?php 
							...
							echo $this->load->view('user/interaction_plans/contact_popup_ajax',$data);
						?>
                      </div>
                    </div>
