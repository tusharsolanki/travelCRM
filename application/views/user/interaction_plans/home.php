          ...
          <div class="portlet-content">
                ...
                <div class="row dt-rt">
                  ...
                  <div class="col-lg-3 col-md-3 text-center">
                    <div class="iconbox"><a id="configuration_view" href="<?=base_url('user/interaction_plans/add_record');?>"><img title="Add Communication Plan" alt="Add Communication Plan" src="<?=base_url()?>images/add-communication-plan-icon.jpg" class="img-responsive"><span>Add Communication Plan</span></a></div>
                  </div>
                  <? } ?>
                  <div class="col-lg-3 col-md-3 text-center">
                    <div class="iconbox"><a id="configuration_view" href="<?=base_url('user/interaction_plans');?>"><img title="View Existing Plans" alt="View Existing Plans" src="<?=base_url()?>images/view-existing-plans.jpg" class="img-responsive"><span>View Existing Plans</span></a></div>
                  </div>
                   <?php if(!empty($this->modules_unique_name) && in_array('communications_delete',$this->modules_unique_name)){?>
                  <div class="col-lg-3 col-md-3 text-center">
                    <div class="iconbox"><a id="configuration_view" href="<?=base_url('user/interaction_plans/view_archive');?>"><img title="View Archived Plans" alt="View Archived Plans" src="<?=base_url()?>images/view-archived-plans.jpg" class="img-responsive"><span>View Archived Plans</span></a></div>
                  </div>
                   <? } ?>
                </div>
                <form class="form parsley-form" enctype="multipart/form-data" name="pause_play_stop" id="pause_play_stop" method="post" accept-charset="utf-8" action="<?php echo $this->config->item('user_base_url')?>interaction_plans/all_pause_play_stop">
                <div class="row">
...
function plan_pause_play_stop(str,plan_status)
{
    ...
    var message = '<strong>Warning!</strong> Are you sure want to pause communication? <br> This function will pause communication plan. Schedule will be adjusted by number of paused days!';
  else
