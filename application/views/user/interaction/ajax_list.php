...
<table class="table table-striped table-bordered table-hover table-highlight table-checkable dataTable-helper dataTable datatable-columnfilter" id="DataTables_Table_0" aria-describedby="DataTables_Table_0_info">
          <thead>
           <tr role="row">
			...
			<th class="hidden-xs hidden-sm" data-filterable="true" role="columnheader" rowspan="1" colspan="1" aria-label="CSS grade" width="15%"><?=$this->lang->line('common_label_contacts')?></th>
          ...
          <?php if(!empty($datalist) && count($datalist)>0){
					...
					<?php if($row['start_type'] == '1'){
							...
							<?php if(isset($datalist[0]['plan_status']) && $datalist[0]['plan_status'] == 1){ ?>
							<td class="hidden-xs hidden-sm">
										<a title="Edit Action" class="btn btn-xs btn-success" href="<?= $this->config->item('user_base_url').$viewname; ?>/edit_record/<?= $row['id'] ?>"><i class="fa fa-pencil"></i></a> &nbsp; 
