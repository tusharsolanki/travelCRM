...
$('body').on('click','.add_new_category',function(e){
	...
	var frameSrc = '<?php echo $this->config->item('user_base_url')?>marketing_library_masters/add_record/iframe';
...
function selectnewcategory()
{
	$.ajax({
     type: "POST",
     url: "<?php echo $this->config->item('user_base_url').'email_library/ajax_category';?>",
     dataType: 'json',
	 data: {},
     cache: false,
     success: function(result){ 
