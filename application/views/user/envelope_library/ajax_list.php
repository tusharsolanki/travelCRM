<?php 
    /*
        @Description: user Tempalte Envelope
        @Author: Mit Makwana
        @Date: 12-08-2014
    */
...
<table class="table table-striped table-bordered table-hover table-highlight table-checkable dataTable-helper dataTable datatable-columnfilter" id="DataTables_Table_0" aria-describedby="DataTables_Table_0_info">
  ...
  <tbody role="alert" aria-live="polite" aria-relevant="all">
    ...
    <tr <? if($i%2==1){ ?>class="bgtitle" <? }
      ...
      <?  }
							?>
      <td class="hidden-xs hidden-sm "><a class="btn btn-secondary view_form_btn" data-toggle="modal" title="<?=$this->lang->line('common_label_preview')?>"  href="#basicModal" data-id="<?php echo  $row['id'] ?>">
	  ...
	  <?php if(!empty($this->modules_unique_name) && in_array('envelope_library_add',$this->modules_unique_name)){?>
