    ...
    <div class="col-md-12">
     <div class="portlet">
      <div class="portlet-header">
       <h3> <i class="fa fa-table"></i><?=$this->lang->line('envelope_library_header');?></h3>
      ...
      <ul class="nav nav-tabs" id="myTab1">
              <li <?php if($tabid == '' || $tabid == 1){?> class="active" <?php } ?>> <a title="<?=$this->lang->line('marketing_envelope_librery_my');?>" data-toggle="tab" href="#mydata" onclick="load_view('my_data');">
                <?=$this->lang->line('marketing_envelope_librery_my');?>
                </a> </li>
              <li <?php if($tabid == 2){?> class="active" <?php } ?>> <a title="<?=$this->lang->line('marketing_envelope_librery_default');?>" data-toggle="tab" href="#defaultdata" onclick="load_view('my_default');">
                <?=$this->lang->line('marketing_envelope_librery_default');?>
                </a> </li>
            </ul>
...
function load_view(id)
{
	...
	function contact_search(allflag)
	{
		...
		$.ajax({
			type: "POST",
			url: "<?php echo base_url();?>user/envelope_library/"+uri_segment,
			data: {
	...
	function delete_all(id)
		{
			...
			success: function(data){
				...
				$.ajax({
					type: "POST",
					url: "<?php echo base_url();?>user/envelope_library/",
					data: {
...
function default_search(allflag1)
	...
	$('body').on('click','#default_common_tb a.paginclass_A',function(e){
		...
		$('body').on('click','.view_form_btn',function(e){
			...
			var temp_size_ = $('#temp_size_'+id).text();
