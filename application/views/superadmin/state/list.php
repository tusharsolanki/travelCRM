            ...
            <div class="col-md-12">
                <div class="portlet">
                    <div class="portlet-header">
                        <h3> <i class="fa fa-table"></i><?=$this->lang->line('state_header');?></h3>
                    </div>
                    <div class="portlet-content">
                        <div class="table_large-responsive">
                            <div role="grid" class="dataTables_wrapper" id="DataTables_Table_0_wrapper">
                                    ...
                                    <div class="col-sm-11">
                                        <div class="dataTables_filter" id="DataTables_Table_0_filter">
                                            <label>
                                                ...
                                                <button class="btn btn-secondary howler" title="Search State" data-type="danger" onclick="contact_search();">Search</button>
                                                <button class="btn btn-secondary howler" title="View All State" data-type="danger" onclick="clearfilter_contact();">View All</button>
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                <div class="row dt-rt">
                                    <div class="col-sm-6">
                                        <button class="btn btn-danger howler" title="Delete State" data-type="danger" onclick="deletepopup1('0');">Delete State</button>
                                    </div>
                                    <div class="col-sm-6">
                                        <a title="Add State" class="btn pull-right btn-success howler" href="<?=base_url('superadmin/'.$viewname.'/add_record');?>">Add State</a>
                                    </div>
                                </div>
                                <div id="common_div">
...
<script>
    ...
    function contact_search()
    {
        $.ajax({
            type: "POST",
            url: "<?php echo base_url();?>superadmin/state/",
            data: {
    ...
    function delete_all(id)
    {
        ...
        $.ajax({
            ...
            success: function(data){
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url();?>superadmin/state/"+data,
                    data: {
                        result_type:'ajax',searchreport:$("#searchreport").val(),perpage:$("#perpage").val(),searchtext:$("#searchtext").val(),sortfield:$("#sortfield").val(),sortby:$("#sortby").val()
                    },
                    beforeSend: function() {
