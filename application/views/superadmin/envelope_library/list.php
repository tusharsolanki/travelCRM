...
<script>
	...
	function contact_search(allflag)
	{
		...
		$.ajax({
			type: "POST",
			url: "<?php echo base_url();?>superadmin/envelope_library/"+uri_segment,
			data: {
	...
	function delete_all(id)
		{
			...
			success: function(data){
				...
				$.ajax({
					type: "POST",
					url: "<?php echo base_url();?>superadmin/envelope_library/"+data,
					data: {
	...
	function update_data(id)
	 {
			...
			$.ajax({
				type: "POST",
				url: "<?php echo base_url();?>superadmin/envelope_library/update_publish",
				data: {
				id:id
			},
			beforeSend: function() {
