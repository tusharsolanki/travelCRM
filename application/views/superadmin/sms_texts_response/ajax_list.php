<?php 
    /*
        @Description: SMS Auto Response list
           ...
           <?php if(!empty($datalist) && count($datalist)>0){
					...
					?>
						<tr <? if($i%2==1){ ?>class="bgtitle" <? }?> > 
							...
							<a title="Unpublish Record" class="btn btn-xs btn-success" onclick="return status_change('0',<?= $row['id'] ?>,'<?=rawurlencode(ucfirst(strtolower($row['template_name'])))?>')" href="#"><i class="fa fa-check-circle"></i></a>	&nbsp;					

                                                  <? }else{ ?>
							<a title="Publish Record" class="btn btn-xs btn-primary" onclick="return status_change('1',<?= $row['id'] ?>,'<?=rawurlencode(ucfirst(strtolower($row['template_name'])))?>')" href="#"><i class="fa fa-times-circle"></i></a>	&nbsp;				  
