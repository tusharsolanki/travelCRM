    ...
    <div class="col-md-12">
     ...
     <div class="portlet">
      <div class="portlet-header">
       <h3> <i class="fa fa-tasks"></i> <?php if(empty($editRecord)){ echo $this->lang->line('smstexttemplate_add_head');}
	   else if(!empty($insert_data)){ echo $this->lang->line('smstexttemplate_add_head'); } 
	   else{ echo $this->lang->line('smstexttemplate_edit_head'); }?> </h3>
       ...
       <div class="col-sm-12">
        ...
        <div class="col-sm-12 clear">
          ...
          <div class="col-sm-8 form-group">
                  ...
                  <textarea name="sms_message" id="sms_message" placeholder="e.g. Message" data-required="true" class="form-control parsley-validated"  onkeypress="return keypress(event);"><?=!empty($editRecord[0]['sms_message'])?$editRecord[0]['sms_message']:'';?>
</textarea>
...
<input type="submit" class="btn btn-secondary-green" title="Save Template" value="Save Template" onclick="return setdefaultdata();" name="submitbtn" id="st_submitbtn" />
			<?php if($this->uri->segment(4) == 'iframe'){ ?>
...
function addfieldtoeditor()
{
	...
	//alert(text_length);
	//if(text_length < 180){
	var a=document.sms_texts.sms_message,b=document.<?php echo $viewname;?>.slt_customfields;
	if(b.options.length>0){
		...
		for(var c="",d=0,e=0;e<b.options.length;e++)
			...
			else if(document.sms_texts.sms_message.selectionStart||document.sms_texts.sms_message.selectionStart=="0"){
				b=document.sms_texts.sms_message.selectionEnd;
				d=document.sms_texts.sms_message.value;
				a.value = d.substring(0,document.sms_texts.sms_message.selectionStart)+c+d.substring(b,d.length);
