          ...
          <div class="portlet-content">
            <div class="col-sm-12">
              <div class="tab-content" id="myTab1Content">
                ...
                <form class="form parsley-form" enctype="multipart/form-data" name="<?php echo $viewname;?>" id="<?php echo $viewname;?>" method="post" accept-charset="utf-8" action="<?php echo $this->config->item('superadmin_base_url')?><?php echo $path?>" novalidate>
			   ...
			   ?>" data-required="true">
                    ...
                    <div class="col-sm-12 form-group">
                  	...
                  	<div class="row">
                      <div class="col-sm-6 form-group" id="fix">
             ...
             <?php } ?>
                 ...
                 <input class="btn btn-secondary" type="button" name="submitbtn1" onclick="addfieldtoeditor();" title="Insert Field" value="Insert Field">
                  ...
                  <div class="col-sm-12 pull-left text-center margin-top-10">
                    ...
                    <input type="submit" class="btn btn-secondary-green" value="Save Label Template" onclick="return setdefaultdata();" name="submitbtn" title="Save Template" />
