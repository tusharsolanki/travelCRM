                                        ...
                                        ?>
                                            ...
                                            <tr>
                                                <td class="text_capitalize" width="70%">
                                                    ...
                                                    <input type="text" class="form-control parsley-validated" name="plantype_update[]" id="plantype_<?=$row['id']?>" value="<?php echo  htmlentities($row['category']) ?>" />
                                                ...
                                                <td>
                                                    ...
                                                    <a href="javascript:void(0);" class="btn btn-xs btn-primary" onclick="deletepopup('<?=rawurlencode($row['category'])?>','<?php echo $this->lang->line('')?>','<?php echo $this->config->item('superadmin_base_url').$viewname;?>/delete_plan_type_record/<?php echo  $row['id'] ?>');"> <i class="fa fa-times"></i> </a> 
                                                </td> 
                                            </tr>
                                  <?php }
                                    ...
                                    <tr>
                                    <td>
                                    <a href="#" id="addScnt" title="Add Category Type" class="text_color_red text_size add_new_ta"><i class="fa fa-plus-square"></i> Add Category Type</a>
                                    </td>
                                    <td>&nbsp;</td>
                                    <td>&nbsp;</td>
                                    </tr>
