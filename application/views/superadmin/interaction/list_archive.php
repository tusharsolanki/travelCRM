	...
	function active_all_plans(name)
		{
			...
			success: function(data){
				...
				$.ajax({
					type: "POST",
					url: "<?php echo base_url();?>superadmin/interaction/<?php echo $plan_id; ?>/view_archive/"+data,
					data: {
...
<script>
	  ...
	  function applysortfilte_contact(sortfilter,sorttype)
		...
		function contact_search(allflag)
		{
			...
			$.ajax({
				type: "POST",
				url: "<?php echo base_url();?>superadmin/interaction/<?php echo $this->router->uri->segments[3]; ?>/view_archive/"+uri_segment,
				data: {
