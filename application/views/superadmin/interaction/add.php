        ...
        <div class="col-md-12">
          ...
          <div class="portlet">
			...
			<?php if(!empty($editRecord[0]['interaction_plan_id'])){?>
			  <span class="pull-right"><a title="Back" class="btn btn-secondary" href="<?php echo $this->config->item('superadmin_base_url')?><?php echo $viewname.'/'.$editRecord[0]['interaction_plan_id'];?>"><?php echo $this->lang->line('common_back_title')?></a> </span>
			  <?php }else {?>
			  <span class="pull-right"><a title="Back" class="btn btn-secondary" href="<?php echo $this->config->item('superadmin_base_url')?><?php echo $viewname.'/'.$inte_plan_id;?>"><?php echo $this->lang->line('common_back_title')?></a> </span> 			<?php } ?>
            </div>
            <!-- /.portlet-header -->
...
<option value="<?php echo $interaction_type[$i]['id'];?>" <?php if(!empty($editRecord[0]['interaction_type']) && $editRecord[0]['interaction_type'] == $interaction_type[$i]['id']){ echo "selected=selected"; } ?>><?php echo $interaction_type[$i]['name'];?></option>
                        ...
                        <div class="col-xs-12">
                          <fieldset class="edit_main_div">
                            ...
                            <div class="col-xs-12 mrgtop1 form-group">
                              ...
                              <textarea name="txtarea_description" id="txtarea_description" class="form-control" data-required="true"><?php if(!empty($editRecord[0]['description'])){ echo htmlentities($editRecord[0]['description']); }?></textarea>
                            </div>
                            <!--<div class="col-xs-12">
                              ...
                              <select  class="form-control parsley-validated" name="slt_assigned" id="slt_assigned">
								...
								<?php if(!empty($user_list)){
										foreach($user_list as $row){ ?>
                                			<option value="<?=$row['id']?>" <?php if(!empty($editRecord[0]['assign_to']) && $editRecord[0]['assign_to'] == $row['id']){ echo ' selected=selected '; }?> ><?php if($row['admin_name']!='') { echo ucwords($row['admin_name']);}else{ echo ucwords($row['user_name']);}?></option>
								<?php 	}
									} ?>
                              </select>
                            </div>-->
      ...
      <input type="text" class="form-control" id="txt_interaction_stat_1" value="<?php if(isset($editRecord[0]['number_count']) && $editRecord[0]['start_type'] == '1'){ echo $editRecord[0]['number_count'];}?>" name="txt_interaction_stat_1" placeholder="Number" onkeypress="return isNumberKey(event);" >
                              ...
                              <div class="row" id="interaction_state">
                                ...
                                <div class="col-sm-3">
                                  <input type="text" class="form-control" id="txt_interaction_stat_2"  name="txt_interaction_stat_2" value="<?php if(!empty($editRecord[0]['number_count']) && $editRecord[0]['start_type'] == '2'){ echo $editRecord[0]['number_count'];  }?>" placeholder="Number" onkeypress="return isNumberKey(event);">
                                </div>
                                <div class="col-sm-3">
                                ...
                                <div class="col-sm-2">
                                  <label for="text-input" style="line-height:14px;">After a Preceding Action</label>
                                </div>
                                <div class="col-sm-3">
                                  <select class="form-control parsley-validated" name="slt_interaction_stat_2" id="slt_interaction_stat_2">
									...
									?>
									<option value="<?php echo $interaction_list[$i]['id'];?>" <?php if(!empty($editRecord[0]['interaction_id']) && $editRecord[0]['interaction_id'] == $interaction_list[$i]['id'] && $editRecord[0]['start_type'] == '2' ){ echo "selected=selected"; } ?> ><?php echo ucfirst($interaction_list[$i]['description']);?></option>
									<?php 
												}
                                             }
                                     ?>
                            ...
                            <div class="col-xs-12">
                              <div class="row">
                                ...
                                <div class="col-sm-3 mrg">
                                  <input type="text" value="<?php if(!empty($editRecord[0]['drop_after_day']) && $editRecord[0]['drop_type'] == '2'){ echo $editRecord[0]['drop_after_day']; }?>" name="txt_drop_after_day"  id="txt_drop_after_day" class="form-control" placeholder="Number" onkeypress="return isNumberKey(event);">
                            ...
                            <div class="col-xs-12 mrgb2">
                              ...
                              <textarea class="form-control" name="txtarea_interaction_notes"><?php if(!empty($editRecord[0]['interaction_notes'])){ echo htmlentities($editRecord[0]['interaction_notes']); }?></textarea>
                            </div>
                          </fieldset>
                        </div>
                      </div>
                            ...
                            <legend class="edit_title">Email/SMS</legend>
							 ...
							 <div class="col-sm-12 mrgtop1 div_only_email">
								...
								<?php if(isset($attachment) && count($attachment) > 0) { 
										$this->load->view('superadmin/interaction/attachmentlist');
									}
								 ?>
							 </div>
