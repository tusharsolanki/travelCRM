    ...
    <div class="col-md-12">
     <div class="portlet">
      <div class="portlet-header">
       <h3> <i class="fa fa-table"></i><?=$this->lang->line('admin_header');?></h3>
      </div>
      <div class="portlet-content">
       <div class="table_large-responsive">
        <div role="grid" class="dataTables_wrapper" id="DataTables_Table_0_wrapper">
          ...
          <div class="col-sm-11">
           <div class="dataTables_filter" id="DataTables_Table_0_filter">
            ...
            <input class="" type="hidden" name="uri_segment" id="uri_segment" value="<?=!empty($uri_segment)?$uri_segment:'0'?>">
			 ...
			 <button class="btn btn-secondary howler" title="Search Admin" data-type="danger" onclick="contact_search('changesearch');">Search</button>
         ...
         <div class="row dt-rt">
          <div class="col-sm-6">
           <button class="btn btn-danger howler" title="Delete Admin" data-type="danger" onclick="deletepopup1('0');">Delete Admin</button>
          </div>
          <div class="col-sm-6">
         <?php /*?> <? if(!empty($admin_list)) {?>
           ...
           <? } ?><?php */?>
          <a title="Add Admin" class="btn pull-right btn-secondary-green howler " href="<?=base_url('superadmin/'.$viewname.'/add_record');?>">Add Admin</a>
...
<script>
	...
	function contact_search(allflag)
	{
		...
		$.ajax({
			type: "POST",
			url: "<?php echo base_url();?>superadmin/admin_management/"+uri_segment,
			data: {
		...
		if(status == 0)
				{
						...
						msg = 'Are you sure want to inactive admin ';
				}else
				{
						path = "<?= $this->config->item('superadmin_base_url').$viewname; ?>/publish_record/"+id;
						msg = 'Are you sure want to  active admin ';
				}
	   ...
	   'action': function(){
			...
			$.ajax({
				...
				success: function(data){
						...
						$.ajax({
							type: "POST",
							url: "<?php echo base_url();?>superadmin/admin_management/"+data,
							data: {
							result_type:'ajax',searchreport:$("#searchreport").val(),perpage:$("#perpage").val(),searchtext:$("#searchtext").val(),sortfield:$("#sortfield").val(),sortby:$("#sortby").val()
						},
						beforeSend: function() {
