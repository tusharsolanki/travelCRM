<?php 
    /*
        @Description: superadmin email_library list
      ...
      <div class="portlet-content">
        ...
        <div role="grid" class="dataTables_wrapper" id="DataTables_Table_0_wrapper">
         ...
         <div class="row dt-rt">
          ...
          <div class="col-sm-6">
          <a class="btn  pull-right btn-secondary-green howler" href="<?=base_url('superadmin/'.$viewname.'/add_record');?>" title="Add Template">Add Auto Responder</a>
          </div>
         </div>
...
<script>
	...
	function contact_search(allflag)
	{
		...
		$.ajax({
			type: "POST",
			url: "<?php echo base_url();?>superadmin/auto_responder/"+uri_segment,
			data: {
	...
	function delete_all(id)
		{
			...
			success: function(data){
				...
				$.ajax({
					type: "POST",
					url: "<?php echo base_url();?>superadmin/auto_responder/"+data,
					data: {
	...
	{      
			...
			else
			{
				...
				if(name.length > 50)
				{
					var	name1 = unescape(name).substr(0, 50)+'...';
					var msg = 'Are you sure want to delete "'+name1+'"';
				}
				else
				{
	...
	function update_data(id)
	 {
			...
			$.ajax({
				type: "POST",
				url: "<?php echo base_url();?>superadmin/auto_responder/update_publish",
				data: {
				id:id
			},
			beforeSend: function() {
