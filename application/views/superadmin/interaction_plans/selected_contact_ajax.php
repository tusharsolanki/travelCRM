...
if(!empty($contacts_data)){
  ...
  <tr class="<?php if($i%2==0){echo 'odd';}else{echo 'even';}$i++;?>">
	...
	<?php /*?><td class="text-center"><a href="javascript:void(0);" class="btn btn-xs btn-primary remove_selected_contact" data-group="<?=!empty($row['interaction_plan_id'])?$row['interaction_plan_id']:'';?>" data-id="<?=!empty($row['id'])?$row['id']:'';?>"> <i class="fa fa-times"></i></a></td><?php */?>
  </tr>
<?php } ?>
<?php }else{ ?>
	<tr>
