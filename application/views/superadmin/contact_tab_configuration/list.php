...
?>
 <div id="content">
  <div id="content-header">
   <h1><?=$this->lang->line('superadmin_contact_tab_config');?></h1>
  </div>
    ...
    <div class="col-md-12">
     <div class="portlet">
      <div class="portlet-header">
       <h3> <i class="fa fa-table"></i><?=$this->lang->line('superadmin_contact_tab_config');?></h3>
      </div>
       ...
       <div class="table_large-responsive">
        <div role="grid" class="dataTables_wrapper" id="DataTables_Table_0_wrapper">
          ...
          <div class="col-sm-11">
           <div class="dataTables_filter" id="DataTables_Table_0_filter">
            <label>
			 ...
			 <button class="btn btn-secondary howler" title="Search Admin" data-type="danger" onclick="contact_search();">Search</button>
         ...
         <!--<div class="row dt-rt">
          ...
          <div class="col-sm-6">
          <a title="Add Admin" class="btn pull-right btn-success howler" href="<?=base_url('superadmin/'.$viewname.'/add_record');?>">Add Admin</a>
          </div>
         </div>-->
         <div id="common_div">
