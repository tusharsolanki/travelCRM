...
<?php
	...
	isset($editProperyStatusRecord) ? $loadcontroller='update_property_status' : $loadcontroller='insert_property_status';
  		$path_property_status = $viewname."/".$loadcontroller;
  	
	//pr($property_listing_status);
	//echo $path = $viewname."/".$loadcontroller; 
?>
  ...
  <div class="col-md-12">
    <div class="portlet">
      <div class="portlet-header">
        ...
        <!--<span class="float-right margin-top--15"><a class="btn btn-secondary" title="Back" href="<?=base_url('superadmin/livewire_configuration');?>"><?php echo $this->lang->line('common_back_title')?></a> </span>--> </div>
      <!-- /.portlet-header -->
      ...
      <div class="portlet-content" style="max-height:none;">
        <div class="">
          <div class="chart_bg1 tbl_border"> 
                ...
                <div class="mrg-bottom-40">
                  ...
                  <div class="portlet-content">
					...
					?>
                      ...
                      <tr>
                        <td class="text_capitalize" width="70%"><input type="text" class="form-control parsley-validated" name="property_list_update[]" id="property_list_<?=$row['id']?>" value="<?php echo  htmlentities($row['name']) ?>" /><input type="hidden" class="form-control parsley-validated" name="property_idd[]" id="" value="<?php echo  $row['id'] ?>"/> </td>
                        <td>
                          <a href="javascript:void(0);" onclick="getsubmit('<?=$row['id']?>')" title="Update record" class="btn btn-xs btn-success"><i class="fa fa-pencil"></i></a> <a href="javascript:void(0);" class="btn btn-xs btn-primary"onclick="deletepopup('<?=rawurlencode(ucfirst(strtolower(($row['name']))))?>','<?php echo $this->lang->line('')?>','<?php echo $this->config->item('superadmin_base_url').$viewname;?>/delete_property_list_record/<?php echo  $row['id'] ?>');"> <i class="fa fa-times"></i> </a>
                          </td>
                      </tr>
                      <?php }}?>
                      ...
                      <tr>
                        <td colspan="2"><div id="p_scents" class="form-group">
                            ...
                            <p>
                              <label for="p_scnts">
                                <input type="text" class="form-control parsley-validated" data-required="required" name="property_list_type[0]" id="property_list_type[0]" value="<?=isset($editRecord) ? $editRecord[0]['name'] : ''?>" />
                              </label>
                            </p>
                            <?php } ?>
                          </div></td>
            ...
            <!-- document_list TYPE-->
            <form class="form parsley-form" enctype="multipart/form-data" name="<?php echo $viewname;?>" id="<?php echo $viewname;?>" method="post" accept-charset="utf-8" action="<?php echo $this->config->item('superadmin_base_url')?><?php echo $path_document_list?>" >
              <div class="col-md-6">
                <div class="mrg-bottom-40">
                  <div class="portlet-header">
                    <h3>
                    <!-- <i class="fa fa-tasks"></i>--> 
					<?php echo $this->lang->line('label_document_type')?> </h3>
                  </div>
                  <div class="portlet-content">
                    <table width="100%" class="iconment_title_in" >
                      <tr>
				...
				?>
                      ...
                      <tr>
                        <td class="text_capitalize" width="70%"><input type="text" class="form-control parsley-validated" name="document_list_update[]" id="document_list_<?=$row['id']?>" value="<?php echo  htmlentities($row['name']) ?>"/><input type="hidden" class="form-control parsley-validated" name="document_idd[]" id="" value="<?php echo  $row['id'] ?>"/></td>
                        <td>
                          <a href="javascript:void(0);" onclick="get_submit_document_list('<?=$row['id']?>')" title="Update record" class="btn btn-xs btn-success"><i class="fa fa-pencil"></i></a> <a href="javascript:void(0);" class="btn btn-xs btn-primary"onclick="deletepopup('<?=rawurlencode(ucfirst(strtolower(($row['name']))))?>','<?php echo $this->lang->line('')?>','<?php echo $this->config->item('superadmin_base_url').$viewname;?>/delete_document_list_record/<?php echo  $row['id'] ?>');"> <i class="fa fa-times"></i> </a>
                          </td>
                      </tr>
                      <?php }}?>
                    </table>
            ...
            <!-- LOT TYPE-->
            <form  class="form parsley-form" enctype="multipart/form-data" name="<?php echo $viewname;?>" id="<?php echo $viewname;?>" method="post" accept-charset="utf-8" action="<?php echo $this->config->item('superadmin_base_url')?><?php echo $path_lot_type?>" >
              <div class="col-md-6">
                <div class="mrg-bottom-40">
                  <div class="portlet-header">
                    <h3> 
                  ...
                  <div class="portlet-content">
					...
					?>
                      ...
                      <tr>
                        <td class="text_capitalize" width="70%"><input type="text" class="form-control parsley-validated" name="lot_type_update[]" id="lot_type_<?=$row['id']?>" value="<?php echo  htmlentities($row['name']) ?>" /><input type="hidden" class="form-control parsley-validated" name="lot_idd[]" id="" value="<?php echo  $row['id'] ?>"/></td>
                        <td>
                          <a href="javascript:void(0);" onclick="get_submit_lot_type('<?=$row['id']?>')" title="Update record" class="btn btn-xs btn-success"><i class="fa fa-pencil"></i></a> <a href="javascript:void(0);" class="btn btn-xs btn-primary"onclick="deletepopup('<?=rawurlencode(ucfirst(strtolower(($row['name']))))?>','<?php echo $this->lang->line('')?>','<?php echo $this->config->item('superadmin_base_url').$viewname;?>/delete_lot_type_record/<?php echo  $row['id'] ?>');"> <i class="fa fa-times"></i> </a>
                          </td>
                      </tr>
                      <?php }}?>
                    </table>
            ...
            <!-- Transaction TYPE-->
            <form  class="form parsley-form" enctype="multipart/form-data" name="<?php echo $viewname;?>" id="<?php echo $viewname;?>" method="post" accept-charset="utf-8" action="<?php echo $this->config->item('superadmin_base_url')?><?php echo $path_trasaction?>" >
              <div class="col-md-6">
                <div class="mrg-bottom-40">
                  <div class="portlet-header">
                  ...
                  <div class="portlet-content">
					...
					?>
                      ...
                      <tr>
                        <td class="text_capitalize" width="70%"><input type="text" class="form-control parsley-validated" name="transaction_update[]" id="transaction_<?=$row['id']?>" value="<?php echo  htmlentities($row['name']) ?>" /><input type="hidden" class="form-control parsley-validated" name="transaction_idd[]" id="" value="<?php echo  $row['id'] ?>"/></td>
                        <td>
                          <a href="javascript:void(0);" onclick="get_submit_transaction('<?=$row['id']?>')" title="Update record" class="btn btn-xs btn-success"><i class="fa fa-pencil"></i></a> <a href="javascript:void(0);" class="btn btn-xs btn-primary"onclick="deletepopup('<?=rawurlencode(ucfirst(strtolower(($row['name']))))?>','<?php echo $this->lang->line('')?>','<?php echo $this->config->item('superadmin_base_url').$viewname;?>/delete_transaction_record/<?php echo  $row['id'] ?>');"> <i class="fa fa-times"></i> </a>
                          </td>
                      </tr>
                      <?php }}?>
                    </table>
            ...
            <!-- lockbox TYPE-->
            <form  class="form parsley-form" enctype="multipart/form-data" name="<?php echo $viewname;?>" id="<?php echo $viewname;?>" method="post" accept-charset="utf-8" action="<?php echo $this->config->item('superadmin_base_url')?><?php echo $path_lockbox?>" >
              <div class="col-md-6">
                <div class="mrg-bottom-40">
                  <div class="portlet-header">
                    <h3> 
                  ...
                  <div class="portlet-content">
					...
					?>
                      ...
                      <tr>
                        <td class="text_capitalize" width="70%"><input type="text" class="form-control parsley-validated" name="lockbox_update[]" id="lockbox_<?=$row['id']?>" value="<?php echo  htmlentities($row['name']) ?>"  /><input type="hidden" class="form-control parsley-validated" name="lock_idd[]" id="" value="<?php echo  $row['id'] ?>"/></td>
                        <td>
                          <a href="javascript:void(0);" onclick="get_submit_lockbox('<?=$row['id']?>')" title="Update record" class="btn btn-xs btn-success"><i class="fa fa-pencil"></i></a> <a href="javascript:void(0);" class="btn btn-xs btn-primary"onclick="deletepopup('<?=rawurlencode(ucfirst(strtolower(($row['name']))))?>','<?php echo $this->lang->line('')?>','<?php echo $this->config->item('superadmin_base_url').$viewname;?>/delete_lockbox_record/<?php echo  $row['id'] ?>');"> <i class="fa fa-times"></i> </a>
                          </td>
                      </tr>
                      <?php }}?>
                    </table>
            ...
            <!-- SEWER TYPE-->
            <form  class="form parsley-form" enctype="multipart/form-data" name="<?php echo $viewname;?>" id="<?php echo $viewname;?>" method="post" accept-charset="utf-8" action="<?php echo $this->config->item('superadmin_base_url')?><?php echo $path_sewer?>" >
			  <div class="col-md-6">
			  <div class="mrg-bottom-40">
			  <div class="portlet-header">
					<h3>
			  ...
			  <table width="100%" class="iconment_title_in" >
				...
				<tr>
				  <td class="text_capitalize" width="70%">
						...
						<input type="text" class="form-control parsley-validated" name="sewer_update[]" id="sewer_<?=$row['id']?>" value="<?php echo  htmlentities($row['name']) ?>"  />
					...
					<td>
						...
						<a href="javascript:void(0);" class="btn btn-xs btn-primary"onclick="deletepopup('<?=rawurlencode(ucfirst(strtolower(($row['name']))))?>','<?php echo $this->lang->line('')?>','<?php echo $this->config->item('superadmin_base_url').$viewname;?>/delete_sewer_record/<?php echo  $row['id'] ?>');"> <i class="fa fa-times"></i> </a>
				  </td>
				</tr>
				<?php }}?>
			  </table>
            ...
            <!-- BASEMENT TYPE-->
			<form  class="form parsley-form" enctype="multipart/form-data" name="<?php echo $viewname;?>" id="<?php echo $viewname;?>" method="post" accept-charset="utf-8" action="<?php echo $this->config->item('superadmin_base_url')?><?php echo $path_basement?>" >
			  <div class="col-md-6">
			  <div class="mrg-bottom-40">
			  <div class="portlet-header">
					<h3>
			  ...
			  <table width="100%" class="iconment_title_in" >
				...
				<tr>
				  <td class="text_capitalize" width="70%">
						...
						<input type="text" class="form-control parsley-validated" name="basement_update[]" id="basement_<?=$row['id']?>" value="<?php echo  htmlentities($row['name']) ?>"  />
				...
				<td>
						...
						<a href="javascript:void(0);" class="btn btn-xs btn-primary"onclick="deletepopup('<?=rawurlencode(ucfirst(strtolower(($row['name']))))?>','<?php echo $this->lang->line('basement_head_submodel')?>','<?php echo $this->config->item('superadmin_base_url').$viewname;?>/delete_basement_record/<?php echo  $row['id'] ?>');"> <i class="fa fa-times"></i> </a>
            ...
            <!-- ARCHITECTURE TYPE-->
           <form  class="form parsley-form" enctype="multipart/form-data" name="<?php echo $viewname;?>" id="<?php echo $viewname;?>" method="post" accept-charset="utf-8" action="<?php echo $this->config->item('superadmin_base_url')?><?php echo $path_architecture?>" >
			  <div class="col-md-6">
			  <div class="mrg-bottom-40">
			  <div class="portlet-header">
					<h3>
			  ...
			  <table width="100%" class="iconment_title_in" >
				...
				<tr>
				  <td class="text_capitalize" width="70%">
						...
						<input type="text" class="form-control parsley-validated" name="architecture_update[]" id="architecture_<?=$row['id']?>" value="<?php echo  htmlentities($row['name']) ?>" />
					...
					<td>
						...
						<a href="javascript:void(0);" class="btn btn-xs btn-primary"onclick="deletepopup('<?=rawurlencode(ucfirst(strtolower(($row['name']))))?>','<?php echo $this->lang->line('')?>','<?php echo $this->config->item('superadmin_base_url').$viewname;?>/delete_architecture_record/<?php echo  $row['id'] ?>');"> <i class="fa fa-times"></i> </a> 
            ...
            <!-- ENERGY SOURCE TYPE-->
			<form  class="form parsley-form" enctype="multipart/form-data" name="<?php echo $viewname;?>" id="<?php echo $viewname;?>" method="post" accept-charset="utf-8" action="<?php echo $this->config->item('superadmin_base_url')?><?php echo $path_energySource?>" >
			  <div class="col-md-6">
			  <div class="mrg-bottom-40">
			  <div class="portlet-header">
					<h3>
			  ...
			  <table width="100%" class="iconment_title_in" >
				...
				<tr>
				  <td class="text_capitalize" width="70%">
						...
						<input type="text" class="form-control parsley-validated" name="energy_source_update[]" id="energy_source_<?=$row['id']?>" value="<?php echo  htmlentities($row['name']) ?>" />
					...
					<td>
						...
						<a href="javascript:void(0);" class="btn btn-xs btn-primary"onclick="deletepopup('<?=rawurlencode(ucfirst(strtolower(($row['name']))))?>','<?php echo $this->lang->line('')?>','<?php echo $this->config->item('superadmin_base_url').$viewname;?>/delete_energy_source_record/<?php echo  $row['id'] ?>');"> <i class="fa fa-times"></i> </a> 
			...
			<form  class="form parsley-form" enctype="multipart/form-data" name="<?php echo $viewname;?>" id="<?php echo $viewname;?>" method="post" accept-charset="utf-8" action="<?php echo $this->config->item('superadmin_base_url')?><?php echo $path_exterior_finish?>" >
			  <div class="col-md-6">
			  <div class="mrg-bottom-40">
			  <div class="portlet-header">
					<h3>
			  ...
			  <table width="100%" class="iconment_title_in" >
				...
				<tr>
				  <td class="text_capitalize" width="70%">
						...
						<input type="text" class="form-control parsley-validated" name="exterior_finish_update[]" id="exterior_finish_<?=$row['id']?>" value="<?php echo  htmlentities($row['name']) ?>" />
					...
					<td>
						...
						<a href="javascript:void(0);" class="btn btn-xs btn-primary"onclick="deletepopup('<?=rawurlencode(ucfirst(strtolower(($row['name']))))?>','<?php echo $this->lang->line('')?>','<?php echo $this->config->item('superadmin_base_url').$viewname;?>/delete_exterior_finish_record/<?php echo  $row['id'] ?>');"> <i class="fa fa-times"></i> </a> 
            ...
            <!-- FIREPLACE TYPE-->
            <form  class="form parsley-form" enctype="multipart/form-data" name="<?php echo $viewname;?>" id="<?php echo $viewname;?>" method="post" accept-charset="utf-8" action="<?php echo $this->config->item('superadmin_base_url')?><?php echo $path_fireplace?>" >
			  <div class="col-md-6">
			  <div class="mrg-bottom-40">
			  <div class="portlet-header">
					<h3>
			  ...
			  <table width="100%" class="iconment_title_in" >
				...
				<tr>
				  <td class="text_capitalize" width="70%">
						...
						<input type="text" class="form-control parsley-validated" name="fireplace_update[]" id="fireplace_<?=$row['id']?>" value="<?php echo  htmlentities($row['name']) ?>" />
					...
					<td>
						...
						<a href="javascript:void(0);" class="btn btn-xs btn-primary"onclick="deletepopup('<?=rawurlencode(ucfirst(strtolower(($row['name']))))?>','<?php echo $this->lang->line('')?>','<?php echo $this->config->item('superadmin_base_url').$viewname;?>/delete_fireplace_record/<?php echo  $row['id'] ?>');"> <i class="fa fa-times"></i> </a> 
			  ...
			  <table width="100%">
            	...
            	<!-- FLOOR COVERING TYPE-->
			<form  class="form parsley-form" enctype="multipart/form-data" name="<?php echo $viewname;?>" id="<?php echo $viewname;?>" method="post" accept-charset="utf-8" action="<?php echo $this->config->item('superadmin_base_url')?><?php echo $path_floorcover?>" >
			  <div class="col-md-6">
			  <div class="mrg-bottom-40">
			  <div class="portlet-header">
					<h3>
			  ...
			  <table width="100%" class="iconment_title_in" >
				...
				<tr>
				  <td class="text_capitalize" width="70%">
						...
						<input type="text" class="form-control parsley-validated" name="floor_covering_update[]" id="floor_covering_<?=$row['id']?>" value="<?php echo  htmlentities($row['name']) ?>" />
					...
					<td>
						...
						<a href="javascript:void(0);" class="btn btn-xs btn-primary"onclick="deletepopup('<?=rawurlencode(ucfirst(strtolower(($row['name']))))?>','<?php echo $this->lang->line('')?>','<?php echo $this->config->item('superadmin_base_url').$viewname;?>/delete_floor_covering_record/<?php echo  $row['id'] ?>');"> <i class="fa fa-times"></i> </a>
            ...
            <!-- FOUNDATION TYPE-->
			<form  class="form parsley-form" enctype="multipart/form-data" name="<?php echo $viewname;?>" id="<?php echo $viewname;?>" method="post" accept-charset="utf-8" action="<?php echo $this->config->item('superadmin_base_url')?><?php echo $path_foundation?>" >
			  <div class="col-md-6">
			  <div class="mrg-bottom-40">
			  <div class="portlet-header">
					<h3>
			  ...
			  <table width="100%" class="iconment_title_in" >
				...
				<tr>
				  <td class="text_capitalize" width="70%">
						...
						<input type="text" class="form-control parsley-validated" name="foundation_update[]" id="foundation_<?=$row['id']?>" value="<?php echo  htmlentities($row['name']) ?>" />
					...
					<td>
						...
						<a href="javascript:void(0);" class="btn btn-xs btn-primary"onclick="deletepopup('<?=rawurlencode(ucfirst(strtolower(($row['name']))))?>','<?php echo $this->lang->line('')?>','<?php echo $this->config->item('superadmin_base_url').$viewname;?>/delete_foundation_record/<?php echo  $row['id'] ?>');"> <i class="fa fa-times"></i> </a>
			...
			<form  class="form parsley-form" enctype="multipart/form-data" name="<?php echo $viewname;?>" id="<?php echo $viewname;?>" method="post" accept-charset="utf-8" action="<?php echo $this->config->item('superadmin_base_url')?><?php echo $path_green_certification?>" >
			  <div class="col-md-6">
			  <div class="mrg-bottom-40">
			  <div class="portlet-header">
					<h3>
			  ...
			  <table width="100%" class="iconment_title_in" >
				...
				<tr>
				  <td class="text_capitalize" width="70%">
						...
						<input type="text" class="form-control parsley-validated" name="green_certification_update[]" id="green_certification_<?=$row['id']?>" value="<?php echo  htmlentities($row['name']) ?>" />
					...
					<td>
						...
						<a href="javascript:void(0);" class="btn btn-xs btn-primary"onclick="deletepopup('<?=rawurlencode(ucfirst(strtolower(($row['name']))))?>','<?php echo $this->lang->line('')?>','<?php echo $this->config->item('superadmin_base_url').$viewname;?>/delete_green_certification_record/<?php echo  $row['id'] ?>');"> <i class="fa fa-times"></i> </a>
			...
			<form  class="form parsley-form" enctype="multipart/form-data" name="<?php echo $viewname;?>" id="<?php echo $viewname;?>" method="post" accept-charset="utf-8" action="<?php echo $this->config->item('superadmin_base_url')?><?php echo $path_heating_cooling?>" >
			  <div class="col-md-6">
			  <div class="mrg-bottom-40">
			  <div class="portlet-header">
					<h3>
			  ...
			  <table width="100%" class="iconment_title_in" >
				...
				<tr>
				  <td class="text_capitalize" width="70%">
						...
						<input type="text" class="form-control parsley-validated" name="heating_cooling_update[]" id="heating_cooling_<?=$row['id']?>" value="<?php echo  htmlentities($row['name']) ?>" />
					...
					<td>
						...
						<a href="javascript:void(0);" class="btn btn-xs btn-primary"onclick="deletepopup('<?=rawurlencode(ucfirst(strtolower(($row['name']))))?>','<?php echo $this->lang->line('')?>','<?php echo $this->config->item('superadmin_base_url').$viewname;?>/delete_heating_cooling_record/<?php echo  $row['id'] ?>');"> <i class="fa fa-times"></i> </a>
			...
			<form  class="form parsley-form" enctype="multipart/form-data" name="<?php echo $viewname;?>" id="<?php echo $viewname;?>" method="post" accept-charset="utf-8" action="<?php echo $this->config->item('superadmin_base_url')?><?php echo $path_interior_feature?>" >
			  <div class="col-md-6">
			  <div class="mrg-bottom-40">
			  <div class="portlet-header">
					<h3>
			  ...
			  <table width="100%" class="iconment_title_in" >
				...
				<tr>
				  <td class="text_capitalize" width="70%">
						...
						<input type="text" class="form-control parsley-validated" name="interior_feature_update[]" id="interior_feature_<?=$row['id']?>" value="<?php echo  htmlentities($row['name']) ?>" />
					...
					<td>
						...
						<a href="javascript:void(0);" class="btn btn-xs btn-primary"onclick="deletepopup('<?=rawurlencode(ucfirst(strtolower(($row['name']))))?>','<?php echo $this->lang->line('')?>','<?php echo $this->config->item('superadmin_base_url').$viewname;?>/delete_interior_feature_record/<?php echo  $row['id'] ?>');"> <i class="fa fa-times"></i> </a>
            ...
            <!-- PARKING TYPE-->
			<form  class="form parsley-form" enctype="multipart/form-data" name="<?php echo $viewname;?>" id="<?php echo $viewname;?>" method="post" accept-charset="utf-8" action="<?php echo $this->config->item('superadmin_base_url')?><?php echo $path_parking?>" >
			  <div class="col-md-6">
			  <div class="mrg-bottom-40">
			  <div class="portlet-header">
					<h3>
			  ...
			  <table width="100%" class="iconment_title_in" >
				...
				<tr>
				  <td class="text_capitalize" width="70%">
						...
						<input type="text" class="form-control parsley-validated" name="parking_update[]" id="parking_<?=$row['id']?>" value="<?php echo  htmlentities($row['name']) ?>" />
					...
					<td>
						...
						<a href="javascript:void(0);" class="btn btn-xs btn-primary"onclick="deletepopup('<?=rawurlencode(ucfirst(strtolower(($row['name']))))?>','<?php echo $this->lang->line('')?>','<?php echo $this->config->item('superadmin_base_url').$viewname;?>/delete_parking_type_record/<?php echo  $row['id'] ?>');"> <i class="fa fa-times"></i> </a>
            ...
            <!-- POWER COMPANY TYPE-->
			<form  class="form parsley-form" enctype="multipart/form-data" name="<?php echo $viewname;?>" id="<?php echo $viewname;?>" method="post" accept-charset="utf-8" action="<?php echo $this->config->item('superadmin_base_url')?><?php echo $path_power_company?>" >
			  <div class="col-md-6">
			  <div class="mrg-bottom-40">
			  <div class="portlet-header">
					<h3>
			  ...
			  <table width="100%" class="iconment_title_in" >
				...
				<tr>
				  <td class="text_capitalize" width="70%">
						...
						<input type="text" class="form-control parsley-validated" name="power_company_update[]" id="power_company_<?=$row['id']?>" value="<?php echo  htmlentities($row['name']) ?>" />
					...
					<td>
						...
						<a href="javascript:void(0);" class="btn btn-xs btn-primary"onclick="deletepopup('<?=rawurlencode(ucfirst(strtolower(($row['name']))))?>','<?php echo $this->lang->line('')?>','<?php echo $this->config->item('superadmin_base_url').$viewname;?>/delete_power_company_record/<?php echo  $row['id'] ?>');"> <i class="fa fa-times"></i> </a>
            ...
            <!-- ROOF MASTER TYPE-->
			<form  class="form parsley-form" enctype="multipart/form-data" name="<?php echo $viewname;?>" id="<?php echo $viewname;?>" method="post" accept-charset="utf-8" action="<?php echo $this->config->item('superadmin_base_url')?><?php echo $path_roof_master?>" >
			  <div class="col-md-6">
			  <div class="mrg-bottom-40">
			  <div class="portlet-header">
					<h3>
			  ...
			  <table width="100%" class="iconment_title_in" >
				...
				<tr>
				  <td class="text_capitalize" width="70%">
						...
						<input type="text" class="form-control parsley-validated" name="roof_master_update[]" id="roof_master_<?=$row['id']?>" value="<?php echo  htmlentities($row['name']) ?>" />
					...
					<td>
						...
						<a href="javascript:void(0);" class="btn btn-xs btn-primary"onclick="deletepopup('<?=rawurlencode(ucfirst(strtolower(($row['name']))))?>','<?php echo $this->lang->line('')?>','<?php echo $this->config->item('superadmin_base_url').$viewname;?>/delete_roof_master_record/<?php echo  $row['id'] ?>');"> <i class="fa fa-times"></i> </a>
            ...
            <!-- SEWER COMPANY TYPE-->
			<form  class="form parsley-form" enctype="multipart/form-data" name="<?php echo $viewname;?>" id="<?php echo $viewname;?>" method="post" accept-charset="utf-8" action="<?php echo $this->config->item('superadmin_base_url')?><?php echo $path_sewer_company?>" >
			  <div class="col-md-6">
			  <div class="mrg-bottom-40">
			  <div class="portlet-header">
					<h3>
			  ...
			  <table width="100%" class="iconment_title_in" >
				...
				<tr>
				  <td class="text_capitalize" width="70%">
						...
						<input type="text" class="form-control parsley-validated" name="sewer_company_update[]" id="sewer_company_<?=$row['id']?>" value="<?php echo  htmlentities($row['name']) ?>" />
					...
					<td>
						...
						<a href="javascript:void(0);" class="btn btn-xs btn-primary"onclick="deletepopup('<?=rawurlencode(ucfirst(strtolower(($row['name']))))?>','<?php echo $this->lang->line('')?>','<?php echo $this->config->item('superadmin_base_url').$viewname;?>/delete_sewer_company_record/<?php echo  $row['id'] ?>');"> <i class="fa fa-times"></i> </a>
			  ...
			  <table width="100%">
            	...
            	<!-- STYLE MASTER TYPE-->
			<form  class="form parsley-form" enctype="multipart/form-data" name="<?php echo $viewname;?>" id="<?php echo $viewname;?>" method="post" accept-charset="utf-8" action="<?php echo $this->config->item('superadmin_base_url')?><?php echo $path_style_master?>" >
			  <div class="col-md-6">
			  <div class="mrg-bottom-40">
			  <div class="portlet-header">
					<h3>
			  ...
			  <table width="100%" class="iconment_title_in" >
				...
				<tr>
				  <td class="text_capitalize" width="70%">
						...
						<input type="text" class="form-control parsley-validated" name="style_master_update[]" id="style_master_<?=$row['id']?>" value="<?php echo  htmlentities($row['name']) ?>" />
					...
					<td>
						...
						<a href="javascript:void(0);" class="btn btn-xs btn-primary"onclick="deletepopup('<?=rawurlencode(ucfirst(strtolower(($row['name']))))?>','<?php echo $this->lang->line('')?>','<?php echo $this->config->item('superadmin_base_url').$viewname;?>/delete_style_master_record/<?php echo  $row['id'] ?>');"> <i class="fa fa-times"></i> </a>
			  ...
			  <table width="100%">
            	...
            	<!-- WATER COMPANY TYPE-->
			<form  class="form parsley-form" enctype="multipart/form-data" name="<?php echo $viewname;?>" id="<?php echo $viewname;?>" method="post" accept-charset="utf-8" action="<?php echo $this->config->item('superadmin_base_url')?><?php echo $path_water_company?>" >
			  <div class="col-md-6">
			  <div class="mrg-bottom-40">
			  <div class="portlet-header">
					<h3>
			  ...
			  <table width="100%" class="iconment_title_in" >
				...
				<tr>
				  <td class="text_capitalize" width="70%">
						...
						<input type="text" class="form-control parsley-validated" name="water_company_update[]" id="water_company_<?=$row['id']?>" value="<?php echo  htmlentities($row['name']) ?>" />
					...
					<td>
						...
						<a href="javascript:void(0);" class="btn btn-xs btn-primary"onclick="deletepopup('<?=rawurlencode(ucfirst(strtolower(($row['name']))))?>','<?php echo $this->lang->line('')?>','<?php echo $this->config->item('superadmin_base_url').$viewname;?>/delete_water_company_record/<?php echo  $row['id'] ?>');"> <i class="fa fa-times"></i> </a>
			...
			<form  class="form parsley-form" enctype="multipart/form-data" name="<?php echo $viewname;?>" id="<?php echo $viewname;?>" method="post" accept-charset="utf-8" action="<?php echo $this->config->item('superadmin_base_url')?><?php echo $path_property_status?>" >
			  <div class="col-md-6">
			  <div class="mrg-bottom-40">
			  <div class="portlet-header">
					<h3>
			  ...
			  <table width="100%" class="iconment_title_in" >
				...
				<?php
					if(!empty($property_listing_status) && count($property_listing_status)>0){
					foreach($property_listing_status as $row)
					{   
					?>
				<tr>
				  <td colspan="2">
				...
				<tr>
				  <td class="text_capitalize" width="70%">
						...
						<input type="text" class="form-control parsley-validated" name="property_status_update[]" id="property_status_<?=$row['id']?>" value="<?php echo  htmlentities($row['name']) ?>" />
                        
                        <input type="hidden" class="form-control parsley-validated" name="property_status_idd[]" id="" value="<?php echo  $row['id'] ?>"/>
                        
					</td>
					<td>
					
						<a href="javascript:void(0);" onclick="get_property_status('<?=$row['id']?>')" title="Update record" class="btn btn-xs btn-success"><i class="fa fa-pencil"></i></a>
						<a href="javascript:void(0);" class="btn btn-xs btn-primary"onclick="deletepopup('<?=rawurlencode($row['name'])?>','<?php echo $this->lang->line('')?>','<?php echo $this->config->item('superadmin_base_url').$viewname;?>/delete_property_status/<?php echo  $row['id'] ?>');"> <i class="fa fa-times"></i> </a>
			  ...
			  <table width="100%">
				<tr>
				   <input type="hidden" id="property_status_id" name="property_status_id" class="property_status_id" value="<?=isset($editProperyStatusRecord) ? $editProperyStatusRecord[0]['id']:''?>" />
				  <td colspan="2"><div id="p_property_status" class="form-group">
					 <?php if(empty($property_listing_status) || count($property_listing_status) == 0){?>
					  <p>
						<label for="p_property_status">
					<input type="text" class="form-control parsley-validated" data-required="required" name="property_status_type[0]" id="property_status_type[0]" value="<?=isset($editProperyStatusRecord) ? htmlentities($editProperyStatusRecord[0]['name']) : ''?>" />
						</label>
				...
				<tr>
				<td>
					<a href="#" id="addScnt_property_status" title="Add Property Status" class="text_color_red text_size add_new_ta"><i class="fa fa-plus-square"></i> Add Status Type</a>
					</td>
					<td>&nbsp;</td>
				</tr>
				
				<tr>
				  <td><input type="submit" style="width:auto;" class="btn btn-primary margin_tops" value="Save" name="type" onclick="return setdefaultdata('<?=$viewname?>');">
				  </td>
				  <td>&nbsp;</td>
				</tr>
			  </table>
...
<script type="text/javascript">
$(function() {
        var scntDiv = $('#p_property_status');
        var i = $('#p_property_status p').size();
		$('body').on('click', '#addScnt_property_status', function(){
        $('<p><label for="p_scnts_phone"><input type="text" class="form-control parsley-validated" data-required="required" name="property_status_type[' + i +']" id="property_status_type[' + i +']"/> </label>&nbsp;<a href="#" id="remScnt_property_status" class="btn btn-xs btn-primary margin_tops"><i class="fa fa-times"></i></a></p>').appendTo(scntDiv);
                i++;
                return false;
        });      
		$('body').on('click', '#remScnt_property_status', function(){
                if( i > 0 ) {
                        $(this).parents('p').remove();
                        i--;
                }
...
function getsubmit(id)
{
	...
	else
	{
		...
		$.ajax({
		type: "POST",
		url: '<?=base_url()?>superadmin/<?=$viewname;?>/update_property_list',
...
function get_submit_document_list(id)
{
	...
	else
	{
		...
		$.ajax({
		type: "POST",
		url: '<?=base_url()?>superadmin/<?=$viewname;?>/update_document_list',
...
function get_submit_lot_type(id)
{
	...
	else
	{
		...
		$.ajax({
		type: "POST",
		url: '<?=base_url()?>superadmin/<?=$viewname;?>/update_lot_type',
...
function get_submit_transaction(id)
{
	...
	else
	{
		...
		$.ajax({
		type: "POST",
		url: '<?=base_url()?>superadmin/<?=$viewname;?>/update_transaction',
...
function get_submit_lockbox(id)
{
	...
	else
	{
		...
		$.ajax({
		type: "POST",
		url: '<?=base_url()?>superadmin/<?=$viewname;?>/update_lockbox',
...
function get_submit_sewer(id)
{
	...
	else
	{
		...
		$.ajax({
		type: "POST",
		url: '<?=base_url()?>superadmin/<?=$viewname;?>/update_sewer',
...
function get_submit_basement(id)
{
	...
	else
	{
		...
		$.ajax({
		type: "POST",
		url: '<?=base_url()?>superadmin/<?=$viewname;?>/update_basement',
...
function get_submit_architecture(id)
{
	...
	else
	{
		...
		$.ajax({
		type: "POST",
		url: '<?=base_url()?>superadmin/<?=$viewname;?>/update_architecture',
...
function get_submit_energy_source(id)
{
	...
	else
	{
		...
		$.ajax({
		type: "POST",
		url: '<?=base_url()?>superadmin/<?=$viewname;?>/update_energy_source',
...
function get_submit_exterior_finish(id)
{
	...
	else
	{
		...
		$.ajax({
		type: "POST",
		url: '<?=base_url()?>superadmin/<?=$viewname;?>/update_exterior_finish',
...
function get_submit_fireplace(id)
{
	...
	else
	{
		...
		$.ajax({
		type: "POST",
		url: '<?=base_url()?>superadmin/<?=$viewname;?>/update_fireplace',
...
function get_submit_floor_covering(id)
{
	...
	else
	{
		...
		$.ajax({
		type: "POST",
		url: '<?=base_url()?>superadmin/<?=$viewname;?>/update_floor_covering',
...
function get_submit_foundation(id)
{
	...
	else
	{
		...
		$.ajax({
		type: "POST",
		url: '<?=base_url()?>superadmin/<?=$viewname;?>/update_foundation',
...
function get_submit_green_certification(id)
{
	...
	else
	{
		...
		$.ajax({
		type: "POST",
		url: '<?=base_url()?>superadmin/<?=$viewname;?>/update_green_certification',
...
function get_submit_heating_cooling(id)
{
	...
	else
	{
		...
		$.ajax({
		type: "POST",
		url: '<?=base_url()?>superadmin/<?=$viewname;?>/update_heating_cooling',
...
function get_submit_interior_feature(id)
{
	...
	else
	{
		...
		$.ajax({
		type: "POST",
		url: '<?=base_url()?>superadmin/<?=$viewname;?>/update_interior_feature',
...
function get_submit_parking(id)
{
	...
	else
	{
		...
		$.ajax({
		type: "POST",
		url: '<?=base_url()?>superadmin/<?=$viewname;?>/update_parking_type',
...
function get_submit_power_company(id)
{
	...
	else
	{
		...
		$.ajax({
		type: "POST",
		url: '<?=base_url()?>superadmin/<?=$viewname;?>/update_power_company',
...
function get_submit_roof_master(id)
{
	...
	else
	{
		...
		$.ajax({
		type: "POST",
		url: '<?=base_url()?>superadmin/<?=$viewname;?>/update_roof_master',
...
function get_submit_sewer_company(id)
{
	...
	else
	{
		...
		$.ajax({
		type: "POST",
		url: '<?=base_url()?>superadmin/<?=$viewname;?>/update_sewer_company',
...
function get_submit_style_master(id)
{
	...
	else
	{
		...
		$.ajax({
		type: "POST",
		url: '<?=base_url()?>superadmin/<?=$viewname;?>/update_style_master',
...
function get_submit_water_company(id)
{
	...
	else
	{
		...
		$.ajax({
		type: "POST",
		url: '<?=base_url()?>superadmin/<?=$viewname;?>/update_water_company',
...
<!-- Property Status COMPANY TYPE-->
<script type="text/javascript">
function get_property_status(id)
{
	var property_status = $("#property_status_"+id).val();
	...
	else
	{
		...
		$.ajax({
		type: "POST",
		url: '<?=base_url()?>superadmin/<?=$viewname;?>/update_property_status',
		data: { property_status_type:property_status,property_status_id:id },
		cache: true,
		success: function(html)
		{
