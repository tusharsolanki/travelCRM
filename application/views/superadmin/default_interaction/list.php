        ...
        <div role="grid" class="dataTables_wrapper" id="DataTables_Table_0_wrapper">
         ...
         <div class="row dt-rt">
          ...
          <div class="col-sm-6">
		   ...
		   <a class="btn  pull-right btn-secondary howler margin-left-5px" href="<?=base_url('superadmin/'.$viewname."/".$plan_id.'/view_archive');?>" title="View Archive">View Archive</a>
	...
	function active_all_plans(name)
		{
			...
			success: function(data){
				...
				$.ajax({
					type: "POST",
					url: "<?php echo base_url();?>superadmin/<?=$viewname?>/<?php echo $plan_id.'/'; ?>"+data.page,
					data: {
...
<script>
	  ...
	  function applysortfilte_contact(sortfilter,sorttype)
		...
		function contact_search(allflag)
		{
			...
			$.ajax({
				type: "POST",
				url: "<?php echo base_url();?>superadmin/<?=$viewname?>/<?php echo $this->router->uri->segments[3]; ?>/"+uri_segment,
				data: {
	...
	function delete_all(id)
		{
			...
			success: function(data){
				$.ajax({
					type: "POST",
					url: "<?php echo base_url();?>superadmin/<?=$viewname?>/<?php echo $plan_id; ?>",
					data: {
					result_type:'ajax',searchreport:$("#searchreport").val(),perpage:$("#perpage").val(),searchtext:$("#searchtext").val(),sortfield:$("#sortfield").val(),sortby:$("#sortby").val()
				},
				beforeSend: function() {
