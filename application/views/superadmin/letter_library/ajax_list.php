...
<? } ?>
							...
							<td class="hidden-xs hidden-sm ">
							<a class="btn btn-xs btn-success" href="<?= $this->config->item('superadmin_base_url').$viewname; ?>/copy_record/<?= $row['id'] ?>" title="Copy Record"><i class="fa fa-copy copyicon8"></i></a> &nbsp; 
