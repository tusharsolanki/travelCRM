...
<script>
	...
	function contact_search(allflag)
	{
		...
		$.ajax({
			type: "POST",
			url: "<?php echo base_url();?>superadmin/email_library/"+uri_segment,
			data: {
	...
	function delete_all(id)
		{
			...
			success: function(data){
				...
				$.ajax({
					type: "POST",
					url: "<?php echo base_url();?>superadmin/email_library/"+data,
					data: {
...
$('body').on('click','.view_form_btn',function(e){
    ...
    function Popup() 
    {
	 ...
	 function update_data(id)
	 {
			...
			$.ajax({
				type: "POST",
				url: "<?php echo base_url();?>superadmin/email_library/update_publish",
				data: {
				id:id
			},
			beforeSend: function() {
