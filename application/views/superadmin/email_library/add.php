          ...
          <div class="row form-group">
             <div class="col-sm-12 checkbox">
              ...
              <div class="float-left margin-left-15">
                <input <?php if(!empty($editRecord[0]['is_unsubscribe']) && $editRecord[0]['publish_flag']=='1'){ echo 'checked="checked"';}?> type="checkbox" class="" name="publish_flag" value="1">
              </div>
              </label>
             </div>
            </div>
...
function selectnewcategory()
{
	$.ajax({
     type: "POST",
     url: "<?php echo $this->config->item('superadmin_base_url').$viewname.'/ajax_category';?>",
     dataType: 'json',
	 data: {},
     cache: false,
     success: function(result){ 
