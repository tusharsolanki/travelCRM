<?php 
    /*
        @Description: superadmin social media post list
     ...
     <div class="portlet">
      ...
      <div class="portlet-content">
        ...
        <div role="grid" class="dataTables_wrapper" id="DataTables_Table_0_wrapper">
          ...
          <div class="col-sm-11">
           <div class="dataTables_filter" id="DataTables_Table_0_filter">
            <label>
                ...
                <input class="" type="text" name="searchtext" title="Search Text" id="searchtext" aria-controls="DataTables_Table_0" placeholder="Search..." value="<?=!empty($searchtext)?$searchtext:''?>">
                <button class="btn btn-secondary howler" title="Search Template" data-type="danger" onclick="contact_search('changesearch');">Search</button>
         ...
         <div class="row dt-rt">
          <div class="col-sm-6">
           <button class="btn btn-danger howler" title="Delete Template" data-type="danger" onclick="deletepopup1('0');">Delete Template</button>
          </div>
          <div class="col-sm-6">
          <a title="Add Template" class="btn pull-right btn-secondary-green howler" href="<?=base_url('superadmin/'.$viewname.'/add_record');?>">Add Template</a>
          </div>
         </div>
...
<script>
	...
	function contact_search(allflag)
	{
		...
		$.ajax({
			type: "POST",
			url: "<?php echo base_url();?>superadmin/socialmedia_post/"+uri_segment,
			data: {
	...
	function delete_all(id)
		{
			...
			success: function(data){
				...
				$.ajax({
					type: "POST",
					url: "<?php echo base_url();?>superadmin/socialmedia_post/"+data,
					data: {
	...
	{      
			...
			else
			{
				...
				if(name.length > 50)
					msg = 'Are you sure want to delete "'+unescape(name).substr(0, 50)+'...'+'"';
			}
	...
	function update_data(id)
	 {
			...
			$.ajax({
				type: "POST",
				url: "<?php echo base_url();?>superadmin/socialmedia_post/update_publish",
				data: {
				id:id
			},
			beforeSend: function() {
