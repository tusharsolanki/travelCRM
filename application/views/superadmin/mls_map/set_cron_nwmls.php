                    ...
                    <div class="portlet-content">
                        <div class="col-sm-12">
                            <div class="tab-content" id="myTab1Content">
                                ...
                                <h2>Insert data to mapping database</h2>
                                        ...
                                        <div class="col-sm-12 col-lg-12">
                                            <div class="row">
                                                <div class="col-sm-12 form-group">
                                                    ...
                                                    ?>
                                                    <?=$path?>mls_update/retrieve_office_data/<?=$id?>
                                                    <? /* <a href="<?=$path?>mls_update/retrieve_office_data/<?=$id?>" ><?=$path?>mls_update/retrieve_office_data/<?=$id?></a> */?>
                                                    <a title="Set Cron" id="import_office_map" class="btn btn-primary" href="javascript:void(0);" onclick="set_cron('retrieve_office_data','<?=$id?>','','update');">Set Cron</a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-12 col-lg-12">
                                            <div class="row">
                                                <div class="col-sm-12 form-group">
                                                    ...
                                                    ?>
                                                    <?=$path?>mls_update/retrieve_member_data/<?=$id?>
                                                    <? /* <a href="<?=$path?>mls_update/retrieve_member_data/<?=$id?>" ><?=$path?>mls_update/retrieve_member_data/<?=$id?></a> */ ?>
                                                    <a title="Set Cron" id="retrieve_member_data" class="btn btn-primary" href="javascript:void(0);" onclick="set_cron('retrieve_member_data','<?=$id?>','','update');">Set Cron</a>
                                                </div>
                                            </div>
                                        </div>    
                                        <div class="col-sm-12 col-lg-12">
                                            <div class="row">
                                                <div class="col-sm-12 form-group">
                                                    ...
                                                    ?>
                                                    <?=$path?>mls_update/retrieve_school_data/<?=$id?>
                                                    <? /* <a href="<?=$path?>mls_update/retrieve_school_data/<?=$id?>" ><?=$path?>mls_update/retrieve_school_data/<?=$id?></a> */?>
                                                    <a title="Set Cron" id="retrieve_school_data" class="btn btn-primary" href="javascript:void(0);" onclick="set_cron('retrieve_school_data','<?=$id?>','','update');">Set Cron</a>
                                                </div>
                                            </div>
                                        </div>   
                                        <div class="col-sm-12 col-lg-12">
                                            <div class="row">
                                                <div class="col-sm-12 form-group">
                                                    ...
                                                    ?>
                                                    <?=$path?>mls_update/retrieve_amenity_data/<?=$id?>
                                                    <? /* <a href="<?=$path?>mls_update/retrieve_amenity_data/<?=$id?>" ><?=$path?>mls_update/retrieve_amenity_data/<?=$id?></a> */?>
                                                    <a title="Set Cron" id="retrieve_amenity_data" class="btn btn-primary" href="javascript:void(0);" onclick="set_cron('retrieve_amenity_data','<?=$id?>','','update');">Set Cron</a>
                                                </div>
                                            </div>
                                        </div>   
                                        <div class="col-sm-12 col-lg-12">
                                            <div class="row">
                                                <div class="col-sm-12 form-group">
                                                    ...
                                                    ?>
                                                    <?=$path?>mls_update/retrieve_area_community_data/<?=$id?>
                                                    <? /*<a href="<?=$path?>mls_update/retrieve_area_community_data/<?=$id?>" ><?=$path?>mls_update/retrieve_area_community_data/<?=$id?></a> */?>
                                                    <a title="Set Cron" id="retrieve_area_community_data" class="btn btn-primary" href="javascript:void(0);" onclick="set_cron('retrieve_area_community_data','<?=$id?>','','update');">Set Cron</a>
                                                </div>
                                            </div>
                                        </div>   
                                        <div class="col-sm-12 col-lg-12">
                                            <div class="row">
                                                <div class="col-sm-12 form-group">
                                                    ...
                                                    ?>
                                                    <?=$path?>mls_update/retrieve_listing_data/<?=$id?>
                                                    <?php /*<a href="<?=$path?>mls_update/retrieve_listing_data/<?=$id?>" ><?=$path?>mls_update/retrieve_listing_data/<?=$id?></a> */?>
                                                    <a title="Set Cron" id="retrieve_listing_data" class="btn btn-primary" href="javascript:void(0);" onclick="set_cron('retrieve_listing_data','<?=$id?>','','update');">Set Cron</a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-12 col-lg-12">
                                            <div class="row">
                                                <div class="col-sm-12 form-group">
                                                    ...
                                                    ?>
                                                    <?=$path?>mls_update/retrieve_listing_history_data/<?=$id?>
                                                    <?php /* <a href="<?=$path?>mls_update/retrieve_listing_history_data/<?=$id?>" ><?=$path?>mls_update/retrieve_listing_history_data/<?=$id?></a> */?>
                                                    <a title="Set Cron" id="retrieve_listing_history_data" class="btn btn-primary" href="javascript:void(0);" onclick="set_cron('retrieve_listing_history_data','<?=$id?>','','update');">Set Cron</a>
                                                </div>
                                            </div>
                                        </div>    
                                        <div class="col-sm-12 col-lg-12">
                                            <div class="row">
                                                <div class="col-sm-12 form-group">
                                                    ...
                                                    ?>
                                                    <?=$path?>mls_update/retrieve_image_data/<?=$id?>
                                                    <?php /* <a href="<?=$path?>mls_update/retrieve_image_data/<?=$id?>" ><?=$path?>mls_update/retrieve_image_data/<?=$id?></a> */?>
                                                    <a title="Set Cron" id="retrieve_image_data" class="btn btn-primary" href="javascript:void(0);" onclick="set_cron('retrieve_image_data','<?=$id?>','','update');">Set Cron</a>
                                                </div>
                                            </div>
                                        </div>    
