...
<html class=""><!--<![endif]-->
<?php
$data=$this->session->userdata($this->lang->line('common_superadmin_session_label'));
...
<title><?="LiveWire-CRM Superadmin";?></title>
<meta charset="utf-8">
...
<body>
<div id="wrapper">
 <h1 id="site-logo"><a href="<?=base_url('superadmin');?>"><img src="<?php echo $this->config->item('image_path');?>logo.png" alt="Site Logo"></a></h1>
 ...
 <nav id="top-bar" class="collapse top-bar-collapse">
  ...
  if(!empty($admin_name))
  {
   ...
   elseif(($admin_name[0]['user_type'])==4)
	  {
		  $type = " Assistant ";
	  } 
  }
  ?>
   <li class="dropdown"> <a class="dropdown-toggle" data-toggle="dropdown" href="javascript:;"> <i class="fa fa-user"></i> <?=isset($admin_name[0]['admin_name'])?$admin_name[0]['admin_name'].' ('.$type.')':'Admin'?><span class="caret"></span> </a>
    <ul class="dropdown-menu" role="menu">
     ...
     <li> <a href="<?=base_url('superadmin/my_profile');?>"> <i class="fa fa-cogs"></i> &nbsp;&nbsp;Settings </a> </li>
     <li class="divider"></li>
...
$( "body" ).keypress(function( event ) {
 ...
 function logout()
	{
		$.confirm({
		'title': 'Logout','message': " <strong> Are you sure want to logout?",'buttons': {'Yes': {'class': 'logout_class',
		'action': function(){
		<? if(!empty($admin['id'])){ ?>
