...
<? } ?>
							...
							<td class="hidden-xs hidden-sm ">
							<a class="btn btn-xs btn-success" title="Copy Record" href="<?= $this->config->item('superadmin_base_url').$viewname; ?>/copy_record/<?= $row['id'] ?>"><i class="fa fa-copy copyicon5"></i></a> &nbsp; 
