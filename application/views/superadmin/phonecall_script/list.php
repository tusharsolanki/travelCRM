<?php 
    /*
        @Description: superadmin task list
...
<script>
	...
	function contact_search(allflag)
	{
		...
		$.ajax({
			type: "POST",
			url: "<?php echo base_url();?>superadmin/phonecall_script/"+uri_segment,
			data: {
	...
	function delete_all(id)
		{
			...
			success: function(data){
				...
				$.ajax({
					type: "POST",
					url: "<?php echo base_url();?>superadmin/phonecall_script/"+data,
					data: {
	...
	function update_data(id)
	 {
			...
			$.ajax({
				type: "POST",
				url: "<?php echo base_url();?>superadmin/phonecall_script/update_publish",
				data: {
				id:id
			},
			beforeSend: function() {
