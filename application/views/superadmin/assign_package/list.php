    ...
    <div class="col-md-12">
     <div class="portlet">
      <div class="portlet-header">
       <h3> <i class="fa fa-table"></i>Assign Package List</h3>
	   <span class="float-right margin-top--15"><a href="<?=base_url('superadmin/package_management');?>" class="btn btn-secondary" title="Back">Back</a> </span>
      </div>
        ...
        <div role="grid" class="dataTables_wrapper" id="DataTables_Table_0_wrapper">
          ...
          <div class="col-sm-11">
           <div class="dataTables_filter" id="DataTables_Table_0_filter">
            <label>
			 ...
			 <button class="btn btn-secondary howler" title="Search Package" data-type="danger" onclick="contact_search();">Search</button>
		 ...
		 <div class="row dt-rt">
          ...
          <div class="col-sm-6">
           <div class="dataTables_filter" id="DataTables_Table_0_filter">
            <label>	
		   <a title="Assign Package" class="btn btn-success howler" href="<?=base_url('superadmin/'.$viewname.'/add_record');?>">Assign Package</a>
...
<script>
	...
	function contact_search()
	{
		$.ajax({
			type: "POST",
			url: "<?php echo base_url();?>superadmin/<?=$viewname?>/",
			data: {
