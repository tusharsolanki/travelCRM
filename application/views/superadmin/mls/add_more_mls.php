         ...
         <div id="common_div">
         	<div class="col-sm-12 pull-left text-center">
            	<div class="">
					...
					<div class="col-sm-12 form-group"><?php echo $count_no_contact."  Property imported successfully."; ?><?=!empty($msg)?' '.$msg:'';?></div>
			...
			<div class="col-sm-12 pull-left text-center">
            	<div class="row">
					...
					<a title="Undo Last Import" class="btn btn-secondary" href="<?=base_url('superadmin/'.$viewname.'/delete_last_import')."/".$csv_id;?>">Undo Last Import</a>
					<a title="Import More Contacts" class="btn btn-secondary" href="<?=base_url('superadmin/'.$viewname.'/import');?>">Import More Contacts</a> 
					<a title="Finish" class="btn btn-secondary" href="<?=base_url('superadmin/'.$viewname);?>">Finish</a>
        		</div>
         	</div>
