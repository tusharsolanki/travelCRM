       ...
       <div class="">
		...
		<?php if(!empty($msg)){?>
         ...
         <div class="row dt-rt">
		  ...
		  <a title="Add Communication" class="btn  pull-right btn-success howler margin-left-5px" href="<?=base_url('superadmin/'.$viewname.'/add_record');?>">Add Communication</a>
	...
	function active_all_plans(name)
		{
			...
			success: function(data){
				...
				$.ajax({
					type: "POST",
					url: "<?php echo base_url();?>superadmin/default_interaction_plans/"+data,
					data: {
...
<script>
	  ...
	  function applysortfilte_contact(sortfilter,sorttype)
		...
		function contact_search(allflag)
		{
			...
			$.ajax({
				type: "POST",
				url: "<?php echo base_url();?>superadmin/default_interaction_plans/"+uri_segment,
				data: {
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="col-sm-12 view_contact_popup">
		  ...
		  <?php /*?><?php $this->load->view('superadmin/default_interaction_plans/view_contact_popup');?><?php */?>
...
{
	$.confirm({'title': 'CONFIRM','message': " <strong> Are you sure want to release interaction plan <strong>?</strong>",'buttons': {'Yes': {'class': '',
	   'action': function(){
