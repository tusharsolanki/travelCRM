                    ...
                    <div class="portlet-content">
                        <div class="table_large-responsive">
                            <div role="grid" class="dataTables_wrapper" id="DataTables_Table_0_wrapper">
                                ...
                                <div class="row dt-rt">
                                    <div class="col-sm-6">
                                        <button class="btn btn-danger howler" title="Delete Domain" data-type="danger" onclick="deletepopup1('0');">Delete</button>
                                    </div>
                                    <div class="col-sm-6">
...
<script>
        ...
        function status_change(status,id)
	{
            ...
            if(status == 0)
            {
                ...
                msg = 'Are you sure want to inactive Domain ';
            }else
            {
                path = "<?= $this->config->item('superadmin_base_url').$viewname; ?>/publish_record/"+id;
                msg = 'Are you sure want to  active Domain ';
            }
