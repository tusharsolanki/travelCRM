...
<div class="row form-group">
 ...
 <?php if(!empty($editRecord[0]['is_bomb']) && $editRecord[0]['is_bomb'] == '1'){?>
             <div class="col-sm-9">
             <label class="">
              Bomb Bomb Before   <?= $editRecord[0]['bomb_time_before']?> <?php if(!empty($editRecord[0]['bomb_time_type']) && $editRecord[0]['bomb_time_type'] == '1'){ echo "Hour"; }
			  else
			  {
			  echo "Day";
			  }
