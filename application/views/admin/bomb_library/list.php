<?php 
    /*
        @Description: Admin bomb_library list
...
?>
 <div id="content">
  <div id="content-header">
   <h1><?=$this->lang->line('bomblibrarytemplate_list_header');?></h1>
  </div>
    ...
    <div class="col-md-12">
     <div class="portlet">
      <div class="portlet-header">
       <h3> <i class="fa fa-table"></i><?=$this->lang->line('bomblibrarytemplate_list_head');?></h3>
      ...
      <div class="portlet-content">
       <ul class="nav nav-tabs" id="myTab1">
                <li <?php if($tabid == '' || $tabid == 1){?> class="active" <?php } ?> > <a title="Bomb Bomb Library" data-toggle="tab" href="#my_library" onclick="load_view('my_library');"><?=$this->lang->line('bomblibrarytemplate_list_head');?></a> </li>
               <?php /*?> <li <?php if($tabid == 2){?> class="active" <?php } ?>> <a title="Bomb Bomb Library" data-toggle="tab" href="#default_library" onclick="load_view('default_library');"> Default <?=$this->lang->line('bomblibrarytemplate_list_head');?></a> </li><?php */?>
            </ul>
...
<script>
	...
	function contact_search(allflag)
	{
		...
		$.ajax({
			type: "POST",
			url: "<?php echo base_url();?>admin/bomb_library/"+uri_segment,
			data: {
	...
	function delete_all(id)
		{
			...
			success: function(data){
				...
				$.ajax({
					type: "POST",
					url: "<?php echo base_url();?>admin/bomb_library/"+data,
					data: {
