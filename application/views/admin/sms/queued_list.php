    ...
    <div class="col-md-12">
     <div class="portlet">
      <div class="portlet-header">
	   ...
	   <span class="float-right margin-top--15"><a class="btn btn-secondary" onclick="history.go(-1)" href="<?=$this->config->item('admin_base_url').$viewname?>" title="Back"><?php echo $this->lang->line('common_back_title')?></a> </span>
      </div>
      <!-- /.portlet-header -->
      
      <div class="portlet-content">
           <?php /*?> <ul class="nav nav-tabs" id="myTab1">
              ...
              <div class="<?php if($tabid == '' || $tabid == 1){?> tab-pane fade in active<?php }else{ ?> tab-pane fade in <?php } ?>" id="mydata" >
                <div class="table_large-responsive">
                  <div role="grid" class="dataTables_wrapper" id="DataTables_Table_0_wrapper">
                    ...
                    <div id="common_div">
                      <?=$this->load->view('admin/'.$viewname.'/ajax_queued_list')?>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="table_large-responsive">
                  <div role="grid" class="dataTables_wrapper" id="DataTables_Table_0_wrapper">
                    ...
                    <div id="default_common_div">
                      <?php //$this->load->view('admin/'.$viewname.'/ajax_queued_list')?>
                    </div>
                  </div>
                </div>
              </div>-->
...
<script>
	...
	function default_search()
	{
		$.ajax({
			type: "POST",
			url: "<?php echo base_url();?>admin/<?=$viewname?>/queued_list/",
			data: {
