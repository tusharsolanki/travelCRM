...
if(!empty($contact_to)){
  ...
  <tr class="<?php if($i%2==0){echo 'odd';}else{echo 'even';}$i++;?>">
	...
	<td width="37%" class="sorting_2"><?=!empty($row['company_name'])?ucfirst(strtolower($row['company_name'])):'';?></td>
	<td width="57%" class="sorting_1"><?=!empty($row['phone_no'])?$row['phone_no']:'';?></td>
  </tr>
<?php } ?>
<?php }else{ ?>
	<tr class="record_smg">
