     ...
     <div class="portlet">
      <div class="portlet-header">
	   ...
	   <?php if($viewname == 'emails')
	   		echo !empty($list[0]['plan_name'])?ucfirst($list[0]['plan_name']):'';
		else
		{
			echo !empty($list[0]['plan_name'])?ucfirst($list[0]['plan_name']):'';
			echo ' >> ';
			echo !empty($list[0]['description'])?ucfirst($list[0]['description']):'';
		}
		?> : Queued Emails</h3>
      ...
      <div class="portlet-content">
       <div class="table_large-responsive">
        <div role="grid" class="dataTables_wrapper" id="DataTables_Table_0_wrapper">
         ...
         <?=$this->load->view('admin/'.$viewname1.'/interaction_ajax_queued_list')?>
...
<script>
	...
	function contact_search(allflag)
	{
		...
		$.ajax({
			type: "POST",
			url: "<?php echo base_url();?>admin/<?=$viewname?>/interaction_plan_queued_list/<?=$this->uri->segment(4)?>/"+uri_segment,
			data: {
