      ...
      <div class="portlet-content">
       <div class="table_large-responsive">
        <div role="grid" class="dataTables_wrapper" id="DataTables_Table_0_wrapper">
         ...
         <div id="common_div">
         <?=$this->load->view('admin/'.$viewname1.'/ajax_all_sent_maillist')?>
...
<script>
	...
	function contact_search(allflag)
	{
		...
		$.ajax({
			type: "POST",
			/*url: "<?php echo base_url();?>admin/emails/all_sent_mail/"+id,*/
                        url: "<?php echo base_url();?>admin/<?=$viewname?>/all_sent_mail/"+uri_segment,
			data: {
