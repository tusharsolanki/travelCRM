    ...
    <div class="col-md-12">
     <div class="portlet">
      <div class="portlet-header">
       <h3> <i class="fa fa-table"></i>Queued Emails</h3>
              ...
              <div class="" id="mydata" >
                <div class="table_large-responsive">
                  <div role="grid" class="dataTables_wrapper" id="DataTables_Table_0_wrapper">
                    ...
                    <div id="common_div">
                      <?=$this->load->view('admin/'.$viewname1.'/ajax_queued_list')?>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="" id="mydata" >
                <div class="table_large-responsive">
                  <div role="grid" class="dataTables_wrapper" id="DataTables_Table_0_wrapper">
                    ...
                    <div id="common_div">
                      <?=$this->load->view('admin/'.$viewname1.'/ajax_interaction_queued_list')?>
                    </div>
                  </div>
                </div>
              </div>
...
<script>
	...
	function contact_search()
	{
		$.ajax({
			type: "POST",
			url: "<?php echo base_url();?>admin/<?=$viewname?>/<?=$viewlist?>/<?=$this->uri->segment(4)?>",
			data: {
