                      ...
                      foreach($interaction_plan as $row){?>
						<tr <? if($i%2==1){ ?>class="bgtitle" <? }?> >
                            ...
                            <?php if($viewname == 'emails') {?>
                            	<a href="<?php echo $this->config->item('admin_base_url').$viewname?>/interaction_plan_queued_list/<?=$row['id']?>"> <?=!empty($row['plan_name'])?ucfirst(strtolower($row['plan_name'])):'';?> </a>
                            <?php } else { ?>
                            	<a href="<?php echo $this->config->item('admin_base_url').$viewname?>/interaction_queued_list/<?=$row['id']?>"><?=!empty($row['plan_name'])?ucfirst(strtolower($row['plan_name'])):'';?></a>
                            <?php } ?>
							</td>			
                          </tr>
          <?php } } else {?>
