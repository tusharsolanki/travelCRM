      ...
      <div class="portlet-content">
        ...
        <div role="grid" class="dataTables_wrapper" id="DataTables_Table_0_wrapper">
         ...
         <div class="row dt-rt">
          ...
          <div class="col-sm-11">
           <div class="dataTables_filter" id="DataTables_Table_0_filter">
            <label>
			 <a href="<?=base_url('admin/'.$viewname.'/queued_list');?>" class="btn btn-secondary howler" title="Queued Emails" > Queued Emails </a>
			  <a href="<?=base_url('admin/'.$viewname.'/all_sent_mail');?>" class="btn btn-secondary howler" title="Sent Emails" > Sent Emails </a>
            </label>
           </div>
          </div>
          <div class="col-sm-12">
         ...
         <div class="row dt-rt">
          ...
          <a class="btn  pull-right btn-secondary-green howler" href="<?=base_url('admin/'.$viewname.'/add_record');?>" title="<?=$this->lang->line('label_add_email_campaign');?>"><?=$this->lang->line('label_add_email_campaign');?></a>
          <? } ?>
          </div>
         </div>
        <div class="table_large-responsive"> 
         <div id="common_div">
         <?=$this->load->view('admin/'.$viewname1.'/ajax_list')?>
         </div>
        </div>
       </div>
       <!-- /.table-responsive --> 
