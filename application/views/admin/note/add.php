                  ...
                  <div class="row dt-rb form">
                    ...
                    <div class="col-sm-5">
                      ...
                      <div class="col-sm-12 added_contacts_list">
						...
						<?php $this->load->view('admin/note/selected_contact_ajax')?>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="col-sm-12 add_new_contact_popup">
          <div class="">
		  <?php $this->load->view('admin/note/add_contact_popup_ajax');?>
		  </div>
        </div>
      </div>
...
$(document).ready(function(){
	...
	function contact_search()
	{
		...
		$.ajax({
			type: "POST",
			url: "<?php echo base_url();?>admin/note/search_contact_ajax/",
			data: {
	...
	function addcontactstointeractionplan()
	{
		$.ajax({
			type: "POST",
			url: "<?php echo base_url();?>admin/note/add_contacts_to_interaction_plan/",
			data: {
