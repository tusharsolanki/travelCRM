...
?>
 <div id="content">
  <div id="content-header">
   <h1><?php echo "Completed Task List";?></h1>
  </div>
    ...
    <div class="col-md-12">
     <div class="portlet">
      <div class="portlet-header">
       <h3> <i class="fa fa-table"></i><?php echo "Completed Task List";?>
       </h3>
...
<script>
	...
	function contact_search(allflag)
	{
		...
		$.ajax({
			type: "POST",
			url: "<?php echo base_url();?>admin/task/completed_task/"+uri_segment,
			data: {
	...
	function delete_all(id)
		{
			...
			dataType: 'json',
			async: false,
			data: {'myarray':myarray,'single_remove_id':id,'page_name':'completed_task'},
			success: function(data){
				$.ajax({
					type: "POST",
					url: "<?php echo base_url();?>admin/task/completed_task/"+data,
					data: {
	...
	{      
			...
			if(boxes.length == '0' && id== '0')
			{
				...
				$.confirm({'title': 'Alert','message': " <strong> Please select record(s) to delete. "+"<strong></strong>",'buttons': {'ok'	: {'class'	: 'btn_center alert_ok'}}});//alert(msg);
				return false;
