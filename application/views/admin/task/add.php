...
<div class="row form-group">
 ...
 Reminders
             ...
             <div class="col-sm-6 col-lg-3">
              <input id="email_time_before" name="email_time_before" class="form-control parsley-validated" type="text" value="<?php if(!empty($editRecord[0]['email_time_before'])){ echo $editRecord[0]['email_time_before']; }?>" onkeypress="return isNumberKey(event)" placeholder="Number">
             </div>
             <div class="col-sm-6 col-lg-3">
