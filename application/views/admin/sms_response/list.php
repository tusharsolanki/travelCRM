...
<div aria-hidden="true" style="display: none;" id="basicModal" class="modal fade">
 ...
 <div id="content">
  <div id="content-header">
   <h1><?=$this->lang->line('sms_response_header');?></h1>
  </div>
    ...
    <div class="col-md-12">
     <div class="portlet">
      <div class="portlet-header">
       <h3> <i class="fa fa-table"></i><?=$this->lang->line('sms_response_list_head');?></h3>
      ...
      <div class="portlet-content">
       <div class="table_large-responsive">
        <div role="grid" class="dataTables_wrapper" id="DataTables_Table_0_wrapper">
         ...
         <div class="row dt-rt">
          <div class="col-sm-6">
           <?php if(!empty($this->modules_unique_name) && in_array('text_response_delete',$this->modules_unique_name)){?>
           <button class="btn btn-danger howler" data-type="danger" title="Delete" onclick="deletepopup1('0');">Delete</button>
           <? } ?>
          </div>
          <div class="col-sm-6">
          <?php /*?><a class="btn btn-secondary pull-right btn-secondary-green howler" title="Add Task" href="<?=base_url('admin/'.$viewname.'/add_record');?>">Add Task</a><?php */?>
          </div>
         </div>
         <div id="common_div">
...
<script>
	...
	function contact_search(allflag)
	{
		...
		$.ajax({
			type: "POST",
			url: "<?php echo base_url();?>admin/sms_response/"+uri_segment,
			data: {
	...
	function delete_all(id)
		{
			...
			success: function(data){
				...
				$.ajax({
					type: "POST",
					url: "<?php echo base_url();?>admin/sms_response/"+data,
					data: {
