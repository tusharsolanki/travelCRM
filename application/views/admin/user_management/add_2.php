	...
	<h3 class="float-right margin-top--15"><a class="btn btn-secondary" onclick="history.go(-1)" href="javascript:void(0)"><?php echo $this->lang->line('common_back_title')?></a> </h3>
     <div class="portlet">
      <div class="portlet-header">
       <h3> <i class="fa fa-tasks"></i> <?php if(empty($editRecord)){ echo $this->lang->line('user_add_table_head');}else{ echo $this->lang->line('user_edit_table_head'); }?> </h3>
      ...
      <div class="portlet-content">
       <div class="col-sm-12">
        <ul class="nav nav-tabs" id="myTab1">
         <li <?php if($tabid == '' || $tabid == 1){?> class="active" <?php } ?>> <a data-toggle="tab" href="#home"><?=$this->lang->line('user_add_table_tab1_head');?></a> </li>
		 <?php if(!empty($editRecord[0]['id'])){ ?>
         <li <?php if($tabid == 2){?> class="active" <?php } ?>> <a data-toggle="tab" href="#profile"><?=$this->lang->line('user_add_table_tab2_head');?></a> </li>
         <li <?php if($tabid == 3){?> class="active" <?php } ?>> <a data-toggle="tab" href="#profilenew"><?=$this->lang->line('user_add_table_tab3_head');?></a> </li>
		 <?php } ?>
         <!--<li class="dropdown">
         ...
         <div <?php if($tabid == '' || $tabid == 1){?> class="row tab-pane fade in active" <?php }else{ ?> class="row tab-pane fade in" <?php } ?> id="home" >
		  ...
		  <input id="id" name="id" type="hidden" value="<?php if(!empty($editRecord[0]['id'])){ echo $editRecord[0]['id']; }?>">
           <div class="col-sm-7">
            <div class="row">
             <div class="col-sm-4">
              <label for="text-input"><?=$this->lang->line('user_add_prefix');?></label>
            ...
            <div class="row">
             <div class="col-sm-4 form-group">
              <label for="text-input"><?=$this->lang->line('user_add_fname');?></label>
			 ...
			 <div class="col-sm-4">
              <label for="text-input"><?=$this->lang->line('user_add_mname');?></label>
             ...
             <div class="col-sm-4">
              <label for="text-input"><?=$this->lang->line('user_add_lname');?></label>
            ...
            <div class="row">
             <div class="col-sm-8">
              <label for="text-input"><?=$this->lang->line('user_add_company');?></label>
            ...
            <div class="row">
             <div class="col-sm-8">
              <label for="text-input"><?=$this->lang->line('user_add_title1');?></label>
            ...
            <div class="row form-group">
             <div class="col-sm-4">
             <label for="text-input"><?=$this->lang->line('user_add_user_roles');?></label>
			  <select class="form-control parsley-validated" name="slt_prefix" id="slt_prefix">
               <option value="">Please Select</option>
               <option <?php if(!empty($editRecord[0]['prefix']) && $editRecord[0]['prefix'] == 'Mr.'){ echo "selected"; }?> value="Mr.">Mr.</option>
				...
				<div class="delete_email_trans_record<?=$rowtrans['id']?> padding-top-10 clear autooverflow">
					<div class="col-sm-4">
					  ...
					  <select class="form-control parsley-validated" name="slt_email_typee[]" id="slt_email_typee">
					   ...
					   <?php if(!empty($email_type)){
								foreach($email_type as $row){?>
									<option <?php if(!empty($rowtrans['email_type']) && $rowtrans['email_type'] == $row['id']){ echo "selected"; }?> value="<?=$row['id']?>"><?=$row['name']?></option>
								<?php } ?>
					   <?php } ?>
					  </select>
					 </div>
					 ...
					 <div class="col-sm-1 text-center icheck-input-new">
					  <div class="">
					   <!--<label>&nbsp;</label>-->
					   <a class="btn btn-xs btn-primary mar_top_con_my" href="javascript:void(0);" onclick="return ajaxdeletetransdata('delete_email_trans_record','<?=$rowtrans['id']?>');"> <i class="fa fa-times"></i> </a>
					  </div>
					 </div>
				</div>
				<?php } ?>	
			...
			<div class="row">
             <div class="col-sm-12 topnd_margin"> <a href="javascript:void(0);" class="text_color_red text_size add_email_address"><i class="fa fa-plus-square"></i> Add Email Address</a> </div>
            </div>
			 ...
			 <?php if(!empty($phone_trans_data) && count($phone_trans_data) > 0){
					...
					<div class="delete_phone_trans_record<?=$rowtrans['id']?> padding-top-10 clear autooverflow">
						...
						<div class="col-sm-4">
						  ...
						  <select class="form-control parsley-validated" name="slt_phone_typee[]" id="slt_phone_type">
						   ...
						   <?php if(!empty($phone_type)){
									foreach($phone_type as $row){?>
										<option <?php if(!empty($rowtrans['phone_type']) && $rowtrans['phone_type'] == $row['id']){ echo "selected"; }?> value="<?=$row['id']?>"><?=$row['name']?></option>
									<?php } ?>
						   <?php } ?>
						  </select>
						 </div>
						 <div class="col-sm-4 form-group">
						  <!--<label for="validateSelect"><?=$this->lang->line('user_add_phone_no');?></label>-->
						  <input id="txt_phone_no" name="txt_phone_noe[]" data-type="number" data-maxlength="12" class="form-control parsley-validated" type="text" value="<?php if(!empty($rowtrans['phone_no'])){ echo $rowtrans['phone_no']; }?>">
						 </div>
						 <div class="col-sm-2 text-center icheck-input-new">
						  <div class="">
						   <!--<label><?=$this->lang->line('common_default');?></label>-->
						 ...
						 <div class="col-sm-1 text-center icheck-input-new">
						  <div class="">
						   <!--<label>&nbsp;</label>-->
						   <a class="btn btn-xs btn-primary mar_top_con_my" href="javascript:void(0)" onclick="return ajaxdeletetransdata('delete_phone_trans_record','<?=$rowtrans['id']?>');"> <i class="fa fa-times"></i> </a>
						  </div>
						 </div>
			...
			<?php }else{ ?>
             ...
             <div class="col-sm-4 form-group">
              <!--<label for="validateSelect"><?=$this->lang->line('user_add_phone_no');?></label>-->
              <input id="txt_phone_no"  data-type="number" name="txt_phone_no[]" class="form-control parsley-validated" type="text" data-required="true">
             </div>
             <div class="col-sm-2 text-center icheck-input-new">
              <div class="">
               <!--<label><?=$this->lang->line('common_default');?></label>-->
            ...
            <div class="row">
			<div class="col-sm-12 topnd_margin"> <a href="javascript:void(0);" class="text_color_red text_size add_phone_number"><i class="fa fa-plus-square"></i> Add Phone No.</a> </div>
            </div>
						  ...
						  <select class="form-control parsley-validated" name="slt_address_typee[]" id="slt_address_type">
						   ...
						   <?php if(!empty($address_type)){
									foreach($address_type as $row){?>
										<option <?php if(!empty($rowtrans['address_type']) && $rowtrans['address_type'] == $row['id']){ echo "selected"; }?> value="<?=$row['id']?>"><?=$row['name']?></option>
									<?php } ?>
						   <?php } ?>
						  </select>
						 </div>
						 <div class="col-sm-6 columns">
						  ...
						  <div class="row">
						   ...
						   <div class="col-sm-4 nopadding form-group">
							<input type="text" placeholder="Zip Code" id="txt_zip_code" name="txt_zip_codee[]" data-maxlength="8" data-minlength="5" class="form-control parsley-validated" value="<?php if(!empty($rowtrans['zip_code'])){ echo $rowtrans['zip_code']; }?>">
						   </div>
						  </div>
						  <div class="row">
			...
			<?php }else{ ?>
             ...
             <div class="col-sm-6 columns">
              ...
              <div class="row">
               ...
               <div class="col-sm-4 nopadding form-group">
                <input type="text" placeholder="Zip Code" id="txt_zip_code" name="txt_zip_code[]" data-minlength="5"  data-maxlength="8" class="form-control parsley-validated">
               </div>
              </div>
              <div class="row">
            ...
            <div class="row">
             <div class="col-sm-12 topnd_margin"> <a class="text_color_red text_size add_new_address" href="javascript:void(0);"><i class="fa fa-plus-square"></i> Add Address</a> </div>
            </div>
            <div class="row">
             <div class="col-sm-8">
              <label for="text-input"><?=$this->lang->line('user_add_notes');?></label>
           ...
           <div class="col-sm-5">
            <div class="add_website">
             <div>
			   ...
			   <?php if(!empty($website_trans_data) && count($website_trans_data) > 0){
			 		foreach($website_trans_data as $rowtrans){ ?>
						...
						<div class="delete_website_trans_record<?=$rowtrans['id']?> padding-top-10 clear autooverflow">
						   ...
						   <div class="col-sm-1 text-center icheck-input-new">
							<div class="">
							 <a class="btn btn-xs btn-primary mar_top_con_my" href="javascript:void(0);" onclick="return ajaxdeletetransdata('delete_website_trans_record','<?=$rowtrans['id']?>');"> <i class="fa fa-times"></i> </a>
							</div>
						   </div>
						</div>
              ...
              <div class="row">
               <div class="col-sm-12 topnd_margin"> <a class="text_color_red text_size add_new_website" href="javascript:void(0);"><i class="fa fa-plus-square"></i> Add Website</a> </div>
              </div>
             </div>
             <div>
			 		...
			 		foreach($profile_trans_data as $rowtrans){ ?>
					  ...
					  <div class="delete_social_trans_record<?=$rowtrans['id']?> padding-top-10 clear autooverflow">
						<div class="col-sm-5">
							...
							<select class="form-control parsley-validated" name="slt_profile_typee[]" id="slt_profile_typee">
							   ...
							   <?php if(!empty($profile_type)){
										foreach($profile_type as $row){?>
											<option <?php if(!empty($rowtrans['profile_type']) && $rowtrans['profile_type'] == $row['id']){ echo "selected"; }?> value="<?=$row['id']?>"><?=$row['name']?></option>
										<?php } ?>
							   <?php } ?>
							</select>
						   </div>
						   ...
						   <div class="col-sm-1 text-center icheck-input-new">
							<div class="">
							 <a class="btn btn-xs btn-primary mar_top_con_my" href="javascript:void(0);" onclick="return ajaxdeletetransdata('delete_social_trans_record','<?=$rowtrans['id']?>');"> <i class="fa fa-times"></i> </a>
							</div>
						   </div>
						</div>
              ...
              <div class="row">
               <div class="col-sm-12 topnd_margin"> <a class="text_color_red text_size add_new_social_profile" href="javascript:void(0);"><i class="fa fa-plus-square"></i> Add Social Profile</a> </div>
              </div>
             </div>
            </div>
		  ...
		  <div class="row">
             ...
             <div <?php if($tabid == 2){?> class="row tab-pane fade in active" <?php }else{ ?> class="row tab-pane fade in" <?php } ?> id="profile">
		  	...
		  	<div class="col-sm-12">
				...
				<div class="add_emailtype autooverflow">
						...
						<label for="text-input"><?=$this->lang->line('user_add_user_pic');?></label>
					
						<div class="browse"> <span class="text"> </span>
						  <div class="browse_btn">
							<div class="file_input_div">
							  <input type="button" value="Browse" class="file_input_button" />
							  <input type="file" alt="1" name="contact_pic" id="contact_pic" class="file_input_hidden"/>
							</div>
						  </div>
            ...
            <div class="row">
             <div class="col-sm-12">
			  ...
			  <div class="col-sm-12">
			  	<div class="row">
				 <div class="col-sm-12">
				  <label for="text-input"><?=$this->lang->line('user_add_birth_date');?></label>
				...
				<div class="row">
				 <div class="col-sm-12">
				  <label for="text-input"><?=$this->lang->line('user_add_anniversary_date');?></label>
			...
			<div class="row">
             <div class="col-sm-8">
              <label for="text-input"><?=$this->lang->line('user_add_status');?></label>
              <select class="form-control parsley-validated" name="slt_contact_status" id="slt_contact_status">
				   ...
				   <?php if(!empty($status_type)){
							foreach($status_type as $row){?>
								<option <?php if(!empty($editRecord[0]['contact_status']) && $editRecord[0]['contact_status'] == $row['id']){ echo "selected"; }?> value="<?=$row['id']?>"><?=$row['name']?></option>
							<?php } ?>
				   <?php } ?>
			  </select>
             </div>
			...
			<div class="row add_tag_div">
			 ...
			 <div class="col-sm-8">
              <label for="text-input"><?=$this->lang->line('user_add_tag');?></label>
             </div>
			 ...
			 <?php if(!empty($tag_trans_data) && count($tag_trans_data) > 0){
				   ...
				   <div class="delete_tag_trans_record<?=$rowtrans['id']?> padding-top-10 clear autooverflow">
					...
					<div class="col-sm-1 text-center icheck-input-new">
					 <div class="">
					  <a class="btn btn-xs btn-primary mar_top_con_my" href="javascript:void(0);" onclick="return ajaxdeletetransdata('delete_tag_trans_record','<?=$rowtrans['id']?>');"> <i class="fa fa-times"></i> </a>
					 </div>
				   	</div>
				   </div>
            ...
            <div class="row">
             <div class="col-sm-12 topnd_margin"> <a class="text_color_red text_size add_new_tag" href="javascript:void(0);"><i class="fa fa-plus-square"></i> Add Tags</a> </div>
            </div>
            <div class="row add_communication_plan_div">
			
			 <div class="col-sm-8">
              <label for="text-input"><?=$this->lang->line('user_add_interaction_plan');?></label>
             </div>
			 		...
			 		foreach($communication_trans_data as $rowtrans){ ?>
						...
						<div class="delete_communication_trans_record<?=$rowtrans['id']?> padding-top-10 clear autooverflow">
							<div class="col-sm-8">
							 ...
							 <select class="form-control parsley-validated" name="slt_communication_plan_ide[]" id="slt_communication_plan_ide">
								   ...
								   <?php if(!empty($communication_plans)){
											foreach($communication_plans as $row){?>
												<option <?php if(!empty($rowtrans['communication_plan_id']) && $rowtrans['communication_plan_id'] == $row['id']){ echo "selected"; }?> value="<?=$row['id']?>"><?=$row['name']?></option>
											<?php } ?>
								   <?php } ?>
							  </select>
							 </div>
							 <div class="col-sm-1 text-center icheck-input-new">
								<div class="">
								 <a class="btn btn-xs btn-primary mar_top_con_my" href="javascript:void(0);" onclick="return ajaxdeletetransdata('delete_communication_trans_record','<?=$rowtrans['id']?>');"> <i class="fa fa-times"></i> </a>
								</div>
							 </div>
						</div>
			...
			<?php } else { ?>
             ...
             <div class="col-sm-8">
              <!--<label for="text-input"><?=$this->lang->line('user_add_communication_plan');?></label>-->
            ...
            <div class="row">
             <div class="col-sm-12 topnd_margin"> <a class="text_color_red text_size add_new_communication_plan" href="javascript:void(0);"><i class="fa fa-plus-square"></i> Add Communication</a> </div>
            </div>
<?php */ ?>         </div>
...
<input type="submit" class="btn btn-secondary" value="Save Contact" onclick="return setdefaultdata();" name="submitbtn" />
<input type="submit" class="btn btn-secondary" value="Save and Continue" onclick="return setdefaultdata();" name="submitbtn" />
 <a class="btn btn-primary" href="javascript:history.go(-1);">Cancel</a>
         ...
         <div <?php if($tabid == 2){?> class="row tab-pane fade in active" <?php }else{ ?> class="row tab-pane fade in" <?php } ?> id="profile">
          	<form class="form parsley-form" enctype="multipart/form-data" name="<?php echo $viewname;?>ajax" id="<?php echo $viewname;?>ajax" method="post" accept-charset="utf-8" action="<?php echo $this->config->item('admin_base_url')?><?php echo $path."_ajax"?>" novalidate >
					...
					<div class="col-sm-8">
						<div class="row">
							<div class="col-sm-7 form-group">
							  <label for="text-input"><?=$this->lang->line('user_add_documents');?></label>
							</div>
							
							<div class="col-sm-7 form-group">
							  <label for="text-input"><?=$this->lang->line('user_add_document_type');?></label>
							...
							<div class="col-sm-7 form-group">
							  <label for="text-input"><?=$this->lang->line('user_add_document_name');?></label>
							...
							<div class="col-sm-7 form-group">
							  <label for="text-input" class="fleft"><?=$this->lang->line('user_add_upload_file');?></label>
			...
			<div class="col-sm-12 pull-left text-center">
				...
				<input type="submit" class="btn btn-secondary" value="Save Contact" onclick="setsubmitidtab2(1);" id="savecontacttab2" name="submitbtn" />
				<input type="submit" class="btn btn-secondary" value="Save and Continue" onclick="setsubmitidtab2(2);" name="submitbtn" />
				<a class="btn btn-primary" href="javascript:history.go(-1);">Cancel</a>
         ...
         <div <?php if($tabid == 3){?> class="row tab-pane fade in active" <?php }else{ ?> class="row tab-pane fade in" <?php } ?> id="profilenew">
			  ...
			  <div class="col-sm-7">
				 ...
				 <div class="col-sm-8">
				  <label for="text-input"><?=$this->lang->line('user_add_birth_date');?></label>
				  <input id="txt_birth_date" name="txt_birth_date" class="form-control parsley-validated" type="text" value="<?php if(!empty($editRecord[0]['birth_date']) && $editRecord[0]['birth_date'] != '0000-00-00' && $editRecord[0]['birth_date'] != '1970-01-01'){ echo date($this->config->item('common_date_format'),strtotime($editRecord[0]['birth_date'])); }?>">
				 </div>
				</div>
				<div class="row">
				 <div class="col-sm-8">
			...
			<div class="col-sm-12 pull-left text-center margin-top-10">
			  ...
			  <input type="submit" class="btn btn-secondary" value="Save Contact" />
			  <a class="btn btn-primary" href="javascript:history.go(-1);">Cancel</a>
			</div>
	...
	$('body').on('click','.add_phone_number',function(e){
		...
		inlinehtml += '<div class="remove_phone_div padding-top-10 clear autooverflow">';
             ...
             inlinehtml += '<div class="col-sm-4 form-group">';
              ...
              inlinehtml += '<input id="txt_phone_no"  data-type="number" name="txt_phone_no[]" class="form-control parsley-validated" type="text">';
             inlinehtml += '</div>';
             inlinehtml += '<div class="col-sm-2 text-center icheck-input-new">';
              inlinehtml += '<div class="form-group">';
               //inlinehtml += '<label><?=$this->lang->line('common_default');?></label>';
	...
	$('body').on('click','.add_new_website',function(e){
		...
		inlinehtml += '<div class="remove_website_div padding-top-10 clear autooverflow">';
		   ...
		   inlinehtml += '<div class="col-sm-1 text-center icheck-input-new">';
			inlinehtml += '<div class="">';
			 //inlinehtml += '<label>&nbsp;</label>';
			 inlinehtml += '<button class="btn btn-xs btn-primary mar_top_con_my delete_website_div_button"> <i class="fa fa-times"></i> </button>';
			inlinehtml += '</div>';
		   inlinehtml += '</div>';
		  inlinehtml += '</div>';
	...
	$('body').on('click','.add_new_social_profile',function(e){
		...
		inlinehtml += '<div class="remove_social_profile_div padding-top-10 clear autooverflow">';
		   ...
		   inlinehtml += '<div class="col-sm-1 text-center icheck-input-new">';
			inlinehtml += '<div class="">';
			 //inlinehtml += '<label>&nbsp;</label>';
			 inlinehtml += '<button class="btn btn-xs btn-primary mar_top_con_my delete_social_profile_div_button"> <i class="fa fa-times"></i> </button>';
			inlinehtml += '</div>';
		   inlinehtml += '</div>';
		  inlinehtml += '</div>';
		 ...
		 inlinehtml += '<div class="col-sm-6 columns">';
		  ...
		  inlinehtml += '<div class="row">';
		   ...
		   inlinehtml += '<div class="col-sm-4 nopadding">';
			inlinehtml += '<input type="text" placeholder="Zip Code" id="txt_zip_code"  name="txt_zip_code[]" class="form-control parsley-validated">';
		   inlinehtml += '</div>';
		  inlinehtml += '</div>';
		  inlinehtml += '<div class="row">';
	...
	$(function(){
		...
		new AjaxUpload(btnUpload1, {
			...
			var data = jQuery.parseJSON(response);
				$('#priview_doc').text(data.document_name);	
