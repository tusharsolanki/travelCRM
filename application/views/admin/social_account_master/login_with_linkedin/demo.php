      ...
      <div class="chart_bg1 tbl_border">
                    <div class="col-md-12">
                        <div class="portlet">
							...
							<table class="mytable">
								<tr>
									<td align="left" width="300"><h3>Hi <?php echo $fname.''.$lname;?></h3></td>
									<td>
                            ...
                            <table class="mytable1">
								<tr class="linkdinbg">
									<td colspan='1'><h3 class="linkdin">Linkdin Friends List</h3></td>
								</tr>
								<tr class="linkdinbg">
									<!--<td><b>id</b></td>-->
								...
								<!--<tr>-->
								   ...
								   $user_data = new SimpleXMLElement($cfname);
                                    ...
                                    <?php $user_data = new SimpleXMLElement($cfname);
								  // pr($user_data);exit;
...
function addfriendslist()
{
	...
	$.ajax({
		...
		data: {'frnd':js_array,'access_token':access_token,'linkedin_uname':linkedin_uname}, 
		beforeSend: function() {
