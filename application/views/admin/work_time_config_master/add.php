          ...
          <div class="col-md-12">
            <div class="portlet">
              ...
              <div class="portlet-content">
                <div class="col-md-7 work_time row">
                ...
                <div class="col-md-5 col-lg-5">
                  <div class="row addmoresubcatdata addmoresubcatdata_new">
                    <div class="row">
                      <fieldset class="edit_main_div hight_fileset append_data">
                        ...
                        <div class="col-md-12 row">
                          ...
                          <div class="col-md-3 col-sm-2 col-lg-2 margin-top-2 float-left pd12">
                          
                           <a href="javascript:void(0);" onclick="get_submit_leave(<?php echo $user_leave[$i]['id'] ?>,<?php echo $i; ?>)" title="Update record" class="btn btn-xs btn-success"><i class="fa fa-pencil-square-o copyicon1"></i></a> <a href="javascript:void(0);" class="btn btn-xs btn-primary" title="Delete Record" onclick="deletepopup('<?=addslashes('Leave From '.$user_leave[$i]['from_date'].' TO '.$user_leave[$i]['to_date'])?>','<?php echo $this->lang->line('contact_head_submodel')?>','<?php echo $this->config->item('admin_base_url').$viewname;?>/delete_leave_record/<?php echo  $user_leave[$i]['id'] ?>');"> <i class="fa fa-times"></i> </a> 
                           
                           </div>
                        </div>
                        <?php } }?>
                        <div class="col-md-12 row padding-top-2">
                          <div class="col-md-5 col-lg-5 col-sm-5">
                            <input type="text" class="form-control from_datepicker"  name="from_date[]" id="from_date" placeholder="From Date" readonly="readonly"/>
                          </div>
                          <div class="col-md-5 col-lg-5 col-sm-5 row">
                            <input type="text" class="form-control  to_datepicker" name="to_date[]" id="to_date" placeholder="To Date" readonly="readonly"/>
                          </div>
                          <div class="col-md-2 col-sm-2"> <!--<a href="#"  style="color:#999900;font-size:10px;"><img src="<?=base_url('images/add_icon.jpg') ?>"/></a>--><a href="javascript:void(0);" id="addScnt_status" class="btn btn-xs btn-success smbtn"> <i class="fa fa-plus copyicon2"></i> </a> </div>
                        </div>
                      </fieldset>
                    </div>
                  </div>
                ...
                <div class="col-md-12 clear addmoresubcatdata1">
                    ...
                    <fieldset class="edit_main_div hight_fileset append_data1">
                      ...
                      <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12">
                          ...
                          <div class="col-lg-3 col-md-6">
                            <div class="col-lg-6 col-md-12 block"> Of Every month </div>
                      ...
                      <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12">
                          ...
                          <div class="col-md-1 col-sm-2"> <a href="javascript:void(0);" onclick="get_submit_rules(<?php echo $special_rules[$i]['id'] ?>,<?php echo $special_rules[$i]['id']; ?>)" title="Update record" class="btn btn-xs btn-success"><i class="fa fa-pencil-square-o copyicon1"></i></a> <a href="javascript:void(0);" class="btn btn-xs btn-primary" title="Delete Record" onclick="deletepopup('<?=addslashes('Rule No. '.$special_rules[$i]['id'])?>','<?php echo $this->lang->line('contact_head_submodel')?>','<?php echo $this->config->item('admin_base_url').$viewname;?>/delete_rules_record/<?php echo $special_rules[$i]['id'] ?>');"> <i class="fa fa-times"></i> </a> </div>
                          </div>
                      </div>
                          <?php
							}}
                      ...
                      <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12">
                          ...
                          <a class="btn btn-xs btn-success smbtn"  id="addScnt_status1" href="javascript:void(0);"> <i class="fa fa-plus copyicon2"></i> </a>
                  ...
                  <div class="col-lg-12 col-md-12 col-sm-12 pull-left text-center margin-top-10">
...
<script type="text/javascript">
    ...
    $(function() {
		...
		innerhtml += '<div class="col-md-12 row padding-top-2 clear catsubcatdiv_'+catsubcatcount+'">';
			innerhtml += '<div class="col-md-5 col-lg-5 col-sm-5">';
			...
			innerhtml += '<div class="col-md-5 col-lg-5 col-sm-5 row">';
			...
			innerhtml += '<div class="col-md-2 pdn"> <button value="catsubcatdiv_'+catsubcatcount+'" class="btn btn-xs btn-primary remScnt"><i class="fa fa-times"></i></button></div>';
		innerhtml += '</div>';
		
		$(innerhtml).appendTo('.append_data');
		
/*		$( "#from_date"+catsubcatcount ).datepicker({
			changeMonth: true,
			changeYear: true,
			yearRange: "-100:+0",
			datepicker:true,
		...
		$( "#to_date"+catsubcatcount ).datepicker({
			changeMonth: true,
			changeYear: true,
			yearRange: "-100:+0",
			datepicker:true,
...
<script type="text/javascript">
    ...
    $(function() {
		...
		innerhtml += '<div class="padding-top-2 clear catsubcatdiv_'+catsubcatcount_rules+'">';
			innerhtml += '<div class="col-lg-2 col-md-4 col-sm-5">';
			...
			innerhtml += '</select>';
			innerhtml += '</div>';
			innerhtml += '<div class="col-lg-3 col-md-12">';			
			innerhtml += '<div class="col-lg-6 col-md-12 block">';
			innerhtml += 'Of Every month</div>';
			
			innerhtml += '<div class="col-lg-6 col-md-12 col-sm-12 pull-left">';
			...
			innerhtml += '<div class="col-md-1 col-sm-2">';
			innerhtml += '</div>';
			...
			innerhtml += '<div class="col-md-1 col-sm-2"> <button value="catsubcatdiv_'+catsubcatcount_rules+'" class="btn btn-xs btn-primary remScnt smbtn"><i class="fa fa-times copyicon2"></i></button></div>';
		innerhtml += '</div>';
...
<!-- ==== LEAVE UPDATE AJAX ===== -->
	...
	else
	{
            ...
            $.ajax({
                type: "POST",
                url: '<?=base_url()?>admin/<?=$viewname;?>/update_leave',
...
<!-- ==== RULES UPDATE AJAX ===== -->
	...
	else
	{
            ...
            $.ajax({
                type: "POST",
                url: '<?=base_url()?>admin/<?=$viewname;?>/update_rules',
...
$(function() {
				...
				<?php /*?>
				$('#e_start_time<?php echo $special_rules[$i]['id'];?>').datetimepicker({
					format:'H:i',
					datepicker:false,
				});
				$('#e_end_time<?php echo $special_rules[$i]['id'];?>').datetimepicker({
					format:'H:i',
					datepicker:false,
				});<?php */?>
});
