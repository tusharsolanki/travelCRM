                                        ...
                                        <div class="col-sm-8">
                                            <div class="row">
                                                <div class="col-sm-12 form-group">
                                                    ...
                                                    <input id="txt_search_address" readonly name="txt_search_address" placeholder="" class="form-control parsley-validated" type="text" value="<?php if(!empty($editRecord[0]['search_address'])){ echo htmlentities($editRecord[0]['search_address']);}?>">
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-sm-12 form-group">
                                                    <label for="text-input"><?=$this->lang->line('contact_joomla_val_searched_domain');?></label>
                                                    <input id="txt_domain" readonly name="txt_domain" placeholder="" class="form-control parsley-validated" type="text" value="<?php if(!empty($editRecord[0]['domain'])){ echo htmlentities($editRecord[0]['domain']);}?>">
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="">
