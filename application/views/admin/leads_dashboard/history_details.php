<table width="100%" class="table1 table-striped1 table-striped1 table-bordered1 table-hover1 table-highlight table table-striped table-bordered" id="DataTables_Table_0" aria-describedby="DataTables_Table_0_info">
                                                ...
                                                <tr class="load_conversations manual_conversations">
                                                 <td colspan="2" width="100%">
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                      <tr>
                                                        <td width="53%"><b><?php if(!empty($conversations[$i]['contact_name'])){echo ucfirst(strtolower($conversations[$i]['contact_name']));}; ?></b></td>
                                                        <td width="47%"><?php if(!empty($conversations[$i]['interaction_type_name'])){ echo ucfirst(strtolower($conversations[$i]['interaction_type_name']));}?> </td>
                                                      </tr>
                                                      <tr>
                                                        ...
                                                        <td><?php if(!empty($conversations[$i]['disposition_name'])){ echo ucfirst(strtolower($conversations[$i]['disposition_name']));}else{echo "Not Available";}?></td>
                                                      </tr>
                                                      
                                                      <tr>
                                                        <td colspan="3"><?php if(!empty($conversations[$i]['description'])){ echo ucfirst(strtolower($conversations[$i]['description']));}?></td>
                                                      </tr>
                                                    </table>
                                                </td>
                                                </tr>
                                                ...
                                                <tr class="load_conversations manual_conversations">
                                                 <td colspan="2" width="100%">
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                      ...
                                                      <tr>
                                                        <td colspan="2"><?php if(!empty($conversations[$i]['description'])){ echo ucfirst(strtolower($conversations[$i]['description']));}?></td>
                                                      </tr>
                                                    </table>
                                                </td>
                                                </tr>
                                                 ...
                                                 <td colspan="2" width="100%">
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                      <tr>
                                                        ...
                                                        <td ><?php if(!empty($conversations[$i]['task_name'])){ echo ucfirst(strtolower($conversations[$i]['task_name']));}?>
                                                      </tr>
                                                      ...
                                                      <tr>
                                                        <td><?php if(!empty($conversations[$i]['user_name'])){  echo ucfirst(strtolower($conversations[$i]['user_name']));}?></td>
                                                        
                                                        <td ><?php if(!empty($conversations[$i]['desc'])){ echo ucfirst(strtolower($conversations[$i]['desc']));}?></td>
                                                    </table>
                                                </td>
                                                </tr>
                                                <?php } else {?>
                                                <tr class="load_conversations">
                                                 <td width="100%" colspan="2">
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                      <tr>
                                                        <td width="30%"><b><?php if(!empty($conversations[$i]['contact_name'])){echo ucfirst(strtolower($conversations[$i]['contact_name']));}; ?></b></td>
                                                        <td width="77%">
                                                                ...
                                                                if(!empty($conversations[$i]['interaction_id']))
                                                                    {
                                                                        ...
                                                                        {
                                                                        echo " >> ".ucfirst(strtolower($conversations[$i]['inte_to_plan_name']));
                                                                        }
                                                                    }
                                                                    else
                                                                    {
                                                                        ...
                                                                        {
                                                                            echo ucfirst(strtolower($conversations[$i]['email_template_name']));
                                                                        }
                                                                        if(!empty($conversations[$i]['email_campaing_template_name']))
                                                                        {
                                                                            echo ucfirst(strtolower($conversations[$i]['email_campaing_template_name']));
                                                                        }
                                                                    }
                                                      ...
                                                      <tr>
                                                        ...
                                                        <td><?php if(!empty($conversations[$i]['plan_name']))
                                                                    { 
                                                                        echo ucfirst(strtolower($conversations[$i]['plan_name']));
                                                                    }
                                                                    ...
                                                                    { 
                                                                        echo " >> ".ucfirst(strtolower($conversations[$i]['interaction_name']));
                                                                    }?>
                                                        </td>
                                                      </tr>
                                                      <tr>
                                                        <td>
                                                                <?php if(!empty($conversations[$i]['mail_out_type']) && $conversations[$i]['mail_out_type']=='Letter')
                                                                {
                                                                    ...
                                                                    {	
                                                                     echo ucfirst(strtolower($conversations[$i]['letter_template_name']));
                                                                    }
                                                                }
                                                                else
                                                                if(!empty($conversations[$i]['mail_out_type']) && $conversations[$i]['mail_out_type']=='Envelope')
                                                                {
                                                                    ...
                                                                    {	
                                                                        echo ucfirst(strtolower($conversations[$i]['envelope_template_name']));
                                                                    }
                                                                }
                                                                else if(!empty($conversations[$i]['mail_out_type']) && $conversations[$i]['mail_out_type']=='Label')
                                                                {
                                                                    ...
                                                                    {	
                                                                        echo ucfirst(strtolower($conversations[$i]['label_template_name']));
                                                                    }
                                                                }
                                                                if(!empty($conversations[$i]['log_type']) && $conversations[$i]['log_type']=='8')
                                                                {
                                                                    ...
                                                                    {	
                                                                        echo ucfirst(strtolower($conversations[$i]['sms_campaing_template_name']));
                                                                    }
                                                                }
                                                                if(!empty($conversations[$i]['log_type']) && $conversations[$i]['log_type']=='7')
                                                                    { 
                                                                        if(!empty($conversations[$i]['sms_template_name']))
                                                                        {
                                                                            ...
                                                                            echo ucfirst(strtolower($conversations[$i]['sms_template_name']));
