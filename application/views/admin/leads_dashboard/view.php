                          ...
                          <!--<tr style="display:none;">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input id="followup_date" name="followup_date" class="form-control parsley-validated" type="text" value="<?php if (!empty($editRecord[0]['followup_date']) && $editRecord[0]['followup_date'] != '0000-00-00' && $editRecord[0]['followup_date'] != '1970-01-01') {
                                echo date($this->config->item('common_date_format'), strtotime($editRecord[0]['followup_date']));
                            } ?>" readonly>
                                </td>
                            </tr>
                        </table>
                                ...
                                <div class="leads_dashboard_top_left_part">
                                    ...
                                    <div class="leads_dashboard_details">
                                        ...
                                        if (!empty($email_trans_data[0]) && !empty($editRecord[0])) {
                                            ...
                                            ?>
                                                <?php if ($editRecord[0]['is_subscribe'] == '0') { ?>
                                        ...
                                        <div class="bottom-btn-set">
                                            ...
                                            <?php } ?>
                                                ...
                                                if (!empty($email_trans_data[0])) {
                                                    //pr($email_trans_data[0]); 
                                                    ?>
                                                <?php if (!empty($editRecord[0]) && $editRecord[0]['is_subscribe'] == '0') { ?>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td width="10%" align="center" valign="middle">
                                                                                    <?php if ($personale_touches[$i]['is_done'] == '0') { ?>
                                                                                        <input type="checkbox" id="selectall1_<?php echo $personale_touches[$i]['id']; ?>" value="<?php if (!empty($personale_touches[$i]['is_done']) && $personale_touches[$i]['is_done'] == '1') {
                                                                                        echo '1';
                                                                                    } ?>" class="selecctall"<?php if (!empty($personale_touches[$i]['is_done']) && $personale_touches[$i]['is_done'] == '1') {
                                                                                        echo "checked=checked";
                                                                                    } ?> onClick="is_done_p(this.value,<?php echo $personale_touches[$i]['id']; ?>);">
                                                                                <?php } ?><br />
                                                                                ...
                                                                                <td width="90%">
                                                                                    <table width="100%" class="personaltouches mrg-bottom-0" border="0" cellspacing="0" cellpadding="0">
                                                                                        <tr>
                                                                                            <td width="20%"><b><?php if (!empty($personale_touches[$i]['followup_date'])) {
                                                                                                echo date($this->config->item('common_date_format'), strtotime($personale_touches[$i]['followup_date']));
                                                                                            } ?></b></td>
                                                                                            <td width="80%"><?php if (!empty($personale_touches[$i]['task'])) {
                                                                                                echo $personale_touches[$i]['task'];
                                                                                            } ?></td>
                                                                                        </tr>
                                                                                        <tr>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="conversations_table append_conversation_data_ajax">
                                                            <?php $this->load->view('admin/leads_dashboard/history_details'); ?>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="portlet-content div_height">
                                                    ...
                                                    <div id="myTab10Content" class="tab-content">
                                                        ...
                                                        <div class="row tab-pane fade in" id="add_plans">
                                                            <form class="form parsley-form" enctype="multipart/form-data" name="<?php echo $viewname; ?>" id="<?php echo $viewname; ?>" method="post" accept-charset="utf-8" action="<?php echo $this->config->item('admin_base_url') ?><?php echo $path_update_view; ?>" novalidate >
                                                                ...
                                                                <select class="form-control parsley-validated" name="slt_communication_plan[]" id="slt_communication_plan" multiple="multiple">
                                                                    ...
                                                                    <?php if (!empty($communication_plans)) {
                                                                        foreach ($communication_plans as $row) {
                                                                            ?>
                                                                            <option <?php if (!empty($plan_list_array) && in_array($row['id'], $plan_list_array)) {
                                                                                echo "selected";
                                                                            } ?> value="<?= $row['id'] ?>"><?= $row['plan_name'] ?></option>
                                                                        <?php } ?>
                                                                    <?php } ?>
                                                                </select>
                              ...
                              <button title="Reply" data-type="danger" class="btn btn-secondary howler smaller_btn1">Search History</button>
                                ...
                                <div <?php if ($tabid == 2) { ?> class="row tab-pane fade in active" <?php } else { ?> class="row tab-pane fade in" <?php } ?> id="properties">
                                    <div id="common_div_pv">  
                                        <?=$this->load->view('admin/'.$viewname.'/property_tab')?>
                                    </div>
                                    <?php /* if(!empty($editRecord[0]['joomla_domain_name']) && $this->config->item('livewire_db_conditions')) { ?>
                                            ...
                                            <div class="table-responsive">
                                                <div class="table-in-responsive">
                                                    <div class="row dt-rt">
                                                        ...
                                                        <?php if (!empty($msg)) { ?>
                                                            <div class="col-sm-12 text-center" id="div_msg"><?php
                                                                echo '<label class="error">' . urldecode($msg) . '</label>';
                                                                $newdata = array('msg' => '');
                                                                $this->session->set_userdata('message_session', $newdata);
                                                                ?> </div><?php } ?>                              <div class="col-lg-12 col-sm-12 col-xs-12">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="table-responsive">
                                                <div class="table-in-responsive">
                                                    ...
                                                    <div class="row dt-rt">
                                                        <?php if (!empty($msg)) { ?>
                                                            <div class="col-sm-12 text-center" id="div_msg1"><?php
                                                                echo '<label class="error">' . urldecode($msg) . '</label>';
                                                                $newdata = array('msg' => '');
                                                                $this->session->set_userdata('message_session', $newdata);
                                                                ?> </div><?php } ?>
                                                    ...
                                                    <div id="common_div_vs">
                                                        <?= $this->load->view('admin/' . $viewname . '/view_valuation_searched') ?>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div  <?php if ($tabid == 4) { ?> class="row tab-pane fade in active" <?php } else { ?> class="row tab-pane fade in" <?php } ?> id="edit_profile" >
                                    ...
                                    <form class="form parsley-form" enctype="multipart/form-data" name="<?php echo $viewname; ?>" id="<?php echo $viewname; ?>_edit_profile" method="post" accept-charset="utf-8" action="<?php echo $this->config->item('admin_base_url') ?><?php echo $path ?>" data-validate="parsley" novalidate >
                                        <input id="id" name="id" type="hidden" value="<?php if (!empty($editRecord[0]['id'])) {
                                            echo $editRecord[0]['id'];
                                        } ?>">
                                        ...
                                        <div class="col-sm-12 col-lg-7 new-mar-bot">
                                            <div class="row">
                                                <div class="col-sm-12 col-lg-4">
                                                    ...
                                                    <select class="form-control parsley-validated" name="slt_prefix" id="slt_prefix">
                                                        <option value="">Please Select</option>
                                                        <option <?php if (!empty($editRecord[0]['prefix']) && $editRecord[0]['prefix'] == 'Mr.') {
                                                            echo "selected";
                                                        } ?> value="Mr.">Mr.</option>
                                                        <option <?php if (!empty($editRecord[0]['prefix']) && $editRecord[0]['prefix'] == 'Ms.') {
                                                            echo "selected";
                                                        } ?> value="Ms.">Ms.</option>
                                                        <option <?php if (!empty($editRecord[0]['prefix']) && $editRecord[0]['prefix'] == 'Mrs.') {
                                                            echo "selected";
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12  col-lg-4 form-group">
                                                    ...
                                                    <input id="txt_first_name" name="txt_first_name" maxlength="50" class="form-control parsley-validated charval" type="text"  value="<?php if (!empty($editRecord[0]['first_name'])) {
                                                        echo $editRecord[0]['first_name'];
                                                    } ?>" data-required="true" onkeypress="return isCharacterKey(event)" placeholder="e.g. John">
                                                </div>
                                                <div class="col-sm-12  col-lg-4">
                                                    <label for="text-input"><?= $this->lang->line('contact_add_mname'); ?></label>
                                                    <input id="txt_middle_name" name="txt_middle_name" maxlength="50" class="form-control parsley-validated" onkeypress="return isCharacterKey(event)" type="text" value="<?php if (!empty($editRecord[0]['middle_name'])) {
                                                        echo $editRecord[0]['middle_name'];
                                                    } ?>" placeholder="e.g. Jane">
                                                </div>
                                                <div class="col-sm-12  col-lg-4">
                                                    <label for="text-input"><?= $this->lang->line('contact_add_lname'); ?></label>
                                                    <input id="txt_last_name" name="txt_last_name" maxlength="50" onkeypress="return isCharacterKey(event)" class="form-control parsley-validated" type="text" value="<?php if (!empty($editRecord[0]['last_name'])) {
                                                        echo $editRecord[0]['last_name'];
                                                    } ?>" placeholder="e.g. Laren">
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-sm-12  col-lg-4 form-group">
                                                 <label for="text-input"><?= $this->lang->line('contact_add_spousefname'); ?><!--<span class="mandatory_field margin-left-5px">*</span>--></label>
                                                    <input id="txt_spousefirst_name" name="txt_spousefirst_name" maxlength="50" class="form-control parsley-validated" type="text" onkeypress="return isCharacterKey(event)" value="<?php if (!empty($editRecord[0]['spousefirst_name'])) {
                                                        echo $editRecord[0]['spousefirst_name'];
                                                    } ?>" placeholder="e.g. Ruby" >
                                                </div>
                                                <div class="col-sm-12  col-lg-4">
                                                    <label for="text-input"><?= $this->lang->line('contact_add_spouselname'); ?></label>
                                                    <input id="txt_spouselast_name" name="txt_spouselast_name" maxlength="50" class="form-control parsley-validated" type="text" onkeypress="return isCharacterKey(event)" value="<?php if (!empty($editRecord[0]['spouselast_name'])) {
                                                        echo $editRecord[0]['spouselast_name'];
                                                    } ?>" placeholder="e.g. Sen">
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-sm-12 col-lg-8">
                                                    ...
                                                    <input id="txt_company_name" name="txt_company_name" class="form-control parsley-validated" type="text" value="<?php if (!empty($editRecord[0]['company_name'])) {
                                                        echo $editRecord[0]['company_name'];
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12 col-lg-8">
                                                    ...
                                                    <input id="txt_company_post" name="txt_company_post" class="form-control parsley-validated" type="text" value="<?php if (!empty($editRecord[0]['company_post'])) {
                                                                    echo $editRecord[0]['company_post'];
                                                ...
                                                <div class="col-sm-12 checkbox">
                                                    <label class="">
                                                        ...
                                                        <div class="float-left margin-left-15">
                                                            <input type="checkbox" value="1" class=""  id="chk_is_lead" name="chk_is_lead" <?php if (!empty($editRecord[0]['is_lead']) && $editRecord[0]['is_lead'] == '1') {
                                                                    echo 'checked="checked"';
                                                                } ?>>
                                                        </div>
                                                    </label>
                                                        ...
                                                        <div class="">
                                                            ...
                                                            <div class="delete_email_trans_record<?= $rowtrans['id'] ?> padding-top-10 clear autooverflow">
                                                                <div class="col-sm-4 col-lg-4 my_col_lg_4 form-group"> 
                                                                  <!--<label for="validateSelect"><?= $this->lang->line('common_label_email_type'); ?></label>-->
                                                                    <input type="hidden" name="email_type_trans_id[]" id="email_type_trans_id" value="<?php if (!empty($rowtrans['id'])) {
                                                                echo $rowtrans['id'];
                                                            } ?>">
                                                                        ...
                                                                        <option value="">Please Select</option>
                                                                            <?php if (!empty($email_type)) {
                                                                                foreach ($email_type as $row) {
                                                                                    ?>
                                                                                <option <?php if (!empty($rowtrans['email_type']) && $rowtrans['email_type'] == $row['id']) {
                                                                                        echo "selected";
                                                                ...
                                                                <div class="col-sm-4 col-lg-4 my_col_lg_4 form-group"> 
                                                                  <!--<label for="validateSelect"><?= $this->lang->line('contact_add_email_address'); ?></label>-->
                                                                    <input id="txt_email_addresse" name="txt_email_addresse[]" class="form-control parsley-validated" type="email"  value="<?php if (!empty($rowtrans['email_address'])) {
                                                                        echo $rowtrans['email_address'];
                                                                    } ?>" data-parsley-type="email" placeholder="e.g. abc.gmail.com">
                                                                </div>
                                                                        ...
                                                                        <div class="radio">
                                                                            <label class="">
                                                                                <div class="margin-left-48">
                                                                                    <input type="radio" class=""  name="rad_email_default" <?php if (!empty($rowtrans['is_default']) && $rowtrans['is_default'] == '1') {
                                                                                        echo 'checked="checked"';
                                                                                    } ?> >
                                                                                </div>
                                                                            </label>
                                 ...
                                 <div class="col-sm-12 topnd_margin"> <a href="javascript:void(0);" title="Add Email" class="text_color_red text_size add_email_address"><i class="fa fa-plus-square"></i> Add Email Address</a> </div>
                                                    ...
                                                    <?php if (!empty($phone_trans_data) && count($phone_trans_data) > 0) {
                                                        foreach ($phone_trans_data as $rowtrans) {
                                                            ...
                                                            <div class="delete_phone_trans_record<?= $rowtrans['id'] ?> padding-top-10 clear autooverflow">
                                                                <div class="col-sm-4 col-lg-4 my_col_lg_4 form-group"> 
                                                                  <!--<label for="validateSelect"><?= $this->lang->line('common_label_phone_type'); ?></label>-->
                                                                    <input type="hidden" name="phone_type_trans_id[]" id="phone_type_trans_id" value="<?php if (!empty($rowtrans['id'])) {
                                                                        echo $rowtrans['id'];
                                                                    } ?>">
                                                                        ...
                                                                        <option value="">Please Select</option>
                                                                            <?php if (!empty($phone_type)) {
                                                                                foreach ($phone_type as $row) {
                                                                                    ?>
                                                                                <option <?php if (!empty($rowtrans['phone_type']) && $rowtrans['phone_type'] == $row['id']) {
                                                                                        echo "selected";
                                                                                    } ?> value="<?= $row['id'] ?>"><?= ucwords($row['name']); ?></option>
                                                                                <?php } ?>
                                                                            <?php } ?>
                                                                ...
                                                                <div class="col-sm-4 col-lg-4 my_col_lg_4 form-group"> 
                                                                  <!--<label for="validateSelect"><?= $this->lang->line('contact_add_phone_no'); ?></label>-->
                                                                    <input id="txt_phone_no" name="txt_phone_noe[]"  maxlength="12"  data-maxlength="12" class="form-control parsley-validated mask_apply_class" type="text" value="<?php if (!empty($rowtrans['phone_no'])) {
                                                                    ...
                                                                    <div class=""> 
                                                                      <!--<label><?= $this->lang->line('common_default'); ?></label>-->
                                                                        <div class="radio">
                                                                            <label class="">
                                                                                <div class="margin-left-48">
                                                                                    <input type="radio" class=""   name="rad_phone_default" <?php if (!empty($rowtrans['is_default']) && $rowtrans['is_default'] == '1') {
                                                                                        echo 'checked="checked"';
                                                                                    } ?> >
                                                                                </div>
                                                                            </label>
                                                    ...
                                                    ?>	
                                                        ...
                                                        <div class="delete_address_trans_record<?= $rowtrans['id'] ?> padding-top-10 clear autooverflow">
                                                            <div class="col-sm-3 columns">
                                                                <input type="hidden" name="address_type_trans_id[]" id="address_type_trans_id" value="<?php if (!empty($rowtrans['id'])) {
                                                                    echo $rowtrans['id'];
                                                                } ?>">
                                                        ...
                                                        <?php if (!empty($address_type)) {
                                                            foreach ($address_type as $row) {
                                                                ?>
                                                                            <option <?php if (!empty($rowtrans['address_type']) && $rowtrans['address_type'] == $row['id']) {
                                                                    echo "selected";
                                                                } ?> value="<?= $row['id'] ?>"><?= ucwords($row['name']); ?></option>
                                                                    <?php } ?>
                                                                <?php } ?>
                                                            ...
                                                            <div class="col-sm-6 columns">
                                                                <div class="row">
                                                                    <textarea placeholder="Address Line 1" id="txtarea_address_line1" name="txtarea_address_line1e[]" class="form-control parsley-validated"><?php if (!empty($rowtrans['address_line1'])) {
                                                                        echo $rowtrans['address_line1'];
                                                                    } ?></textarea>
                                                                </div>
                                                                <div class="row">
                                                                    <input type="text" placeholder="Address Line 2" name="txtarea_address_line2e[]" id="txtarea_address_line2" class="form-control parsley-validated" value="<?php if (!empty($rowtrans['address_line2'])) {
                                                                        echo $rowtrans['address_line2'];
                                                                    } ?>">
                                                                </div>
                                                                <div class="row">
                                                                    <div class="col-sm-5 nopadding">
                                                                        <input type="text" placeholder="City" id="txt_city" name="txt_citye[]" class="form-control parsley-validated" value="<?php if (!empty($rowtrans['city'])) {
                                                                            echo $rowtrans['city'];
                                                                        } ?>">
                                                                    </div>
                                                                    <div class="col-sm-3 nopadding">
                                                                        <input type="text" placeholder="State" id="txt_state" name="txt_statee[]" class="form-control parsley-validated" value="<?php if (!empty($rowtrans['state'])) {
                                                                            echo $rowtrans['state'];
                                                                        } ?>">
                                                                    </div>
                                                                    <div class="col-sm-4 nopadding form-group">
                                                                        <input type="text" placeholder="Zip Code" id="txt_zip_code" name="txt_zip_codee[]" maxlength="5" data-minlength="5" class="form-control parsley-validated" value="<?php if (!empty($rowtrans['zip_code'])) {
                                                                            echo $rowtrans['zip_code'];
                                                                        } ?>">
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                    <input type="text" placeholder="Country" id="txt_country" name="txt_countrye[]" class="form-control parsley-validated" value="<?php if (!empty($rowtrans['country'])) {
                                                                echo $rowtrans['country'];
                                                            } ?>">
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-2">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-8">
                                                    ...
                                                    <textarea name="txtarea_notes" placeholder="e.g. Notes" id="txtarea_notes" class="form-control parsley-validated"><?php if (!empty($editRecord[0]['notes'])) {
                                                        echo $editRecord[0]['notes'];
                                                    } ?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                                            ...
                                                            foreach ($website_trans_data as $rowtrans) {
                                                                ...
                                                                <div class="delete_website_trans_record<?= $rowtrans['id'] ?> padding-top-10 clear autooverflow">
                                                                    <div class="col-sm-5">
                                                                        ...
                                                                        <input type="hidden" class="form-control" id="txt_website_typeid" name="txt_website_typeid[]" value="<?php if (!empty($rowtrans['id'])) {
                                                                            echo $rowtrans['id'];
                                                                        } ?>">
                                                                        ...
                                                                        <?php if (!empty($website_type)) {
                                                                            foreach ($website_type as $row) {
                                                                                ?>
                                                                                    <option <?php if (!empty($rowtrans['website_type']) && $rowtrans['website_type'] == $row['id']) {
                                                                    echo "selected";
                                                                } ?> value="<?= $row['id'] ?>"><?= ucwords($row['name']); ?></option>
                                                                    <?php } ?>
                                                                <?php } ?>
                                                                    ...
                                                                    <div class="col-sm-5 form-group">
                                                                        <input type="url" class="form-control parsley-validated" id="txt_website_namee" name="txt_website_namee[]" value="<?php if (!empty($rowtrans['website_name'])) {
                                                                            echo $rowtrans['website_name'];
                                                                        } ?>" data-parsley-type="url"  placeholder="e.g. www.xyz.com">
                                                                    </div>
                                                                    <div class="col-sm-1 text-center icheck-input-new">
                                                                        <div class="">
                                                        ...
                                                        <?php if (!empty($profile_trans_data) && count($profile_trans_data) > 0) {
                                                            foreach ($profile_trans_data as $rowtrans) {
                                                                ...
                                                                <div class="delete_social_trans_record<?= $rowtrans['id'] ?> padding-top-10 clear autooverflow">
                                                                    <div class="col-sm-5">
                                                                        <input type="hidden" class="form-control" id="slt_profile_typeid" name="slt_profile_typeid[]" value="<?php if (!empty($rowtrans['id'])) {
                                                                    echo $rowtrans['id'];
                                                                } ?>">
                                                                ...
                                                                <?php if (!empty($profile_type)) {
                                                                    foreach ($profile_type as $row) {
                                                                        ?>
                                                                                    <option <?php if (!empty($rowtrans['profile_type']) && $rowtrans['profile_type'] == $row['id']) {
                                                                            echo "selected";
                                                                        } ?> value="<?= $row['id'] ?>"><?= ucfirst($row['name']); ?></option>
                                                                            <?php } ?>
                                                                        <?php } ?>
                                                                        </select>
                                                                    </div>
                                                                    <div class="col-sm-5 form-group">
                                                                        <input type="text" class="form-control parsley-validated fbid" id="txt_social_profilee" name="txt_social_profilee[]" value="<?php if (!empty($rowtrans['website_name'])) {
                                                                            echo $rowtrans['website_name'];
                                                                        } ?>" data-parsley-type="url" placeholder="e.g. https://twitter.com/demo">
                                                                    </div>
                                                                    <div class="col-sm-1 text-center icheck-input-new">
                                                                        <div class="">
                                                        ...
                                                        <option value="">Please Select</option>
                                                            <?php if (!empty($source_type)) {
                                                                foreach ($source_type as $row) {
                                                                    ?>
                                                                <option <?php if (!empty($editRecord[0]['contact_source']) && $editRecord[0]['contact_source'] == $row['id']) {
                                                                    echo "selected";
                                                                } ?> value="<?= $row['id'] ?>"><?= ucwords($row['name']); ?></option>
                                                            <?php } ?>
                                                        <?php } ?>
                                                ...
                                                <div class="col-sm-8">
                                                    ...
                                                    <?php if (!empty($method_type)) {
                                                        foreach ($method_type as $row) {
                                                            ?>
                                                                <option <?php if (!empty($editRecord[0]['contact_method']) && $editRecord[0]['contact_method'] == $row['id']) {
                                                        echo "selected";
                                                    } ?> value="<?= $row['id'] ?>"><?= ucwords($row['name']); ?></option>
                                                        <?php } ?>
                                                    <?php } ?>
                                                ...
                                                foreach ($contact_type as $row) {
                                                    ?>
                                                                ...
                                                                <div class="checkbox nopadding margin-left-20">
                                                                    <label class="">
                                                                        <div class="">
                                                                            <input <?php if (in_array($row['id'], $selectedcontacttypes)) {
                                                                                echo 'checked="checked"';
                                                                            } ?> type="checkbox" class="" name="chk_contact_type_id[]" value="<?= $row['id']; ?>">
                                                                        </div>
                                                        <?= $row['name']; ?>
                                                                    </label>
                                                                </div>
                                                    ...
                                                    <select class="form-control parsley-validated" name="slt_contact_status" id="slt_contact_status">
                                                        ...
                                                        <?php if (!empty($status_type)) {
                                                            foreach ($status_type as $row) {
                                                                ?>
                                                                <option <?php if (!empty($editRecord[0]['contact_status']) && $editRecord[0]['contact_status'] == $row['id']) {
                                                                echo "selected";
                                                            } ?> value="<?= $row['id'] ?>"><?= ucwords($row['name']); ?></option>
                                                    <?php } ?>
                                                <?php } ?>
        ...
        foreach ($communication_trans_data as $rowtrans) {
            ...
            ?>
                    ...
                    <!--<div class="delete_communication_trans_record<?= $rowtrans['id'] ?> padding-top-10 clear autooverflow">
                            <div class="col-sm-8">
                             <input type="hidden" name="communication_trans_id[]" id="communication_trans_id" value="<?php if (!empty($rowtrans['id'])) {
                echo $rowtrans['id'];
            } ?>">
            ...
            <?php if (!empty($communication_plans)) {
                foreach ($communication_plans as $row) {
                    ?>
                                                                            <option <?php if (!empty($rowtrans['interaction_plan_id']) && $rowtrans['interaction_plan_id'] == $row['id']) {
                        echo "selected";
                    } ?> value="<?= $row['id'] ?>"><?= $row['plan_name'] ?></option>
                <?php } ?>
            <?php } ?>
...
if (!empty($user_list)) {
    foreach ($user_list as $row) {
        ...
        ?>
                                                                <option value="<?= $row['id'] ?>" <?php if (!empty($user_add_list[0]['user_id']) && $user_add_list[0]['user_id'] == $row['id']) {
            echo "selected";
        } ?>><?= ucwords($row['first_name'] . " " . $row['middle_name'] . " " . $row['last_name'] . $email); ?></option>
    <?php } ?>
<?php } ?>
                                                    </select>
                                                </div>
                                        ...
                                        <div class="col-sm-12 pull-left text-center margin-top-10">
                                            ...
                                            <input type="hidden" id="fb_id" name="fbid" value="<?php if (!empty($editRecord[0]['fb_id'])) {
    echo $editRecord[0]['fb_id'];
} ?>"/>
...
<?php } ?>
            ...
            $.confirm({'title': 'Alert', 'message': " <strong> Same phone no used multiple times. Please insert different phone no. " + "<strong></strong>", 'buttons': {'ok'	: {'class'	: 'btn_center alert_ok'}}});
                    ...
                    if (returndata == 1)
                    return false;
                    emailchkval = $('input[name=rad_email_default]:checked', '#<?php echo $viewname; ?>_edit_profile').closest("div.my_col_lg_2").siblings('div.my_col_lg_4').find('input[type=email]').val();
                    $('input[name=rad_email_default]:checked', '#<?php echo $viewname; ?>_edit_profile').val(emailchkval);
                    phonechkval = $('input[name=rad_phone_default]:checked', '#<?php echo $viewname; ?>_edit_profile').closest("div.my_col_lg_2").siblings('div.my_col_lg_4').find('input[type=text]').val();
                    $('input[name=rad_phone_default]:checked', '#<?php echo $viewname; ?>_edit_profile').val(phonechkval);
            }
    ...
    $(".contact_register_popup").html('Something went wrong.');
            ...
            contact_search('changesearch');
                    ...
                    $(".saved_searches_popup").html('<div class="text-center"><img src="<?= base_url() ?>images/ajaxloader.gif" /></div>');
                            ...
                            $.ajax({
                    type: "POST",
                            url: "<?php echo $this->config->item('admin_base_url') . $viewname . '/view_record_index_savser'; ?>",
                                                    ...
                                                    $(".properties_viewed_popup").html('Something went wrong.');
                                                            ...
                                                            function contact_search3(allflag)
                                                                    ...
                                                                    var uri_segment = $("#uri_segment3").val();
                                                                            ...
                                                                            $.ajax({
                                                                    type: "POST",
                                                                            url: "<?php echo base_url(); ?>admin/leads_dashboard/view_record_index_prop_view/" + id,
                                                                            data: {
...
<script type="text/javascript">
                                                                                            ...
                                                                                            function contact_search1(allflag)
                                                                                                    ...
                                                                                                    var uri_segment = $("#uri_segment1").val();
                                                                                                            ...
                                                                                                            $.ajax({
                                                                                                    type: "POST",
                                                                                                            url: "<?php echo base_url(); ?>admin/leads_dashboard/view_record_index_savser/" + id,
                                                                                                            data: {
                                                                                                    result_type:'ajax', searchreport:$("#searchreport").val(), perpage:$("#perpage1").val(), searchtext:$("#searchtext1").val(), sortfield:$("#sortfield1").val(), sortby:$("#sortby1").val(), allflag:allflag, id:id
                                                                                                    },
                                                                                                            beforeSend: function() {
...
<script type="text/javascript">
                                                                                            ...
                                                                                            $(".valuation_searched_popup").html('<div class="text-center"><img src="<?= base_url() ?>images/ajaxloader.gif" /></div>');
                                                                                                    ...
                                                                                                    $.ajax({
                                                                                            type: "POST",
                                                                                                    url: "<?php echo $this->config->item('admin_base_url') . $viewname . '/valuation_searched_popup'; ?>",
                                                                                                    data: {'search_id':search_id},
                                                                                                    success: function(html){
                                                                                            ...
                                                                                            $(".valuation_searched_popup").html('Something went wrong.');
                                                                                                    ...
                                                                                                    function contact_search5(allflag)
                                                                                                            ...
                                                                                                            var uri_segment = $("#uri_segment5").val();
                                                                                                                    ...
                                                                                                                    $.ajax({
                                                                                                            type: "POST",
                                                                                                                    url: "<?php echo base_url(); ?>admin/leads_dashboard/view_record_index_valuation_searched/" + id,
                                                                                                                    data: {
                                                                                                            ...
                                                                                                            showOn: "button",
                                                                                                                    ...
                                                                                                                    function is_done_p(id, is_done_hidd)
                                                                                                                            ...
                                                                                                                            if ($('#selectall1_' + is_done_hidd).prop('checked') == true)
                                                                                                                                    ...
                                                                                                                                    $.ajax({
                                                                                                                            type: "POST",
                                                                                                                                    url: "<?php echo $this->config->item('admin_base_url') . 'contacts/personal_id_done'; ?>",
                                                                                                                                    dataType: 'json',
                                                                                                                                    async: false,
                                                                                                                    ...
                                                                                                                    function history_search()
                                                                                                                            ...
                                                                                                                            myarray[i] = this.value;
                                                                                                                                    ...
                                                                                                                                    $.ajax({
                                                                                                                            type: "POST",
                                                                                                                                    url: "<?php echo base_url(); ?>admin/contacts/change_conversations",
                                                                                                                                    data: {
