     ...
     <div class="portlet">
      ...
      <div class="portlet-content">
        <ul class="nav nav-tabs" id="myTab1">
                <li <?php if($tabid == '' || $tabid == 1){?> class="active" <?php } ?> > <a title="Email Library" data-toggle="tab" href="#my_library" onclick="load_view('my_library');"><?=$this->lang->line('label_library_header');?></a> </li>
                <li <?php if($tabid == 2){?> class="active" <?php } ?>> <a title="Email Library" data-toggle="tab" href="#default_library" onclick="load_view('default_library');"> Default <?=$this->lang->line('label_library_header');?></a> </li>
            </ul>
...
<script>
	...
	function contact_search(allflag)
	{
		...
		$.ajax({
			type: "POST",
			url: "<?php echo base_url();?>admin/label_library/"+uri_segment,
			data: {
	...
	function delete_all(id)
		{
			...
			success: function(data){
				...
				$.ajax({
					type: "POST",
					url: "<?php echo base_url();?>admin/label_library/"+data,
					data: {
