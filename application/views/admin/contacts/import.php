      ...
      <div class="portlet-content">
       <div class="table-responsive">
        <div role="grid" class="dataTables_wrapper" id="DataTables_Table_0_wrapper">
         <div id="common_div">
		 <form class="form parsley-form" enctype="multipart/form-data" name="<?php echo $viewname;?>" id="<?php echo $viewname;?>" method="post" accept-charset="utf-8" action="<?php echo $this->config->item('admin_base_url').$viewname.'/insert_contact_csv';?>" data-validate="parsley" >
		 <div class="col-sm-12">
            <div class="row">
...
<script type="text/javascript">
	$(function(){
		...
		new AjaxUpload(btnUpload1, {
			type: 'post',
			data:{},
			action: '<?=$this->config->item('admin_base_url').$viewname."/upload_csv";?>',
			name: 'uploadfile',
