	  ...
	  <div class="row">
       <div class="col-sm-12">
			...
			<form class="form parsley-form" enctype="multipart/form-data" name="<?php echo $viewname;?>" id="<?php echo $viewname;?>" method="post" accept-charset="utf-8" action="<?php echo $this->config->item('admin_base_url')?><?php echo $path?>" data-validate="parsley" novalidate >
			   <div class="col-sm-12">
				<div class="row">
				 <div class="col-sm-12 col-lg-4 appendfielddata">
				  ...
				  <div class="row">
					  <div class="col-sm-10 form-group">
						  <select class="form-control parsley-validated" name="slt_fields[]" id="slt_prefix" data-required="true">
                           ...
                           <option value="address_line1"><?=$this->lang->line('staff_add_labeladdress');?></option>
						  </select>
					  </div>
					  <div class="col-sm-2 form-group padding-top-5">
						<a href="javascript:void(0);" title="Add More Field" class="btn btn-xs btn-success addnewfielddropdown"><i class="fa fa-plus"></i></a>
					  </div>
				  </div>
				 </div>
				</div>
		...
		inlinehtml += '<div class="remove_field_div clear">';
			inlinehtml += '<div class="row">';
					  ...
					  inlinehtml += '<div class="col-sm-2 form-group padding-top-5">';
						inlinehtml += '<a href="javascript:void(0);" title="Delete Field" class="btn btn-xs btn-primary removenewfielddropdown"><i class="fa fa-times"></i></a>';
					  inlinehtml += '</div>';
				  inlinehtml += '</div>';
		inlinehtml += '</div>';
