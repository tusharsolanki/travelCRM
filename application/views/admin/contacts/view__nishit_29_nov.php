          ...
          <li <?php if($tabid == 8){?> class="active" <?php } ?>> <a title="Buyer Preferences" data-toggle="tab" onclick="load_view('8');" href="#buyer_preference">
            ...
            <?php } ?>
			 <?php 
					if($joomla == "Yes"){
					?>
                <li <?php if($tabid == 9  || $joomla_tabid == 105){?> class="active" <?php } ?>> <a title="Joomla Connection" data-toggle="tab" onclick="load_view('9');" href="#joomla_connection">
            ...
            <div class="add_emailtype">
              ...
              <div class="col-sm-6">
                ...
                <?php } ?>
                  ...
                  <?php /*?><?php if(!empty($communication_trans_data) && count($communication_trans_data) > 0){
						foreach($communication_trans_data as $rowtrans){ ?>
                  <div class="">
                    <div class="">
                      <?php if(!empty($communication_plans)){
                 ...
                 <?php } } ?>
                  ...
                  <?php if($flag == 'twitter'){ ?>
                  	<?php foreach($profile_trans_data as $rowtrans){ 
								if($rowtrans['profile_type'] == '2')
								{?>
									<i class="fa fa-twitter scl_btn btn-twitter"></i><a class="twitter-follow-button" href="https://twitter.com/<?=$rowtrans['website_name']?>" data-show-count="false" data-lang="en">Follow @<?=$rowtrans['website_name']?></a>
									<?php break;
								}
							}
						?>
...
<div class="add_website add_emailtype1">
      ...
      <div  <?php if($tabid == 9 || $joomla_tabid == 105){?> class="row tab-pane fade in active" <?php }else{ ?> class="row tab-pane fade in" <?php } ?> id="joomla_connection" >
        <div class="col-lg-12">
    ...
    <div  <?php  if($tabid == 108){?> class="row tab-pane fade in active" <?php }else{ ?> class="row tab-pane fade in" <?php } ?> id="last_login" >
      ...
      <div class="col-lg-12">
		...
		<?php /*?><?=$interation_plan_communication_plan[$i]['assign_name']?$interation_plan_communication_plan[$i]['assign_name']:''?><?php */?>
                            <?php if(!empty($interation_plan_communication_plan[$i]['assign_name'])) { echo ucwords($interation_plan_communication_plan[$i]['assign_name']);}elseif(!empty($interation_plan_communication_plan[$i]['assign_name1'])) { echo ucwords($interation_plan_communication_plan[$i]['assign_name1']);}?>
                        </td>
                      </tr>
                      <tr>
