...
<style>
    .ui-multiselect {width: 671px !important;}
</style>
<div id="content">
...
<script type="text/javascript">
    ...
    */
    ...
    $(function() {
        ...
        $( "#searchc" ).catcomplete({
            delay: 0,
            source: '<?=$this->config->item('admin_base_url')?>contacts/get_property/<?=!empty($mls_id)?$mls_id:0?>',
    ...
    */
    ...
    /*$('body').on('blur','#min_price, #max_price',function(e){
            //alert($("#min_price").val());
        ...
        if((lil > 0 && big != 0) || (lil != 0 && big > 0) || (lil > 0 && big > 0))
        {
            if (lil > big) {
                ...
                if (targ.is("#max_price")) {
                    ...
                    $('#ass_submitbtn').attr('disabled','disabled');
                    $('#ass_cancel').attr('disabled','disabled');
                    $.confirm({'title': 'Alert','message': " <strong> Maximum price must be greater than minimum "+"<strong></strong>",
                        'buttons': {'ok'	: {
                        'class'	: 'btn_center alert_ok',	
                        'action': function(){
                                $('#max_price').val(lil);
                                $('#max_price').focus();
                                $('#ass_submitbtn').removeAttr('disabled');
                                $('#ass_cancel').removeAttr('disabled');
                        }},  }
                    });
                ...
                if (targ.is("#min_price")) {
                    ...
                    $('#ass_submitbtn').attr('disabled','disabled');
                    $('#ass_cancel').attr('disabled','disabled');	
                    $.confirm({'title': 'Alert','message': " <strong> Min price must be less than maximum "+"<strong></strong>",
                        'buttons': {'ok'	: {
                        'class'	: 'btn_center alert_ok',	
                        'action': function(){
                                $('#min_price').val(big);
    ...
    $('body').on('change','#min_area, #max_area',function(e){

        var from_val = $("#min_area").val();
        var to_val = $("#max_area").val();
        ...
        if((lil > 0 && big != 0) || (lil != 0 && big > 0) || (lil > 0 && big > 0))
        {
            if (lil > big) {
                ...
                if (targ.is("#max_area")) {
                    ...
                    $('#ass_submitbtn').attr('disabled','disabled');
                    $('#ass_cancel').attr('disabled','disabled');
                    $.confirm({'title': 'Alert','message': " <strong> Maximum area must be greater than minimum "+"<strong></strong>",
                        'buttons': {'ok'	: {
                        'class'	: 'btn_center alert_ok',	
                        'action': function(){
                                $('#max_area').val(lil);
                ...
                if (targ.is("#min_area")) {
                    ...
                    $('#ass_submitbtn').attr('disabled','disabled');
                    $('#ass_cancel').attr('disabled','disabled');	
                    $.confirm({'title': 'Alert','message': " <strong> Minimum area must be less than maximum "+"<strong></strong>",
                        'buttons': {'ok'	: {
                        'class'	: 'btn_center alert_ok',	
                        'action': function(){
                                $('#min_area').val(big);
    ...
    */
    // Min/Max year built
    /*$('body').on('change','#min_year_built, #max_year_built',function(e){

        var from_val = $("#min_year_built").val();
        var to_val = $("#max_year_built").val();
        ...
        if((lil > 0 && big != 0) || (lil != 0 && big > 0) || (lil > 0 && big > 0))
        {
            if (lil > big) {
                var targ = $(e.target);
                if (targ.is("#max_year_built")) {
                    //alert("Max must be greater than Min");
                    $('#ass_submitbtn').attr('disabled','disabled');
                    $('#ass_cancel').attr('disabled','disabled');
                    $.confirm({'title': 'Alert','message': " <strong> Maximum year built must be greater than minimum "+"<strong></strong>",
                        'buttons': {'ok'	: {
                        'class'	: 'btn_center alert_ok',	
                        'action': function(){
                                $('#max_year_built').val(lil);
                                $('#max_year_built').focus();
                                $('#ass_submitbtn').removeAttr('disabled');
                                $('#ass_cancel').removeAttr('disabled');
                        }},  }
                    });
                ...
                if (targ.is("#min_year_built")) {
                    //alert("Min must be less than Max");
                    $('#ass_submitbtn').attr('disabled','disabled');
                    $('#ass_cancel').attr('disabled','disabled');	
                    $.confirm({'title': 'Alert','message': " <strong> Minimum year built must be less than maximum "+"<strong></strong>",
                        'buttons': {'ok'	: {
                        'class'	: 'btn_center alert_ok',	
                        'action': function(){
                                $('#min_year_built').val(big);
                                $('#min_year_built').focus();
                                $('#ass_submitbtn').removeAttr('disabled');
                                $('#ass_cancel').removeAttr('disabled');
                        }},  }
                    });
    ...
    // Min/Max lotsize
    $('body').on('change','#min_lotsize, #max_lotsize',function(e){

        var from_val = $("#min_lotsize").val();
        var to_val = $("#max_lotsize").val();
        ...
        if((lil > 0 && big != 0) || (lil != 0 && big > 0) || (lil > 0 && big > 0))
        {
            if (lil > big) {
                var targ = $(e.target);
                if (targ.is("#max_lotsize")) {
                    //alert("Max must be greater than Min");
                    $('#ass_submitbtn').attr('disabled','disabled');
                    $('#ass_cancel').attr('disabled','disabled');
                    $.confirm({'title': 'Alert','message': " <strong> Maximum lot size must be greater than minimum "+"<strong></strong>",
                        'buttons': {'ok'	: {
                        'class'	: 'btn_center alert_ok',	
                        'action': function(){
                                $('#max_lotsize').val(lil);
                ...
                if (targ.is("#min_lotsize")) {
                    //alert("Min must be less than Max");
                    $('#ass_submitbtn').attr('disabled','disabled');
                    $('#ass_cancel').attr('disabled','disabled');	
                    $.confirm({'title': 'Alert','message': " <strong> Minimum lot size must be less than maximum "+"<strong></strong>",
                        'buttons': {'ok'	: {
                        'class'	: 'btn_center alert_ok',	
                        'action': function(){
                                $('#min_lotsize').val(big);
