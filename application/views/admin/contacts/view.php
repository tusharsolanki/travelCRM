    ...
    <div class="">
      ...
      <div class="col-sm-12">
        <ul class="nav nav-tabs" id="myTab1">
          <li <?php if($tabid == '' || $tabid == 1 || $tabid == 4 || $tabid == 5 || $tabid == 6 || $tabid == 7){?> class="active" <?php } ?>> <a title="Contact Information" onclick="load_view('1');" data-toggle="tab" href="#home">
            <?=$this->lang->line('contact_add_table_tab1_head');?>
            </a> </li>
          <?php if(!empty($editRecord[0]['id'])){ ?>
          <li <?php if($tabid == 2){?> class="active" <?php } ?>> <a title="Contact Photo and Documents" data-toggle="tab" onclick="load_view('2');" href="#profile">
            <?=$this->lang->line('contact_add_table_tab2_head');?>
            </a> </li>
          <li <?php if($tabid == 3){?> class="active" <?php } ?>> <a title="Extra Information" data-toggle="tab" onclick="load_view('3');" href="#profilenew">
			...
			{
		 ?>
          <li <?php if($tabid == 8){?> class="active" <?php } ?>> <a title="Buyer Preferences" data-toggle="tab" onclick="load_view('8');" href="#buyer_preference">
        ...
        <div class="tab-content" id="myTab1Content">
              ...
              <div class="delete_phone_trans_record<?=$rowtrans['id']?> padding-top-10 clear autooverflow">
                ...
                <div class="col-sm-4">
                 ...
                 <a href="#basicModal" class="text_size normal_a_css" id="basicModal" data-toggle="modal" onclick="add_sms_campaign('<?=$editRecord[0]['id']?>','<?=$rowtrans['id']?>')">
				  	<?php
                                        //echo $rowtrans['phone_no'];
                                        echo preg_replace('/([0-9]{3})([0-9]{3})([0-9]{4})/', '$1-$2-$3', $rowtrans['phone_no']);
                                        ?>
                  </a>
                  <?php
				  }
          ...
          <div class="add_emailtype autooverflow">
            ...
            <div class="col-lg-4 col-md-3 col-sm-3 col-xs-4">
              <label for="text-input" class="cont">
            ...
            <div class="socialnework">
				...
				{ ?>
				 ...
				 <?php }else{ ?> 
                 	 <li><i class="fa fa-facebook scl_btn btn-facebook"></i><a href="<?php echo $this->config->item('admin_base_url')?><?php echo $viewname;?>/edit_record/<?php echo $contact_id;?>">Add Facebook Profile Link</a></li>
                 <?php } } ?>
                  ...
                  <li><i class="fa fa-linkedin scl_btn btn-linkedin"></i><a href="<?php echo $this->config->item('admin_base_url')?><?php echo $viewname;?>/sendlinked_invitation/<?php echo $contact_id;?>">Invite <?php if(!empty($editRecord[0]['first_name'])){ echo ucfirst($editRecord[0]['first_name']); }else{ echo "-"; }?> to contact</a></li>
                  <?php } else{?>
                  <li><i class="fa fa-linkedin scl_btn btn-linkedin"></i><a href="<?php echo $this->config->item('admin_base_url')?><?php echo $viewname;?>/edit_record/<?php echo $contact_id;?>">Add Linkedin Profile Link</a></li>
                  <?php }?>
                  ...
                  <?php if($flag == 'twitter'){ ?>
                  	<?php foreach($profile_trans_data as $rowtrans){ 
						...
						?>
                  <?php }else{ ?>
                  <li><i class="fa fa-twitter scl_btn btn-twitter"></i><a href="<?php echo $this->config->item('admin_base_url')?><?php echo $viewname;?>/edit_record/<?php echo $contact_id;?>">Add Twitter Profile Link</a></li>
                  <?php } ?>
                </ul>
              </div>
            </div>
            ...
            <div class="add_website add_emailtype1">
              <div>
                <div class="row add_website_div">
                  ...
                  <?php } ?>
                  <?php }else { ?>
				  <div class="delete_website_trans_record<?= !empty($rowtrans['id']) && $rowtrans['id'] ?> padding-top-10 clear autooverflow">
                    <div class="col-sm-3">
                      <?php echo "-";?>
                    </div>
              ...
              <div>
                <div class="row add_social_profile_div">
                  ...
                  <?php } ?>
                  <?php } else {?>
				  <div class="delete_social_trans_record<?= !empty($rowtrans['id']) && $rowtrans['id'] ?> padding-top-10 clear autooverflow">
                    <div class="col-sm-3">
                      <?php echo "-"; ?>
        ...
        <div class="conversations_table">
         <table width="100%" class="table1 table-striped1 table-striped1 table-bordered1 table-hover1 table-highlight table table-striped table-bordered" id="DataTables_Table_0" aria-describedby="DataTables_Table_0_info">
                ...
                <?php  if(!empty($conversations)){
					...
					if(isset($conversations[$i]['personal_touch_type']))
					{?>
						<tr>
                          <td colspan="2">
                            <table width="100%" class="personaltouches" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                <td width="30%"><b><?php if(!empty($conversations[$i]['name'])){echo $conversations[$i]['name'];}; ?></b></td>
                                <td width="77%"><?php if(!empty($conversations[$i]['followup_date'])){ echo date($this->config->item('common_date_format'),strtotime($conversations[$i]['followup_date']));}?></td>
                              </tr>
                              <tr>
                              <td colspan="2"><?php if(!empty($conversations[$i]['created_by_admin'])){ echo "By : ".$conversations[$i]['created_by_admin'];}else{if(!empty($conversations[$i]['created_by_user'])){ echo "By : ".$conversations[$i]['created_by_user'];}else{echo "";}}?></td>
                                 ...
                                 <tr>
                                <td colspan="2"><?php if(!empty($conversations[$i]['task'])){ echo $conversations[$i]['task'];}?></td>
			...
			<?php	}
					elseif(isset($conversations[$i]['communication_type']))
					{?>
						<tr>
                        	<td width="75%">
                                <table width="100%" class="personaltouches" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    <td width="40%"><b><?php if(!empty($conversations[$i]['name'])){echo $conversations[$i]['name'];}; ?></b> (<?php if(!empty($conversations[$i]['task_date'])){ echo date($this->config->item('common_date_format'),strtotime($conversations[$i]['task_date']));}?>)</td>
                                    <td width="50%">Assigned To : <?php if(!empty($conversations[$i]['assign_name'])) { echo ucwords($conversations[$i]['assign_name']);}elseif(!empty($conversations[$i]['assign_name1'])) { echo ucwords($conversations[$i]['assign_name1']);}?></td>
                                  </tr>
                                  <tr>
                                    <td colspan="2">
                    <?php /*?><?=$conversations[$i]['assign_name']?$conversations[$i]['assign_name']:''?><?php */?>
                                        <?php if(!empty($conversations[$i]['interaction_plan_name'])){ 
										if(!empty($conversations[$i]['interaction_plan_id']))
										{
										?>
										<a class="normal_a_css" href="<?=$this->config->item('admin_base_url').'interaction_plans';?>/edit_record/<?=!empty($conversations[$i]['interaction_plan_id'])?$conversations[$i]['interaction_plan_id']:'';?>" title="View"><?= $conversations[$i]['interaction_plan_name']?></a>
										<?
										}else
										{
										echo $conversations[$i]['interaction_plan_name']; }}?>
                                    </td>
                                  </tr>
                                  <tr>
                                    <td colspan="2"><?php if(!empty($conversations[$i]['interaction_name'])){
										if(!empty($conversations[$i]['interaction_plan_interaction_id']))
										{
										?>
										<a class="normal_a_css" href="<?=$this->config->item('admin_base_url').'interaction';?>/view_record/<?=!empty($conversations[$i]['interaction_plan_interaction_id'])?$conversations[$i]['interaction_plan_interaction_id']:'';?>" title="View"><?= $conversations[$i]['interaction_name']?></a>
										<?
										}else
										{
										 echo $conversations[$i]['interaction_name'];} }?></td>
                                  </tr>
                                </table>
                              </td>
                              <td width="25%" valign="top">
                              	<span class="reload_class_<?php echo $conversations[$i]['id']; ?>"><?php if(!empty($conversations[$i]['is_done'])) { ?>
 <?php /*?><?=$interation_plan_communication_plan[$i]['completed_by_name']?$interation_plan_communication_plan[$i]['completed_by_name']:''?><?php */?> 
 Completed By:<br />
 <?php if(!empty($conversations[$i]['completed_by_name'])) { echo ucwords($conversations[$i]['completed_by_name']);}elseif(!empty($conversations[$i]['completed_by_name1'])) { echo ucwords($conversations[$i]['completed_by_name1']);}?>
                   <br/>
                   (<?=date($this->config->item('common_date_format'),strtotime($conversations[$i]['task_completed_date']))?>)
				   <?php } ?>
                              </td>
                        </tr>
			<?php	}
					elseif($conversations[$i]['status'] != '0' || $conversations[$i]['is_completed_task'] != '0')
					{
				 ...
				 <td width="80%">
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
						...
						<?php if(!empty($conversations[$i]['plan_name'])){ echo $conversations[$i]['plan_name'];}?> </td>
                      </tr>
                      <tr>
               ...
               <td width="20%" valign="middle" class="text-center">
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
						...
						<?php if(!empty($conversations[$i]['log_type']) && $conversations[$i]['log_type']=='6'){
                            ...
                            if(!empty($conversations[$i]['ecr_id']))
							{ ?>
							
								<a class="normal_a_css" href="<?=$this->config->item('admin_base_url').'emails';?>/view_data/<?=!empty($conversations[$i]['campaign_id'])?$conversations[$i]['campaign_id']:'';?>/<?=!empty($conversations[$i]['ecr_id'])?$conversations[$i]['ecr_id']:'';?>" title="View">Email Sent From  Campaign </a>
							<? } else {?>
                            <?
						...
						<?php if(!empty($conversations[$i]['log_type']) && $conversations[$i]['log_type']=='8'){
							if(!empty($conversations[$i]['scr_id']))
							{
							?>
							<a class="normal_a_css" href="<?=$this->config->item('admin_base_url').'sms';?>/view_data/<?=!empty($conversations[$i]['campaign_id'])?$conversations[$i]['campaign_id']:'';?>/<?=!empty($conversations[$i]['scr_id'])?$conversations[$i]['scr_id']:'';?>" title="View"> SMS Sent From Campaign </a>
							<?
							}else
							{
        ...
        <ul class="nav nav-tabs" id="myTab2">
          <!--<li <?php if($tabid == '' || $tabid == 1 || $tabid == 2 || $tabid == 3 || $tabid == 4){?> class="active" <?php } ?>> <a title="Conversations" data-toggle="tab" href="#conversations">
            ...
            <?php if(!empty($this->modules_unique_name) && in_array('communications',$this->modules_unique_name)){}else{$tabid=5;}?>
            <?php /*if(!empty($this->modules_unique_name) && in_array('communications',$this->modules_unique_name)){?>
            <li <?php if($tabid == '' || $tabid == 1 || $tabid == 2 || $tabid == 3 || $tabid == 4 || $tabid == 6){?> class="active" <?php } ?>> <a title="Communication" data-toggle="tab" href="#communication_plan">
        ...
        <div class="tab-content" id="myTab2Content">
                    ...
                    <table width="100%" class="personaltouches" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        ...
                        <td width="77%"><?php if(!empty($personale_touches[$i]['followup_date'])){ echo date($this->config->item('common_date_format'),strtotime($personale_touches[$i]['followup_date']));}?></td>
					     ...
					     <tr>
                        <td colspan="2"><?php if(!empty($personale_touches[$i]['task'])){ echo $personale_touches[$i]['task'];}?></td>
          ...
          <?php if(!empty($this->modules_unique_name) && in_array('communications',$this->modules_unique_name)){?>
          <div <?php /*if($tabid == '' || $tabid == 1 || $tabid == 2 || $tabid == 3 || $tabid == 4 || $tabid == 6){?> class="row tab-pane fade in active" <?php }else{ ?> class="row tab-pane fade in" <?php }*/  ?> class="row tab-pane fade in" id="communication_plan" >
            <div class="col-lg-12">
             <div class="table-responsive">
            <div class="table-in-responsive">
              <table width="100%" class="table1 table-striped1 table-striped1 table-bordered1 table-hover1 table-highlight table table-striped table-bordered  " id="DataTables_Table_0" aria-describedby="DataTables_Table_0_info">
                ...
                <tr>
                  <td width="50%">
                    <table width="100%" class="personaltouches" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td width="40%"><b><?php if(!empty($interation_plan_communication_plan[$i]['name'])){echo $interation_plan_communication_plan[$i]['name'];}; ?></b> (<?php if(!empty($interation_plan_communication_plan[$i]['task_date'])){ echo date($this->config->item('common_date_format'),strtotime($interation_plan_communication_plan[$i]['task_date']));}?>)</td>
                        <td width="50%">Assigned To : <?php if(!empty($interation_plan_communication_plan[$i]['assign_name'])) { echo ucwords($interation_plan_communication_plan[$i]['assign_name']);}elseif(!empty($interation_plan_communication_plan[$i]['assign_name1'])) { echo ucwords($interation_plan_communication_plan[$i]['assign_name1']);}?></td>
                      </tr>
                      <tr>
                        <td colspan="2">
		<?php /*?><?=$interation_plan_communication_plan[$i]['assign_name']?$interation_plan_communication_plan[$i]['assign_name']:''?><?php */?>
                            ...
                            {
                            ?>
                            <a class="normal_a_css" href="<?=$this->config->item('admin_base_url').'interaction_plans';?>/edit_record/<?=!empty($interation_plan_communication_plan[$i]['interaction_plan_id'])?$interation_plan_communication_plan[$i]['interaction_plan_id']:'';?>" title="View"><?= $interation_plan_communication_plan[$i]['interaction_plan_name']?></a>
                            <?
                            }else
                            {
              ...
              {
              ?>
              <a class="normal_a_css" href="<?=$this->config->item('admin_base_url').'interaction';?>/view_record/<?=!empty($interation_plan_communication_plan[$i]['interaction_plan_interaction_id'])?$interation_plan_communication_plan[$i]['interaction_plan_interaction_id']:'';?>" title="View"><?= $interation_plan_communication_plan[$i]['interaction_name']?></a>
              <?
              }else
              {
               echo $interation_plan_communication_plan[$i]['interaction_name'];} }?>
                  ...
                  <td width="10%" align="center" valign="middle" class="">
              ...
              <div class="table-responsive">
                <div class="table-in-responsive">
                   ...
                   <div id="common_div_vc">
                    <?=$this->load->view('admin/'.$viewname.'/view_valuation_contact')?>
                   </div>
                   <!-- table code end-->
                </div>
              </div>
              ...
              <div class="table-responsive">
                <div class="table-in-responsive">
                   ...
                   <div id="common_div_pc">
                    <?=$this->load->view('admin/'.$viewname.'/view_property_contact')?>
                   </div>
                   <!-- table code end-->
                </div>
              </div>
      ...
      <div <?php  if($tabid == 7){?> class="row tab-pane fade in active" <?php }else{ ?> class="row tab-pane fade in" <?php } ?> id="social_media">
       ...
       <?php 
         ...
         <div <?php if($tabid == 10){?> class="row tab-pane fade in active" <?php }else{ ?> class="row tab-pane fade in" <?php } ?> id="propertyinformation">
            ...
            <div id="common_div6">
             <?=$this->load->view('admin/'.$viewname.'/property_list');?>
          </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <input id="contact_id" name="contact_id" type="hidden" value="<?php echo $contact_id; ?>">
        <button type="submit" id="activitylog" class="btn btn-secondary" onclick="this.form.submit(); this.disabled=true;">Add Conversation Log</button>
...
<div aria-hidden="true" style="display: none;" id="basicModal_2" class="modal fade">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="col-sm-12 text-center mrgb4">
        <input type="submit" value="Add Personal Touches" class="btn btn-secondary" title="Add Personal Touches" onclick="this.form.submit(); this.disabled=true;">
       ...
       <div class="col-sm-12">
        <div class="tab-content" id="myTab1Content">
         ...
         <div class="row tab-pane fade in active" id="home">
          ...
          <form class="form parsley-form" enctype="multipart/form-data" name="twitter_form" id="twitter_form" method="post" data-validate="parsley" accept-charset="utf-8" action="<?php echo $this->config->item('admin_base_url').$viewname.'/send_twitter_message'?>" novalidate>
       ...
       <div class="col-sm-12">
        <div class="tab-content" id="myTab1Content">
         ...
         <div class="row tab-pane fade in active" id="home">
          ...
          <form class="form parsley-form" enctype="multipart/form-data" name="linkedin_form" id="linkedin_form" method="post" data-validate="parsley" accept-charset="utf-8" action="<?php echo $this->config->item('admin_base_url').$viewname.'/sendlinked_message'?>" novalidate>
		  <input id="id" name="id" type="hidden" value="<?php if(!empty($editRecord[0]['id'])){ echo $editRecord[0]['id']; }?>">
...
<script>
	...
	function is_done(id,is_done_hidd,interaction_type)
	{
		...
		try
		{
		   ...
		   'action': function(){
			...
			$.ajax({
				...
				dataType: 'json',
				async: false,
				data: {'id':id,'is_done_hidd':is_done_hidd,interaction_type:interaction_type},
		...
		if(response.authResponse)
		{
				var contact = "<?php echo $this->router->uri->segments[4] ?>"; 
				 ...
				 $.ajax({
					...
					{
						$.confirm({'title': 'Alert','message': " <strong> This contact is not tour friend "+"<strong></strong>",'buttons': {'ok'	: {'class'	: 'btn_center alert_ok'}}});
...
function contact_search5(allflag)
{
    ...
    $.ajax({
        type: "POST",
        url: "<?php echo base_url();?>admin/contacts/view_record_index_valuation_searched/"+id,
        data: {
...
function contact_search6(allflag6)
	{
		...
		$.ajax({
			type: "POST",
			url: "<?php echo base_url();?>admin/<?=$viewname?>/property_listing/"+uri_segment6,
			data: {
...
<script>
    $('body').on('click','.valuation_contact_popup_btn',function(e){
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo $this->config->item('admin_base_url').$viewname.'/valuation_contact_popup';?>",
            data: {'search_id':search_id},
            success: function(html){
    ...
    function contact_search110(allflag)
    {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url();?>admin/contacts/view_record_index_valuation_contact/"+id,
            data: {
...
<script>
    ...
    function contact_search111(allflag)
    {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url();?>admin/contacts/view_record_index_property_contact/"+id,
            data: {
