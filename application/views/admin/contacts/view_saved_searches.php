  ...
  <table class="table table-striped table-bordered table-hover table-highlight table-checkable dataTable-helper dataTable datatable-columnfilter" id="DataTables_Table_0" aria-describedby="DataTables_Table_0_info">
							...
							<?=!empty($rss['name'])?$rss['name']:'';?></a>
                                                ...
                                                <td class="hidden-xs hidden-sm text-center">
                                                    ...
                                                    <a class="btn btn-xs btn-success" title="Edit Saved Searches" href="<?= $this->config->item('admin_base_url').$viewname; ?>/edit_saved_searches/<?= $rss['id'] ?>"><i class="fa fa-pencil"></i></a> &nbsp; 
                                                </td>
                                              </tr>
                              <?php } } else {?>
                              <tr>
          ...
          <div class="col-sm-6">
           <div class="dataTables_paginate paging_bootstrap float-right">
            ...
            <label>
             ...
             <option <?php if(empty($perpage1)){ echo 'selected="selected"';}?> value="0"><?=$this->lang->line('label_saved_searches_per_page')?></option>
