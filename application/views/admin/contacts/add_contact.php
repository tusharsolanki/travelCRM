       ...
       <div class="table-responsive">
        <div role="grid" class="dataTables_wrapper" id="DataTables_Table_0_wrapper">
         <div id="common_div">
			...
			<form class="form parsley-form" enctype="multipart/form-data" name="<?php echo $viewname;?>" id="<?php echo $viewname;?>" method="post" accept-charset="utf-8" action="<?php echo $this->config->item('admin_base_url').$viewname.'/insert_contact';?>" data-validate="parsley" >
			<div class="col-sm-12">
            	<div class="row">
			...
			<div class="col-sm-12">
            	<div class="row">
					...
					<div class="col-sm-4 form-group">
					<select class="form-control parsley-validated" name="slt_default_email" id="slt_default_email">
				   <option value="">Please Select Field</option>
				   <?php foreach($dropdown_data as $row){ ?>
				   <option value="<?php echo $row['id'];?>"><?php echo $row['field'];?></option>
				   <?php }?>
			...
			<div class="col-sm-12">
            	<div class="row">
					...
					<div class="col-sm-4 form-group">
					<select class="form-control parsley-validated" name="slt_default_phone" id="slt_default_phone">
				   <option value="">Please Select Field</option>
				   <?php foreach($dropdown_data as $row){ ?>
				   <option value="<?php echo $row['id'];?>"><?php echo $row['field'];?></option>
				   <?php }?>
			...
			<div class="col-sm-12">
            	<div class="row">
					...
					<input type="submit" class="btn btn-secondary-green" value="Import Contacts"  title="Import Contacts" id="save" name="submitbtn" />
