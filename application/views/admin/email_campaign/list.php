    ...
    <div class="col-md-12">
     <div class="portlet">
      <div class="portlet-header">
       <h3> <i class="fa fa-table"></i><?=$this->lang->line('template_list_head');?></h3>
      </div>
      <!-- /.portlet-header -->
      ...
      <div class="portlet-content">
       <div class="table_large-responsive">
        <div role="grid" class="dataTables_wrapper" id="DataTables_Table_0_wrapper">
         ...
         <div class="row dt-rt">
          <div class="col-sm-6">
           <button class="btn btn-danger howler" data-type="danger" onclick="deletepopup1('0');">Delete Template</button>
          </div>
          <div class="col-sm-6">
          <a class="btn  pull-right btn-success howler" href="<?=base_url('admin/'.$viewname.'/add_record');?>">Add Template</a>
          </div>
         </div>
         <div id="common_div">
...
<script>
	...
	function contact_search()
	{
		$.ajax({
			type: "POST",
			url: "<?php echo base_url();?>admin/phonecall_script/",
			data: {
