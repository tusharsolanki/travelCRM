...
?>
<input type="hidden" id="hidden_date" name="hidden_date"  value="<?php if(!empty($now_date)){ echo date('l M d, Y',strtotime($now_date));} ?>" />
<div class="row">
    <div class="col-md-12">
    <div class="row">
    
    <div class="col-lg-6 col-md-4 col-sm-12 col-xs-12">
    <div class="deshboard_main"><h3><span><?=!empty($time_message)?$time_message.' '.$this->admin_session['name'].'!':''?></span></h3></div>
    </div>
     ...
     <div class="col-sm-2">
	  ...
	  ?>
			...
			<a href="#basicModal" class="text_size howler" id="basicModal" data-toggle="modal"><img class="img-responsive" src="<?=$this->config->item('admin_upload_img_small')?>/<?=(!empty($prifile_pic[0]['admin_pic'])?$prifile_pic[0]['admin_pic']:'');?>"/></a>
		<? } else {?>
        ...
        <div class="row">
          ...
          <div class="col-md-2 col-sm-4 ">
              <div class="new_listings"><p>New Contacts</p>
                 <form class="form parsley-form" enctype="multipart/form-data" name="<?php echo $viewname;?>" id="<?php echo $viewname;?>" method="post" accept-charset="utf-8" action="<?php echo $this->config->item('admin_base_url')?>contacts">
                  <h1>
          ...
          <div class="col-md-2 col-sm-4 ">
              <div class="new_listings"><p>Live Wire Leads</p>
                 <form class="form parsley-form" enctype="multipart/form-data" name="<?php echo $viewname;?>2" id="<?php echo $viewname;?>2" method="post" accept-charset="utf-8" action="<?php echo $this->config->item('admin_base_url')?>leads_dashboard">
                  <h1>
          ...
          <div class="col-md-2 col-sm-4 ">
              <div class="new_listings"><p>Form Received</p>
                 <form class="form parsley-form" enctype="multipart/form-data" name="<?php echo $viewname;?>3" id="<?php echo $viewname;?>3" method="post" accept-charset="utf-8" action="<?php echo $this->config->item('admin_base_url')?>dashboard/form_lead_list">
                  <h1>
          ...
          <div class="col-md-2 col-sm-4 ">
              <div class="new_listings"><p>Manual Leads</p>
                 <form class="form parsley-form" enctype="multipart/form-data" name="<?php echo $viewname;?>1" id="<?php echo $viewname;?>1" method="post" accept-charset="utf-8" action="<?php echo $this->config->item('admin_base_url')?>contacts">
                  <h1>
          ...
          <form class="form parsley-form" enctype="multipart/form-data" name="<?php echo $viewname;?>4" id="<?php echo $viewname.'4';?>" method="post" accept-charset="utf-8" action="<?php echo $this->config->item('admin_base_url')?>listing_manager">
          <h1>
...
<?php */ ?>
      ...
      <h1>0</h1></div>
       ...
       <div class="col-sm-3 mein_box_center">
      <div class="new_listings"><p>New Leads</p>
       <form class="form parsley-form" enctype="multipart/form-data" name="<?php echo $viewname;?>" id="<?php echo $viewname;?>" method="post" accept-charset="utf-8" action="<?php echo $this->config->item('admin_base_url')?>contacts">
      <h1>
      <input type="hidden" name="new_contact" id="new_contact" value="<?php echo date('m/d/Y')?>"  />
      <b><a href="#" onclick="return form_submit();"><?=!empty($contact_count)?$contact_count:0?></a></b>
      </h1></form></div>
       </div>
        <div class="col-sm-4">
       <div class="new_listings"><p>New Expired / Cancelled</p>
    ...
    <div class="row">
       ...
       <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="Daily_box_mian_te">
           <p>  Mailings </p>
            <h2><a href="<?php echo $this->config->item('admin_base_url').$viewname.'/letter_label_envelope_task'; ?>" ><?=$task_lel_count?>/<span><?=$task_lel_overdue_count?></span></a></h2>
      </div>
      </div>
       ...
       <? if(in_array('communications',$this->modules_unique_name)){ ?>
        ...
        <div class="Daily_box_mian_te">
           <p>  Calls </p>
            <h2><a href="<?php echo $this->config->item('admin_base_url').$viewname.'/telephone_task';?>" ><?=$call_count?>/<span><?=$call_overdue_count?></span> </a><span></span></h2>
      </div>
      </div>
         ...
         <? if(in_array('communications',$this->modules_unique_name)){ ?>
          ...
          <div class="Daily_box_mian_bottom_te">
           <p>  Text </p>
            <h2><a href="<?php echo $this->config->item('admin_base_url').$viewname.'/sms_task';?>" ><?=$sms_count?>/<span><?=$sms_overdue_count?></span></a></h2>
      </div>
      ...
      <? } ?>
       ...
       <!-- <div class="Daily_box_Social_img"></div>-->
           ...
           <div class="Daily_box_mian_bottom_te">
           <p>  Tasks </p>
            <h2><a href="<?php echo $this->config->item('admin_base_url').$viewname.'/daily_task'; ?> " ><?=$task_count?>/<span><?=$task_overdue_count?></span></a></h2>
      </div>
      ...
      <!--  <div class="Daily_box_mian_Schedule_img"></div>-->
           ...
           <div class="Daily_box_mian_bottom_te">
           <p>  Emails </p>
            <h2><a href="<?php echo $this->config->item('admin_base_url').$viewname.'/email_task'; ?> " ><?=$email_count?>/<span><?=$email_overdue_count?></span></a></h2>
      </div>
    ...
    <div class="Daily_box">
      ...
      <p> All Actions </p>
      <h2><a href="<?php echo $this->config->item('admin_base_url').$viewname.'/to_do_task';?>" ><?=$to_do_task_count+$call_count+$sms_count+$task_count+$email_count+$task_lel_count?>/<span><?=$to_do_task_overdue_count+$call_overdue_count+$sms_overdue_count+$task_overdue_count+$email_overdue_count+$task_lel_overdue_count?></span></a></h2>
      </div>
