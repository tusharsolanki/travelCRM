      ...
      <div class="portlet-content">
       <div class="table_large-responsive">
        <div role="grid" class="dataTables_wrapper" id="DataTables_Table_0_wrapper">
         ...
         <div id="common_div">
         <?=$this->load->view('admin/home/sms_ajax_list')?>
         </div>
        </div>
       </div>
       <!-- /.table-responsive --> 
	...
	$.ajax({
			...
			success: function(result){
				...
				$.ajax({
					...
					data: {
					result_type:'ajax',searchreport:$("#searchreport").val(),perpage:$("#perpage").val(),searchtext:$("#searchtext").val(),sortfield:$("#sortfield_3").val(),sortby:$("#sortby_3").val()
				},
				beforeSend: function() {
							$('#common_div').block({ message: 'Loading...' }); 
						  },
