...
<table class="table table-striped table-bordered table-hover table-highlight table-checkable dataTable-helper dataTable datatable-columnfilter" id="DataTables_Table_0" aria-describedby="DataTables_Table_0_info">
          <thead>
           ...
           <?php if(!empty($telephone_datalist) && count($telephone_datalist)>0){
					$i=!empty($this->router->uri->segments[4])?$this->router->uri->segments[4]+1:1;
                      foreach($telephone_datalist as $row){?>
									...
									if(!empty($row['calling_script']))
									{
										...
										{?>
                                            ...
                                            <!--<div class="div_dash_more_data div_dash_display_none">
                                            	<?php echo ucfirst(strtolower($row['calling_script']));?>
         ...
         <div class="row dt-rb common_tb" id="common_tb">
          ...
          <div class="col-sm-6">
			...
			if(isset($telephone_pagination))
			{
				echo $telephone_pagination;
			}
		  	?>
           </div>
         </div>
...
'action': function(){
	$.ajax({
			...
			data: {
			selectedvalue:id,disposition:value,interaction_type:'call'
		},
		beforeSend: function() {
