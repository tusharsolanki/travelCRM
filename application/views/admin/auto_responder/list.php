<?php 
    /*
        @Description: Admin auto_responder list
    ...
    <div class="col-md-12">
     <div class="portlet">
      <div class="portlet-header">
       <h3> <i class="fa fa-table"></i><?=$this->lang->line('autoresponder_list_head');?></h3>
      ...
      <div class="portlet-content">
       <ul class="nav nav-tabs" id="myTab1">
                <li <?php if($tabid == '' || $tabid == 1){?> class="active" <?php } ?> > <a title="Email Library" data-toggle="tab" href="#my_library" onclick="load_view('my_library');"><?=$this->lang->line('autoresponder_list_head');?></a> </li>
                <li <?php if($tabid == 2){?> class="active" <?php } ?>> <a title="Email Library" data-toggle="tab" href="#default_library" onclick="load_view('default_library');"> Default <?=$this->lang->line('autoresponder_list_head');?></a> </li>
            </ul>
        ...
        <div role="grid" class="dataTables_wrapper" id="DataTables_Table_0_wrapper">
         ...
         <div class="row dt-rt">
          ...
          <a class="btn  pull-right btn-secondary-green howler" href="<?=base_url('admin/'.$viewname.'/add_record');?>" title="Add Template">Add Auto Responder</a>
          <? } ?>
          </div>
         </div>
...
<script>
	...
	function contact_search(allflag)
	{
		...
		$.ajax({
			type: "POST",
			url: "<?php echo base_url();?>admin/auto_responder/"+uri_segment,
			data: {
	...
	function delete_all(id)
		{
			...
			success: function(data){
				...
				$.ajax({
					type: "POST",
					url: "<?php echo base_url();?>admin/auto_responder/"+data,
					data: {
