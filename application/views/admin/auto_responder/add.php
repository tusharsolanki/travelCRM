...
<input type="submit" class="btn btn-secondary-green" title="Save Template" value="Save Auto Responder" onclick="return setdefaultdata();" name="submitbtn" id="ar_submitbtn" />
 <a class="btn btn-primary" title="Cancel" href="javascript:history.go(-1);" id="ar_cancel">Cancel</a>
         </div>
			...
			return false;
                ...
                else
                {
                    if ($('#<?php echo $viewname?>').parsley().isValid()) {
                        ...
                        /*$('#ar_submitbtn').attr('disabled','disabled');
                        $('#ar_cancel').attr('disabled','disabled');*/
                    }
                }
	 }
