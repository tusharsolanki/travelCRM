						...
						<tr  <? if($i%2==1){ ?>class="bgtitle" <? }?> > 
							...
							<td class="hidden-xs hidden-sm" id="temp_subject_<?php echo  $row['id'] ?>"><?=!empty($temptitleOutput)?ucfirst(strtolower($temptitleOutput)):'';?>
                              ...
                              <td class="hidden-xs hidden-sm "  id="temp_event_<?php echo  $row['id'] ?>"><?=!empty($row['email_event_name'])?ucfirst(strtolower($row['email_event_name'])):'';?></td>
                                 ...
                                 <?
								// echo $row['parent_superadmin_publish_date'] .'>'. $row['superadmin_publish_date'];
                             ...
                             <? if(in_array('auto_responder_edit',$this->modules_unique_name) || in_array('auto_responder_delete',$this->modules_unique_name)){ ?>
							<td class="hidden-xs hidden-sm">
							 <?php if(!empty($this->modules_unique_name) && in_array('auto_responder_edit',$this->modules_unique_name)){?> 
