            ...
            <div class="col-md-12">
                <div class="portlet">
					...
					$this->session->set_userdata('message_session', $newdata);?> </div>
                                ...
                                <div id="common_div">
                                    <?=$this->load->view('admin/lead_capturing/form_lead_ajax_list')?>
                                </div>
                            </div>
                        </div>
                        <!-- /.table-responsive --> 
...
<script>
    ...
    function contact_search(allflag)
    {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url();?>admin/lead_capturing/<?=$viewname?>/"+uri_segment,
            data: {
	...
	$.ajax({
            type: "POST",
            url:"<?php echo $this->config->item('admin_base_url').'lead_capturing_view/contact_details';?>",
            data:{lead_id:id},
            beforeSend: function() {
