...
<div id="content">
   ...
   <div class="">
    <div class="col-md-12">
     <div class="portlet">
      <div class="portlet-header">
       <h3> <i class="fa fa-table"></i>Calendar - My Appointment</h3>
      </div>
      <!-- /.portlet-header -->
          <div class="table_large-responsive_cale">
    ...
    $(document).ready(function() {
      ...
      function Edit(data)
      {
		  var type=$('#type').val();
		  var acc=$('#acc').val();
        /*var eurl="<?=$this->config->item('wdcalendar')?>edit.php?agentid=<?=$agentid?>&agentname=<?=$agentname?>&id={0}&start={2}&end={3}&isallday={4}&title={1}";*/
    ...
    <div id="calhead" style="padding-left:1px;padding-right:1px;"> 
      ...
      <div id="caltoolbar" class="ctoolbar">
		...
		<div id="showreflashbtn" class="fbutton pull-right">
        	<div><a class="google_calendar" href="<?=base_url('admin/calendar/google_login')?>">Login With G+</a></div>
        </div>
        ...
        <div class="fshowdatep fbutton">
          <div>
              ...
              <input type="hidden" name="todaydate" id="todaydate" value="<?=date('d/m/Y')?>" />
  ...
  <script type="text/javascript">
		...
		$(".google_calendar").colorbox({iframe:true, innerWidth:'50%', innerHeight:'40%',
	onClosed:function(){
		window.location='<?=base_url('admin/calendar')?>';
		}
	});		
		});  
</script>
