        ...
        <div class="tab-content" id="myTab1Content"> 
              ...
              <div class="row dt-rt">
               ...
               <div class="col-sm-8 col-xs-6 col-lg-6">
					  ...
					  <a title="Add Communication" class="btn  pull-right btn-secondary-green howler " href="<?=base_url('admin/'.$viewname.'/add_record');?>">New Mail Blast</a>
                      <? } ?>
	...
	function delete_all(id)
		{
			...
			success: function(data){
				...
				$.ajax({
					type: "POST",
					url: "<?php echo base_url();?>admin/mail_out/"+data,
					data: {
