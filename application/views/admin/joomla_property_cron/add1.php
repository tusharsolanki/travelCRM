                            ...
                            <div class="tab-content" id="myTab1Content">
                                <div class="row tab-pane fade in active" id="home">
                                    <form class="form parsley-form" data-validate="parsley" enctype="multipart/form-data" name="<?php echo $viewname;?>" id="<?php echo $viewname;?>" method="post" accept-charset="utf-8" action="<?php echo $this->config->item('admin_base_url')?><?php echo $path?>" novalidate >
                                        ...
                                        <input id="property_id" name="property_id" type="hidden" value="<?php if(!empty($editRecord[0]['property_id'])){ echo $editRecord[0]['property_id']; }?>">
                                        <input id="data_from" name="data_from" type="hidden" value="2">
                                        <div class="col-sm-8">
                                            <div class="row">
                                            ...
                                            <div class='row'>
                                                ...
                                                <script type="text/javascript">
                                                    var common = 0;
                                                    /*$("#city").autocomplete({
                                                        source:'<?php echo $this->config->item('admin_base_url').$viewname.'/getstatelist1';?>',
                                                    ...
                                                    $(document).ready(function() {
                                                        ...
                                                        $("#city").tokenInput('<?php echo $this->config->item('admin_base_url').$viewname.'/getstatelist1';?>',
                                                        {
                                                            prePopulate:[
                                                                    <?php 
                                            ...
                                            <div class='row'>
                                                ...
                                                <script type="text/javascript">
                                                    ...
                                                    $(document).ready(function() {
                                                        ...
                                                        $("#neighborhood").tokenInput('<?php echo $this->config->item('admin_base_url').$viewname.'/getneighborlist1';?>',
                                                        {
                                                            onAdd: function (item) {
                                                                $('#property_id').val(item.property_id);
                                                            },
                                                            prePopulate:[
                                                                <?php 
                                                                if(!empty($editRecord[0]['neighborhood'])){ ?>
                                                                        {id: "<?=$editRecord[0]['neighborhood']?>", name: "<?=$editRecord[0]['neighborhood']?>", property_id: "<?=$editRecord[0]['property_id']?>"},
                                                                <?php } ?>
                                                            ],
                                                            preventDuplicates: true,
                                            ...
                                            <div class='row'>
                                                ...
                                                <script type="text/javascript">
                                                    var common = 0;
                                                    $(document).ready(function() {
                                                        $("#zip_code").tokenInput('<?php echo $this->config->item('admin_base_url').$viewname.'/getzipcodelist1';?>',
                                                        {
                                                            prePopulate:[
                                                                <?php 
        ...
        function checkcontactcount()
	{
            ...
            if(popupcontactlist == '')
            {
                ...
                if ($('#<?php echo $viewname?>').parsley().isValid()) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<?php echo $this->config->item('admin_base_url').$viewname.'/check_address1';?>",
