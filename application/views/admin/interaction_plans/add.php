                ...
                <form class="form parsley-form" enctype="multipart/form-data" name="<?php echo $viewname;?>" id="<?php echo $viewname;?>" method="post" accept-charset="utf-8" action="<?php echo $this->config->item('admin_base_url')?><?php echo $path?>" data-validate="parsley" novalidate >
                  <div class="row dt-rb form">
					...
					<div class="row">
                        ...
                        <legend class="edit_title">Run Communication Plan</legend><div class="cf"></div>
                        <div class="col-lg-4">
                       <div class="edit_btn">
							...
							<?php }else{?>
								<a href="javascript:void(0);"  class="btn btn-xs btn-secondary-new stop_interaction_plan" data-id="<?=$editRecord[0]['id']?>" title="Reset"> <i class="fa fa-stop"></i></a>
							<?php } ?>
					   </div>
                        </div>
                             <div class="col-lg-8">
				...
				<?php } ?>
                      ...
                      <div class="row">
                        <div class="col-xs-12 mrgb2 form-group">
                          ...
                          <input type="text" id="txt_plan_name" name="txt_plan_name" class="form-control parsley-validated" value="<?php if(!empty($editRecord[0]['plan_name'])){ echo htmlentities($editRecord[0]['plan_name']); }?>" placeholder="e.g. Communication Name" data-required="true">
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-xs-12 mrgb2">
                          ...
                          :</label>
                          <textarea placeholder="e.g. Description" id="txtarea_description" name="txtarea_description" class="form-control parsley-validated"><?php if(!empty($editRecord[0]['description'])){ echo htmlentities($editRecord[0]['description']); }?>
</textarea>
                        </div>
                      </div>
                      <div class="row" <?php if(empty($editRecord)){ echo "style='display:none;'";}?> >
                        <div class="col-xs-12 mrgb2">
                          ...
                          :</label>
                          <input id="txt_interaction_status" name="txt_interaction_status" class="form-control parsley-validated" type="text" readonly value="<?php if(!empty($editRecord[0]['plan_status_name'])){ echo htmlentities($editRecord[0]['plan_status_name']);}else{if(!empty($interaction_plan_status[0]['name'])){ echo htmlentities($interaction_plan_status[0]['name']); }}?>">
                      ...
                      <div class="row">
                        <div class="col-xs-12 mrgb2">
                          ...
                          :</label>
                          <textarea placeholder="e.g. Target Audience" id="txtarea_target_audience" name="txtarea_target_audience" class="form-control parsley-validated"><?php if(!empty($editRecord[0]['target_audience'])){ echo htmlentities($editRecord[0]['target_audience']); }?>
</textarea>
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-xs-12 mrgb2 icheck-input-new">
                          ...
                          <div class="form-group">
                            ...
                            <div class="">
                              <label class="">
                              <div>
                                <input type="radio" data-required="true" class="fleft" id="" name="plan_start_date" value="1" <?php if(!empty($editRecord[0]['plan_start_type']) && $editRecord[0]['plan_start_type'] == '1'){ echo 'checked="checked"'; }?> checked="checked" onclick="hide_start_date(this.value);">
                            ...
                            <div class="">
                              ...
                              <div class="col-xs-12 txt_plan_start_date" style="display:none;" >
                                <input id="txt_start_date" name="txt_start_date" class="form-control parsley-validated" type="text" 
								 ...
								 value="<?php if(!empty($editRecord[0]['start_date']) && $editRecord[0]['start_date'] != '0000-00-00' && $editRecord[0]['start_date'] != '1970-01-01'){ echo date($this->config->item('common_date_format'),strtotime($editRecord[0]['start_date'])); }?>" readonly="readonly" placeholder="Specific Date"  >
                              </div>
                            </div>
                            <!--</div>-->
                    ...
                    <div class="col-sm-5">
                      ...
                      <div class="col-sm-12 added_contacts_list">
						...
						<?php $this->load->view('admin/interaction_plans/selected_contact_ajax')?>
                  ...
                  <div class="col-sm-12 text-center margin-top-10">
                    ...
                    <input type="submit" class="btn btn-secondary-green" value="Save & Add Action" name="submitbtn_action" onclick="return checkcontactcount();" />
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="col-sm-12 add_new_contact_popup">
          <div class="">
		  <?php $this->load->view('admin/interaction_plans/add_contact_popup_ajax');?>
		  </div>
        </div>
      </div>
...
$(document).ready(function(){
	...
	$('body').on('click','.remove_selected_contact',function(e){
		...
		'action': function(){
			...
			$.ajax({
				type: "POST",
				url: "<?php echo $this->config->item('admin_base_url').$viewname.'/delete_contact_from_plan';?>",
