         ...
         <div class="row dt-rt">
          <div class="col-sm-6">
           <button class="btn btn-danger howler" data-type="danger" onclick="active_plan('0');" title="Un-Archive">Un-Archive</button>
              ...
              <div class="col-sm-6">
                <a class="btn  pull-right btn-success howler" href="<?=base_url('admin/'.$viewname);?>" title="Back to List">Back to List</a>
              </div>
         </div>
         <div id="common_div">
         <?=$this->load->view('admin/'.$viewname.'/ajax_list_archive')?>
                ...
                <div role="grid" class="dataTables_wrapper" id="DataTables_Table_0_wrapper">
                        ...
                        <div class="col-sm-12">
                            <div class="dataTables_filter" id="DataTables_Table_0_filter">
                                <label>
                                    ...
                                    <button class="btn btn-success howler" data-type="danger" onclick="contact_search1('changesearch');" title="Search">Search</button>
                                    <button class="btn btn-success howler" data-type="danger" onclick="clearfilter_contact1();" title="View All" title="View All">View All</button>
                                </label>
                            </div>
                        </div>
                    </div>
                    <div class="row dt-rt">
                        <div class="col-sm-6 col-xs-6">
                            <button class="btn btn-danger howler" data-type="danger" onclick="active_plan1('0');" title="Un-Archive">Un-Archive</button>
                        </div>
                        <div class="col-sm-6 col-xs-6">
                           <!-- <a title="Add Communication" class="btn  pull-right btn-success howler margin-left-5px" href="<?=base_url('admin/'.$viewname.'/add_record');?>">Add Communication</a>-->
                            <a title="View Archive" class="btn  pull-right btn-success howler" href="<?=base_url('admin/'.$viewname);?>">Back to List</a>
                        </div>
                    </div>
                    <div id="premium_common_div" class="table_large-responsive">
                        <?=$this->load->view('admin/'.$viewname.'/ajax_list_premium_archive')?>
                    </div>
                </div>
           ...
           <div <?php if($tabid == '3'){ ?> class="tab-pane fade in active" <?php } else {?> class="tab-pane fade in" <?php } ?> id="default_plan">
                <div role="grid" class="dataTables_wrapper" id="DataTables_Table_0_wrapper">
                        ...
                        <div class="col-sm-12">
                            <div class="dataTables_filter" id="DataTables_Table_0_filter">
                                <label>
                                    ...
                                    <button class="btn btn-success howler" data-type="danger" onclick="contact_search2('changesearch');" title="Search">Search</button>
                                    <button class="btn btn-success howler" data-type="danger" onclick="clearfilter_contact2();" title="View All" title="View All">View All</button>
                                </label>
                            </div>
                        </div>
                    </div>
                    <div class="row dt-rt">
                        <div class="col-sm-6 col-xs-6">
                            <button class="btn btn-danger howler" data-type="danger" onclick="active_plan2('0');" title="Un-Archive">Un-Archive</button>
                        </div>
                        <div class="col-sm-6 col-xs-6">
                           <!-- <a title="Add Communication" class="btn  pull-right btn-success howler margin-left-5px" href="<?=base_url('admin/'.$viewname.'/add_record');?>">Add Communication</a>-->
                            <a title="View Archive" class="btn  pull-right btn-success howler" href="<?=base_url('admin/'.$viewname);?>">Back to List</a>
                    ...
                    <div id="default_common_div" class="table_large-responsive">
                        <?=$this->load->view('admin/'.$viewname.'/ajax_list_default_archive')?>
                    </div>
                </div>
            </div>
...
<script>
	  ...
	  function applysortfilte_contact(sortfilter,sorttype)
		...
		function contact_search(allflag)
		{
			...
			$.ajax({
				type: "POST",
				url: "<?php echo base_url();?>admin/interaction_plans/view_archive/"+uri_segment,
				data: {
	...
	function active_all_plans(name)
		{
			...
			$.ajax({
			type: "POST",
			url: "<?php echo $this->config->item('admin_base_url').$viewname.'/ajax_Active_all';?>",
			dataType: 'json',
			//async: false,
			...
			success: function(data1){
				...
				$.ajax({
					type: "POST",
					url: "<?php echo base_url();?>admin/interaction_plans/view_archive/"+data1,
					data: {
					result_type:'ajax',searchreport:$("#searchreport").val(),perpage:$("#perpage").val(),searchtext:$("#searchtext").val(),sortfield:$("#sortfield").val(),sortby:$("#sortby").val()
				},
				beforeSend: function() {
	...
	function delete_all(id)
		{
			...
			success: function(data){
				$.ajax({
					type: "POST",
					url: "<?php echo base_url();?>admin/interaction_plans/view_archive",
					data: {
					result_type:'ajax',searchreport:$("#searchreport").val(),perpage:$("#perpage").val(),searchtext:$("#searchtext").val(),sortfield:$("#sortfield").val(),sortby:$("#sortby").val()
				},
				beforeSend: function() {
    ...
    {   
				...
				if(id.length > 50)
				{
					var name = unescape(id).substr(0, 50)+'...';
					var msg = name;
				}
				else
				{
