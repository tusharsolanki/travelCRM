   ...
   <div class="">
    <div class="col-md-12">
     <div class="portlet">
	  ...
	  <span class="pull-right"><a title="Back" class="btn btn-secondary" onclick="history.go(-1)" title="Back" href="javascript:void(0)"><?php echo $this->lang->line('common_back_title')?></a> </span>       
      ...
      <div class="portlet-content">
       <div class="table-responsive">
        <div role="grid" class="dataTables_wrapper" id="DataTables_Table_0_wrapper">
         ...
         <div id="common_div">
         <?=$this->load->view('admin/'.$viewname.'/ajax_list_view')?>
         </div>
        </div>
       </div>
       <!-- /.table-responsive --> 
