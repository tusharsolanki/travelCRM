					...
					$i=!empty($this->router->uri->segments[4])?$this->router->uri->segments[4]+1:1;
                      foreach($datalist as $row){
                         ...
                         <?php if(!empty($this->modules_unique_name) && in_array('listing_manager_delete',$this->modules_unique_name)){?>
							...
							<td class="hidden-xs hidden-sm "><a class="" title="Edit Record" href="<?= $this->config->item('admin_base_url').$viewname; ?>/edit_record/<?= $row['id'] ?>">
							<?=!empty($row['address'])?ucwords($row['address']):'';?></a></td>
							<td class="hidden-xs hidden-sm "><a class="" title="Edit Record" href="<?= $this->config->item('admin_base_url').$viewname; ?>/edit_record/<?= $row['id'] ?>">
                            ...
                            <td class="hidden-xs hidden-sm "><a class="" title="Edit Record" href="<?= $this->config->item('admin_base_url').$viewname; ?>/edit_record/<?= $row['id'] ?>">
							<?=!empty($row['property_type_name'])?ucwords($row['property_type_name']):'';?></a></td>
                            <td class="hidden-xs hidden-sm "><a class="" title="Edit Record" href="<?= $this->config->item('admin_base_url').$viewname; ?>/edit_record/<?= $row['id'] ?>"><?=!empty($row['my_price'])?$row['my_price']:'';?></a></td>
                            <td class="hidden-xs hidden-sm "><a class="" title="Edit Record" href="<?= $this->config->item('admin_base_url').$viewname; ?>/edit_record/<?= $row['id'] ?>"><?=!empty($row['agent_name'])?$row['agent_name']:'';?></a>
