                ...
                <div class="col-lg-12">
                  <div id="DataTables_Table_0_filter" class="dataTables_filter">
					...
					?>
                        ...
                        <!--<label for="text-input"><span class="field_name"></span> </label>-->
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="col-sm-12 add_new_contact_popup">
          <div class="">
		  <?php $this->load->view('admin/listing_manager/add_contact_popup_ajax');?>
		  </div>
        </div>
      </div>
      <div class="col-sm-12 text-center mrgb4">
                    ...
                    <div class="col-lg-6">
                    	...
                    	<div class="row">
                          ...
                          <div class="col-sm-12 added_contacts_list">
                            ...
                            <?php $this->load->view('admin/listing_manager/selected_contact_ajax')?>
                          </div>
                        </div>
                      ...
                      <div id="DataTables_Table_0_filter" class="dataTables_filter">
                        ...
                        */ ?>
                        ...
                        <div class="form-group clear">
                          ...
                          <input type="text" readonly="true" value="<?php if(!empty($editRecord[0]['listed_date']) && $editRecord[0]['listed_date'] != '0000-00-00' && $editRecord[0]['listed_date'] != '1970-01-01') echo date($this->config->item('common_date_format'),strtotime($editRecord[0]['listed_date'])); else echo '';?>" placeholder="" aria-controls="DataTables_Table_0" id="listed_date" name="listed_date" class="addinput my_custom_date_class">
                        </div>
                        <div class="form-group clear">
                          <label for="text-input">Listing Expiration Date</label>
                          <input type="text" readonly="true" value="<?php if(!empty($editRecord[0]['listing_expire_date']) && $editRecord[0]['listing_expire_date'] != '0000-00-00' && $editRecord[0]['listing_expire_date'] != '1970-01-01') echo date($this->config->item('common_date_format'),strtotime($editRecord[0]['listing_expire_date'])); else echo '';?>" aria-controls="DataTables_Table_0" id="listing_expire_date" name="listing_expire_date" class="addinput my_custom_date_class">
                        </div>
                        <div class="form-group clear">
                          <label for="text-input">Closed Date</label>
                          <input type="text" readonly="true" value="<?php if(!empty($editRecord[0]['closed_date']) && $editRecord[0]['closed_date'] != '0000-00-00' && $editRecord[0]['closed_date'] != '1970-01-01') echo date($this->config->item('common_date_format'),strtotime($editRecord[0]['closed_date'])); else echo '';?>" placeholder="" aria-controls="DataTables_Table_0" id="closed_date" name="closed_date" class="addinput my_custom_date_class">
                        </div>
                        <div class="form-group clear">
                          <label for="text-input">Pending Date</label>
                          <input type="text" readonly="true" value="<?php if(!empty($editRecord[0]['pending_date']) && $editRecord[0]['pending_date'] != '0000-00-00' && $editRecord[0]['pending_date'] != '1970-01-01') echo date($this->config->item('common_date_format'),strtotime($editRecord[0]['pending_date'])); else echo '';?>" placeholder="" aria-controls="DataTables_Table_0" id="pending_date" name="pending_date" class="addinput my_custom_date_class">
                        </div>
                        <?php /*
                        <div class="form-group clear">
                        ...
                        */ ?>
                        <div class="form-group">
                          ...
                          <input type="text" value="<?=!empty($editRecord[0]['price'])?substr($editRecord[0]['price'],0,-3):''?>" aria-controls="DataTables_Table_0" id="price" name="price" class="addinput" onkeypress="return IsNumeric(event)">
                          <select data-required="true" id="price_unit" name="price_unit" class="form-control parsley-validated addselect">
                          <?php if(count($price_unitdata) > 0){
								foreach($price_unitdata as $row)
								{ ?>
									<option value="<?=$row['id']?>{^}<?=$row['unit_title']?>" <?php if(!empty($editRecord[0]['price_unit']) && $editRecord[0]['price_unit'] == $row['id']) echo "selected=selected"; ?> ><?=$row['unit_title']?></option>
							<?php
								}
							}
							?>
                    ...
                    <div class="col-lg-6">
                      ...
                      <div class="form-group">
                        ...
                        <div class="form-group">
                          ...
                          <!--<a data-toggle="modal" class="text_color_red addplus" href="#"><i class="fa fa-plus-square addplus"></i></a>
-->                          <select id="lot_type" name="lot_type" class="form-control parsley-validated addinput">
                ...
                <div class="row">
                    ...
                    <div id="DataTables_Table_0_filter" class="dataTables_filter">
                      <div class="col-lg-6 ">
                        <div class="form-group custom-form-group">
                          ...
                          <div class="">
                          <input type="text" value="<?=!empty($editRecord[0]['address_line_1'])?htmlentities($editRecord[0]['address_line_1']):''?>" placeholder="Address1" aria-controls="DataTables_Table_0" id="address_line_1" name="address_line_1" class="form-control parsley-validated" data-required="true" onblur="blurFunction();">
                          </div>
                        </div>
                        <div class="form-group">
                          <input type="text" value="<?=!empty($editRecord[0]['address_line_2'])?htmlentities($editRecord[0]['address_line_2']):''?>" placeholder="Address2" aria-controls="DataTables_Table_0" id="address_line_2" name="address_line_2" class="addinput form-control parsley-validated" onblur="blurFunction();">
                          ...
                          <div class="div">
                            ...
                            <div class="col-lg-3 col-xs-3 nopadding">
                              <input type="text" value="<?=!empty($editRecord[0]['zip_code'])?$editRecord[0]['zip_code']:''?>" class="form-control parsley-validated" data-minlength="5" maxlength="6" name="zip_code" id="zip_code" placeholder="Zip Code" onblur="blurFunction();">
                            </div>
                  ...
                  <div id="googleMap"  class="map"></div>
                        ...
                        {
                            var mp = '<iframe width="100%" scrolling="no" style="height:300px; border:0;" frameborder="0" src="https://maps.google.com/maps?q='+passaddress+'&amp;output=embed&amp; z=10" marginwidth="0" marginheight="0"></iframe>';
                            $('#googleMap').html(mp);
			...
			<div class="col-sm-12" id="documenets">
				...
				<div class="add_emailtype autooverflow">
					...
					<div class="col-sm-8">
						<div class="row">
							...
							<div class="col-sm-7 form-group margin-top-10">
							  <input title="Save and Add More Document" type="submit" class="btn btn-secondary" value="Save and Add More Document" onclick="on_submit(); return setsubmitidtab2(3);" id="doc_submit" name="submitbtn" />
							</div>
					...
					<div class="col-sm-12 clear appendajaxdata toppadding">
						<?php $this->load->view('admin/listing_manager/listing_document_ajax'); ?>
					</div>
				</div>
			</div>
			<div class="col-sm-12 pull-left text-center">
                ...
                <input type="submit" name="submitbtn" value="Save and Continue" onclick="setsubmitidtab2(2);" id="on_submit(); savecontacttab3" class="btn btn-secondary">
                <a class="btn btn-primary" href="javascript:history.go(-1);">Cancel</a>
            </div>
 			</form>
         </div>
                    ...
                    <div class="col-lg-6">
                      <div id="DataTables_Table_0_filter" class="dataTables_filter">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" placeholder="" aria-controls="DataTables_Table_0" id="lockbox_serial" name="lockbox_serial" class="addinput" value="<?php if(!empty($editRecord[0]['lockbox_serial'])){ echo htmlentities($editRecord[0]['lockbox_serial']); }?>">
                        </div>
                        <div class="form-group">
                          <label for="text-input">Combination </label>
                          <input type="text" aria-controls="DataTables_Table_0" id="lockbox_combination" name="lockbox_combination" class="addinput" value="<?php if(!empty($editRecord[0]['lockbox_combination'])){ echo htmlentities($editRecord[0]['lockbox_combination']); }?>">
                        </div>
                        <div class="form-group">
                          <label for="text-input">Lock box Location </label>
                          <input type="text" aria-controls="DataTables_Table_0" id="lockbox_location_on_property" name="lockbox_location_on_property" class="addinput" value="<?php if(!empty($editRecord[0]['lockbox_location_on_property'])){ echo htmlentities($editRecord[0]['lockbox_location_on_property']); }?>">
                        </div>
                       	<div class="form-group">
			...
			<div class="col-sm-12" id="documenets">
				...
				<div class="add_emailtype autooverflow">
					...
					<div class="col-sm-12 clear appendajaxdata toppadding">
						<?php $this->load->view('admin/listing_manager/listing_offers_ajax'); ?>
					</div>
				</div>
			</div>
			<div class="col-sm-12 pull-left text-center">
			...
			<div class="col-sm-12" id="documenets">
				...
				<div class="add_emailtype autooverflow">
					...
					<div class="col-sm-8">
						<div class="row">
                            ...
                            <div class="col-sm-6 form-group">
                              ...
                              <input id="txt_new_price" name="txt_new_price" class="form-control parsley-validated background_white" type="text" value="<?php if(!empty($editRecord[0]['new_price'])){ echo substr($editRecord[0]['new_price'],0,-3); }?>" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;">
                              </div>
                              <div class="col-sm-6 form-group">
                               <label for="text-input"><?=$this->lang->line('common_label_unit');?></label>
					...
					<div class="col-sm-12 clear appendajaxdata toppadding">
						<?php $this->load->view('admin/listing_manager/listing_price_ajax'); ?>
					</div>
				</div>
			</div>
			<div class="col-sm-12 pull-left text-center">
				...
				<div class="add_emailtype autooverflow">
					...
					<div class="col-sm-8">
						<div class="row">
							...
							<div class="col-sm-7 form-group">
							  <label for="text-input"><?=$this->lang->line('common_label_date');?></label>
							  <input id="txt_houses_date"  readonly="true" name="txt_houses_date" aria-controls="DataTables_Table_0" class="form-control parsley-validated my_custom_date_class background_white" type="text" value="<?php if(!empty($editRecord[0]['open_house_date']) && $editRecord[0]['open_house_date'] != '0000-00-00' && $editRecord[0]['open_house_date'] != '1970-01-01'){ echo date($this->config->item('common_date_format'),strtotime($editRecord[0]['open_house_date'])); }?>">
							</div>
					...
					<div class="col-sm-12 clear appendajaxdata toppadding">
						<?php $this->load->view('admin/listing_manager/listing_houses_ajax'); ?>
					</div>
				</div>
			</div>
			<div class="col-sm-12 pull-left text-center">
			...
			<div class="col-sm-12" id="documenets">
				...
				<div class="add_emailtype autooverflow">
						...
						<div class="">
							...
							<div class="col-sm-6 form-group">
							  <label for="text-input"><?=$this->lang->line('common_label_date');?></label>
							  <input id="txt_showings_date" readonly="true" name="txt_showings_date" aria-controls="DataTables_Table_0" class="form-control parsley-validated my_custom_date_class background_white" type="text" value="<?php if(!empty($editRecord[0]['open_house_date']) && $editRecord[0]['showings_date'] != '0000-00-00' && $editRecord[0]['showings_date'] != '1970-01-01'){ echo date($this->config->item('common_date_format'),strtotime($editRecord[0]['showings_date'])); }?>">
							</div>
					...
					<div class="col-sm-12 clear appendajaxdata toppadding">
						<?php $this->load->view('admin/listing_manager/listing_showings_ajax'); ?>
					</div>
				</div>
			</div>
			<div class="col-sm-12 pull-left text-center">
            ...
            <div class="row">
              ...
              <div class="col-lg-6"><!--<input type="hidden" name="live_link" id="live_link" value="<?=!empty($editRecord[0]['live_link'])?$this->config->item('proprty_listing_base_path').$editRecord[0]['live_link']:''?>" />-->
              ...
              <?php } ?>
			  <!--<input type="text" readonly="true" name="live_link" id="live_link" class="form-control parsley-validated" value="<?=!empty($editRecord[0]['live_link'])?$editRecord[0]['live_link']:''?>" />--></div>
            </div>
            <div class="row">
          ...
          <div class="col-sm-12 pull-left text-center margin-top-10">
            <input type="submit" name="savebtn" value="Save" class="btn btn-secondary-green">
            <a class="btn btn-primary" href="javascript:history.go(-1);">Cancel</a> </div>
          </form>
        </div>
        	  <? } ?>
...
<script type="text/javascript">
	$(function(){
		...
		new AjaxUpload(btnUpload1, {
			...
			onSubmit: function(file, ext){
				$("#savecontacttab2").attr('disabled','disabled');
				$("#savecontacttab3").attr('disabled','disabled');
			...
			var data = jQuery.parseJSON(response);
				...
				$("#doc_submit").removeAttr('disabled');
				$("#savecontacttab2").removeAttr('disabled');
				$("#savecontacttab3").removeAttr('disabled');
			}
		});
			...
			$.ajax({
					...
					success: function (data) {
						...
						if(chkval == 1)
							...
							window.location.href = '<?=base_url().'admin/'.$viewname.'/edit_record/';?>'+cid+'/6';
	...
	function editofferstransdata(id)
	{
		$.ajax({
			...
			dataType: 'json',
			data:{id:id},
			url: '<?=$this->config->item('admin_base_url').$viewname."/get_offers_trans_data";?>',
			success:function(msg){
					if(msg == 'error')
					{
						alert('Something went wrong.');
	...
	function editpricestransdata(id)
	{
		$.ajax({
			...
			dataType: 'json',
			data:{id:id},
			url: '<?=$this->config->item('admin_base_url').$viewname."/get_price_trans_data";?>',
			success:function(msg){
					if(msg == 'error')
					{
						alert('Something went wrong.');
	...
	function edithousesstransdata(id)
	{
		$.ajax({
			...
			dataType: 'json',
			data:{id:id},
			url: '<?=$this->config->item('admin_base_url').$viewname."/get_houses_trans_data";?>',
			success:function(msg){
					if(msg == 'error')
					{
						alert('Something went wrong.');
	...
	function editshowingsstransdata(id)
	{
		$.ajax({
			...
			dataType: 'json',
			data:{id:id},
			url: '<?=$this->config->item('admin_base_url').$viewname."/get_showings_trans_data";?>',
			success:function(msg){
					if(msg == 'error')
					{
						alert('Something went wrong.');
...
$(document).ready(function(){
	...
	function contact_search()
	{
		$.ajax({
			type: "POST",
			url: "<?php echo base_url();?>admin/listing_manager/search_contact_ajax/",
			data: {
			result_type:'ajax',searchtext:$("#search_contact_popup_ajax").val(),contact_status:$('#slt_contact_status').val(),contact_source:$('#slt_contact_source').val(),contact_type:$('#contact_type').val(),search_tag:$("#search_tag").val(),perpage:$("#perpage").val()
		},
		beforeSend: function() {
	...
	function addcontactstolistingmanager()
	{
		$.ajax({
			type: "POST",
			url: "<?php echo base_url();?>admin/listing_manager/add_contacts_to_listing_manager/",
			data: {
	...
	$('body').on('click','.remove_selected_contact',function(e){
		...
		'action': function(){
			...
			$.ajax({
				type: "POST",
				url: "<?php echo $this->config->item('admin_base_url').$viewname.'/delete_contact_from_listing_manager';?>",
...
function blurFunction()
{
	...
	$.ajax({
	type: "POST",
	url: "<?php echo $this->config->item('admin_base_url').$viewname.'/getLatLong';?>",
	dataType: 'json',
...
function active_theme(property_id,theme_id)
{
	$.ajax({
			type: "POST",
			url: "<?php echo base_url();?>admin/listing_manager/active_theme/",
			data: {
...
{
	$(".add_property_type").show();
	$(".property_insert_data").show();
	$(".share_link").hide();
	if(title != '')
	{
		var frameSrc = '<?php echo $this->config->item('admin_base_url')?>property_list_masters/add_record/property_master_iframe/'+name;
		//$('iframe').attr("src",frameSrc);
		$(".add_property_type").html('<iframe src="'+frameSrc+'" style="zoom:0.60" frameborder="0" height="490" width="99.6%"></iframe>');
	}
...
function insert_data()
{
	...
	//{
		$.ajax({
				type: "POST",
				dataType: 'json',
				url: "<?php echo base_url();?>admin/listing_manager/property_listing_master/",
				data: {
