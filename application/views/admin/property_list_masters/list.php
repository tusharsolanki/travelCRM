...
<img title="Edit record" src="<?php echo $this->config->item('image_path');?>edit_icon.png" width="15" height="20" /> 
                                                        ...
                                                        <td width="20" valign="top"><a href="javascript:void(0);" onclick="deletepopup('<?=rawurlencode($row['email_type'])?>','<?php echo $this->lang->line('contact_head_submodel')?>','<?php echo $this->config->item('admin_base_url').$viewname;?>/delete_email_record/<?php echo  $row['id'] ?>');"><img title="Delete record" src="<?php echo $this->config->item('image_path');?>delete_icon.png" width="15"  /></a></td>
...
<img title="Edit record" src="<?php echo $this->config->item('image_path');?>edit_icon.png" width="15" height="20" /> 
                                                        ...
                                                        <td width="20" valign="top"><a href="javascript:void(0);" onclick="deletepopup('<?=rawurlencode($row['phone_type'])?>','<?php echo $this->lang->line('contact_head_submodel')?>','<?php echo $this->config->item('admin_base_url').$viewname;?>/delete_phone_record/<?php echo  $row['id'] ?>');"><img title="Delete record" src="<?php echo $this->config->item('image_path');?>delete_icon.png" width="15"  /></a></td>
                                                    </tr>
                                               </table>
...
<img title="Edit record" src="<?php echo $this->config->item('image_path');?>edit_icon.png" width="15" height="20" /> 
                                                        ...
                                                        <td width="20" valign="top"><a href="javascript:void(0);" onclick="deletepopup('<?=rawurlencode($row['address_type'])?>','<?php echo $this->lang->line('contact_head_submodel')?>','<?php echo $this->config->item('admin_base_url').$viewname;?>/delete_address_record/<?php echo  $row['id'] ?>');"><img title="Delete record" src="<?php echo $this->config->item('image_path');?>delete_icon.png" width="15"  /></a></td>
...
<img title="Edit record" src="<?php echo $this->config->item('image_path');?>edit_icon.png" width="15" height="20" /> 
                                                        ...
                                                        <td width="20" valign="top"><a href="javascript:void(0);" onclick="deletepopup('<?=rawurlencode($row['website_type'])?>','<?php echo $this->lang->line('contact_head_submodel')?>','<?php echo $this->config->item('admin_base_url').$viewname;?>/delete_website_record/<?php echo  $row['id'] ?>');"><img title="Delete record" src="<?php echo $this->config->item('image_path');?>delete_icon.png" width="15"  /></a></td>
...
<img title="Edit record" src="<?php echo $this->config->item('image_path');?>edit_icon.png" width="15" height="20" /> 
                                                        ...
                                                        <td width="20" valign="top"><a href="javascript:void(0);" onclick="deletepopup('<?=rawurlencode($row['profile_type'])?>','<?php echo $this->lang->line('contact_head_submodel')?>','<?php echo $this->config->item('admin_base_url').$viewname;?>/delete_profile_record/<?php echo  $row['id'] ?>');"><img title="Delete record" src="<?php echo $this->config->item('image_path');?>delete_icon.png" width="15"  /></a></td>
...
<img title="Edit record" src="<?php echo $this->config->item('image_path');?>edit_icon.png" width="15" height="20" /> 
                                                        ...
                                                        <td width="20" valign="top"><a href="javascript:void(0);" onclick="deletepopup('<?=rawurlencode($row['contact_type'])?>','<?php echo $this->lang->line('contact_head_submodel')?>','<?php echo $this->config->item('admin_base_url').$viewname;?>/delete_contact_record/<?php echo  $row['id'] ?>');"><img title="Delete record" src="<?php echo $this->config->item('image_path');?>delete_icon.png" width="15"  /></a></td>
...
<img title="Edit record" src="<?php echo $this->config->item('image_path');?>edit_icon.png" width="15" height="20" /> 
                                                        ...
                                                        <td width="20" valign="top"><a href="javascript:void(0);" onclick="deletepopup('<?=rawurlencode($row['document_type'])?>','<?php echo $this->lang->line('contact_head_submodel')?>','<?php echo $this->config->item('admin_base_url').$viewname;?>/delete_document_record/<?php echo  $row['id'] ?>');"><img title="Delete record" src="<?php echo $this->config->item('image_path');?>delete_icon.png" width="15"  /></a></td>
...
<img title="Edit record" src="<?php echo $this->config->item('image_path');?>edit_icon.png" width="15" height="20" /> 
                                                        ...
                                                        <td width="20" valign="top"><a href="javascript:void(0);" onclick="deletepopup('<?=rawurlencode($row['source_type'])?>','<?php echo $this->lang->line('contact_head_submodel')?>','<?php echo $this->config->item('admin_base_url').$viewname;?>/delete_source_record/<?php echo  $row['id'] ?>');"><img title="Delete record" src="<?php echo $this->config->item('image_path');?>delete_icon.png" width="15"  /></a></td>
