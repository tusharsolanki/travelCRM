...
?>
 <div id="content">
  <div id="content-header">
   <h1><?=$this->lang->line('customfield_list_head');?></h1>
  </div>
    ...
    <div class="col-md-12">
     <div class="portlet">
      <div class="portlet-header">
       <h3> <i class="fa fa-table"></i><?=$this->lang->line('customfield_list_head');?></h3>
      ...
      <div class="portlet-content">
       <div class="table_large-responsive">
        <div role="grid" class="dataTables_wrapper" id="DataTables_Table_0_wrapper">
         ...
         <div class="row dt-rt">
          <div class="col-sm-6">
           <button class="btn btn-danger howler" data-type="danger" onclick="deletepopup1('0');" title="Delete Custom Field">Delete Custom Field</button>
          </div>
          <div class="col-sm-6">
          <a class="btn  pull-right btn-success howler" href="<?=base_url('admin/'.$viewname.'/add_record');?>" title="Add Custom Field">Add Custom Field</a>
          </div>
         </div>
         <div id="common_div">
...
<script>
	...
	function contact_search()
	{
		$.ajax({
			type: "POST",
			url: "<?php echo base_url();?>admin/custom_field/",
			data: {
