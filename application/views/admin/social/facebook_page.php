        ...
        <div class="portlet">
          ...
          <div class="portlet-content custom_fb_box_class">
            <div class="">
              ...
              <form class="form parsley-form" enctype="multipart/form-data" name="<?php echo $viewname;?>" id="<?php echo $viewname;?>" method="post" accept-charset="utf-8" action="<?php echo $this->config->item('admin_base_url').'social/fbconnection'?>" novalidate data-validate="parsley">
                <div class="row">
				<!--<div class="col-sm-12">
	...
	if(plarform == 3)
	{
		<?php /*?>var contact_id = $("#email_to").val();
			//window.open("http://www.facebook.com/messages/new?to=100001598523327");
			 url = '<?php echo $this->config->item('admin_base_url').$viewname.'/linkedin_contact';?>';
			 $.ajax({
				 type: "POST",
				 //dataType: 'json',
				 url: url,
