          ...
          <div class="portlet-content">
            <div role="grid" class="dataTables_wrapper" id="DataTables_Table_0_wrapper">
                ...
                <div class="">
                  <div class="col-sm-4 col-lg-2 col-md-2 col-xs-11">
                    <div class="dataTables_filter pull-left" id="DataTables_Table_0_filter">
                      <label>
                        <?php /*?> <a href="<?=base_url('admin/'.$viewname.'/queued_list');?>" class="btn btn-secondary howler" title="Queued Social" > Queued Social </a>
                        <a href="<?=base_url('admin/'.$viewname.'/all_sent_social');?>" class="btn btn-secondary howler" title="Sent Social" > Sent Social </a><?php */?> </label>
                    </div>
                  </div>
                  <div class="col-sm-12">
              ...
              <div class="row dt-rt">
                ...
                <div class="col-sm-6"> <a class="btn  pull-right btn-secondary-green howler" href="<?=base_url('admin/'.$viewname.'/add_record');?>" title="Add Social Campaign">Add Social Media Campaign</a> </div>
                <? } ?>
              </div>
...
<script>
	...
	function contact_search(allflag)
	{
		...
		$.ajax({
			type: "POST",
			url: "<?php echo base_url();?>admin/Social/"+uri_segment,
			data: {
	...
	function delete_all(id)
		{
			...
			success: function(data){
				...
				$.ajax({
					type: "POST",
					url: "<?php echo base_url();?>admin/Social/"+data,
					data: {
